...
export const InstanceAnnotationTypes: TypeMap = {
  ...
  [INSTANCE_ANNOTATIONS.CREATED_BY_NAME]: BuiltinTypes.HIDDEN_STRING,
  [INSTANCE_ANNOTATIONS.CREATED_BY_DATE]: BuiltinTypes.HIDDEN_STRING,
  [INSTANCE_ANNOTATIONS.CHANGED_BY_NAME]: BuiltinTypes.HIDDEN_STRING,
  [INSTANCE_ANNOTATIONS.CHANGED_BY_DATE]: BuiltinTypes.HIDDEN_STRING,
}
