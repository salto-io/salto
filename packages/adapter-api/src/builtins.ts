...
export const InstanceAnnotationTypes: TypeMap = {
  ...
  [CORE_ANNOTATIONS.CREATED_BY_NAME]: BuiltinTypes.HIDDEN_STRING,
  [CORE_ANNOTATIONS.CREATED_BY_DATE]: BuiltinTypes.HIDDEN_STRING,
  [CORE_ANNOTATIONS.CHANGED_BY_NAME]: BuiltinTypes.HIDDEN_STRING,
  [CORE_ANNOTATIONS.CHANGED_BY_DATE]: BuiltinTypes.HIDDEN_STRING,
}
