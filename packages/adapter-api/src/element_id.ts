...
export const INSTANCE_ANNOTATIONS = {
  ...
  CREATED_BY_NAME: CORE_ANNOTATIONS.CREATED_BY_NAME,
  CREATED_BY_DATE: CORE_ANNOTATIONS.CREATED_BY_DATE,
  CHANGED_BY_NAME: CORE_ANNOTATIONS.CHANGED_BY_NAME,
  CHANGED_BY_DATE: CORE_ANNOTATIONS.CHANGED_BY_DATE,
}
