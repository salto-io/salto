...
*/
import { ChangeValidator, CORE_ANNOTATIONS, ElemID, InstanceElement, ObjectType, ReferenceExpression, toChange } from '@salto-io/adapter-api'
...
describe('createSkipParentsOfSkippedInstsValidator', () => {
  ...
  const skippedInst = new InstanceElement(
    'inner',
    skippedInstType,
    {},
    undefined,
  ...
  it('should skip the parent instance as well', async () => {
    ...
    expect(errors.map(e => e.elemID.getFullName()))
