...
*/
import { ObjectType, ElemID, InstanceElement, BuiltinTypes, ReferenceExpression, toChange, getChangeData, Change, ListType } from '@salto-io/adapter-api'
import { SUBTYPES_PATH, TYPES_PATH } from '../../../src/elements'
import { replaceInstanceTypeForDeploy, restoreInstanceTypeFromDeploy } from '../../../src/elements/ducktype/deployment_placeholder_types'
