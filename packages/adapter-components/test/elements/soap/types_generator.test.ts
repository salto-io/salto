...
describe('extractTypes', () => {
  ...
  it('should have a primitive field', () => {
    ...
    expect(testedType.fields.primitiveField.type.elemID.getFullNameParts()).toEqual(['string'])
  })

  it('should have an object type field', () => {
    expect(testedType.fields.fieldToType.type.elemID.getFullNameParts()).toEqual(['adapterName', 'someType'])
  })

  it('should have an aliased field', () => {
    expect(testedType.fields.aliasField.type.elemID.getFullNameParts()).toEqual(['string'])
  })

  it('should have an unknown field', () => {
    expect(testedType.fields.testUnknown.type.elemID.getFullNameParts()).toEqual(['unknown'])
  })

  it('should have extension fields', () => {
    expect(testedType.fields.testAttr.type.elemID.getFullNameParts()).toEqual(['string'])
  ...
  it('should have sub types defined in the same file as the type', async () => {
    expect(testedType.fields.subtypeField.type.elemID.getFullNameParts()).toEqual(['adapterName', 'testedTypeSubtype'])
  })
  ...
  it('should have types defined in the WSDL', async () => {
    ...
    expect(type.fields.someField.type.elemID.getFullNameParts()).toEqual(['adapterName', 'typeInMain'])
  })

  it('should have list fields', async () => {
    expect(testedType.fields.listField.type instanceof ListType).toBeTruthy()
  })
