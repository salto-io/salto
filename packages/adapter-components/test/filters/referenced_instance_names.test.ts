  ...
  describe('referencedInstanceNames filter', () => {
    ...
    it('should rename the elements correctly when the filter is called', () => {
      expect(
        ...
        'myAdapter.differentMappingFunction.instance.nestingParent_first_SECOND_third',
        'myAdapter.email.instance.aaa_username_group1@um',
        'myAdapter.email.instance.aaa_username_group1_x_y@umvv',
        'myAdapter.folder.instance.recipe123_123_ROOT_lastRecipe_456_123_ROOT_Desktop',
        'myAdapter.folder.instance.recipe123_123_ROOT_lastRecipe_456_123_ROOT_Documents',
        ...
        'myAdapter.nestingParent_standaloneNestedField_standaloneDoubleNestedField.instance.nestingParent_upstandingName_nestedNestedName',
        'myAdapter.noIdFields.instance.no_idFieldsParent',
        'myAdapter.notNestingParent.instance.notNestingParent',
        'myAdapter.notStandaloneNestedField.instance.notNestingParent_fishyName',
        'myAdapter.recipe.instance.recipe123_123_ROOT',
        'myAdapter.recipe.instance.recipe123_123_ROOT_lastRecipe_456_123_ROOT',
        'myAdapter.recipe.instance.recipe456_456_123_ROOT',
        'myAdapter.recipe.instance.sameRecipe',
        'myAdapter.recipe.instance.sameRecipe',
        'myAdapter.standaloneNestedField.instance.nestingParent_upstandingName',
    ...
    it('should calculate path correctly when the filter is called', () => {
      expect(
        ...
        'myAdapter/Records/existing/path/to/nestingParent/differentMappingFunction/nestingParent_first_SECOND_third',
        'myAdapter/Records/existing/path/to/nestingParent/standaloneNestedField/nestingParent_upstandingName/nestingParent_standaloneNestedField_standaloneDoubleNestedField/nestingParent_upstandingName_nestedNestedName',
        'myAdapter/Records/existing/path/to/nestingParent/standaloneNestedField/nestingParent_upstandingName/nestingParent_upstandingName',
        'myAdapter/Records/folder/recipe123_123_ROOT_lastRecipe_456_123_ROOT_Desktop',
        'myAdapter/Records/folder/recipe123_123_ROOT_lastRecipe_456_123_ROOT_Documents',
        'myAdapter/Records/noIdFields/no_idFieldsParent',
        'myAdapter/Records/notStandaloneNestedField/notNestingParent_fishyName',
        'myAdapter/Records/recipe/recipe123_123_ROOT',
        'myAdapter/Records/recipe/recipe123_123_ROOT_lastRecipe_456_123_ROOT',
  ...
  describe('addReferencesToInstanceNames function', () => {
    ...
    it('should update the path of a double nested instance', async () => {
      ...
      expect(updatedNestedNestedStandaloneFieldPath).toEqual([
        ...
        'nestingParent',
        'standaloneNestedField',
        'nestingParent_upstandingName',
        'nestingParent_standaloneNestedField_standaloneDoubleNestedField',
        'nestingParent_upstandingName_nestedNestedName',
      ])
    })
    ...
    it('should ignore null values on idFields', async () => {
      ...
      expect(recipeWithNullBookRes.elemID.getFullName()).toEqual(
        'myAdapter.recipe.instance.recipe123_123_ROOT_recipeWithNullBook',
      )
    })
  })
})
