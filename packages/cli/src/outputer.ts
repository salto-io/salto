...
export const outputLine = (text: string, output: CliOutput | {stdout: WriteStream}): void => {
  output.stdout.write(`${text}\n`)
  log.debug(text)
}
export const errorOutputLine = (text: string, output: CliOutput | {stderr: WriteStream}): void => {
