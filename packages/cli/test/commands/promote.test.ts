...
import { command } from '../../src/commands/promote'
...
describe('promote command', () => {
  ...
  describe('with errored workspace', () => {
    beforeEach(async () => {
      ...
      mockCliTelemetry = getCliTelemetry(mockTelemetry, 'promote')
  ...
  describe('when workspace throws an error', () => {
    ...
    it('should print deployment to console', () => {
      expect(cliOutput.stdout.content)
        .toContain('Failed to move the selected elements to the common folder')
    })
  })
})
