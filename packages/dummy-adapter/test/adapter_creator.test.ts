...
describe('adapter creator', () => {
  it('should return a config containing all of the generator params', () => {
    ...
    expect(Object.keys(config?.fields)).toEqual([...Object.keys(defaultParams), 'changeErrors', 'extraNaclPath', 'generateEnvName', 'fieldsToOmitOnDeploy', 'elementsToExclude', 'conflictedElementsVersion'])
  })
