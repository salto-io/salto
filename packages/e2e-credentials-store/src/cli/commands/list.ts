...
type Lister = (iterable: AsyncIterable<LeaseWithStatus<unknown>>) => Promise<string>
...
const commandModule = ({ adapters, pool, asyncHandler, stdout }: Opts): CommandModule<{}, ListArgs> => ({
