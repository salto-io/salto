...
export const DUCKTYPE_API_DEFINITIONS = 'duckTypeApiDefinitions'
...
export const REQUEST_TYPE_FIELD_NAME = 'RequestTypeField'
export const REQUEST_FORM_TYPE = 'RequestForm'
export const ISSUE_VIEW_TYPE = 'IssueView'
export const REQUEST_TYPE_GROUP_TYPE = 'RequestTypeGroup'
