...
import { applyFunctionToChangeData, getParents, isResolvedReferenceExpression, resolvePath } from '@salto-io/adapter-utils'
...
export const updateDefaultValues = async (
  ...
  const defaultValueToUpdate = afterDefault
    ?? _.mapValues(
      beforeDefault,
