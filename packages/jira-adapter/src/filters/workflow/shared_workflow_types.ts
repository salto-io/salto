...
import { DIRECTED_LINK_TYPE, JIRA } from '../../constants'


export const linkDirectionType = new ObjectType({
  ...
  path: [JIRA, elements.TYPES_PATH, elements.SUBTYPES_PATH, DIRECTED_LINK_TYPE],
})

export const types = [linkDirectionType]
