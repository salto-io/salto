...
const ERROR_TITLE = 'Unable to deploy Kanban Board When the first column is not named "Backlog"'
const ERROR_MESSAGE =
  'A Kanban board must have a first column named Backlog. If you did not edit the board manually please fetch and try again'
