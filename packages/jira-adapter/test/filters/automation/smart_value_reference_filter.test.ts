...
import filterCreator from '../../../src/filters/automation/smart_value_reference_filter'
import { getFilterParams } from '../../utils'

const logging = logger('jira-adapter/src/filters/automation/smart_value_reference_filter')
