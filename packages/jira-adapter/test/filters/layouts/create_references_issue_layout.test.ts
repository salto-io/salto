...
import { BuiltinTypes, ElemID, InstanceElement, ListType, ObjectType, ReferenceExpression, Element } from '@salto-io/adapter-api'
...
describe('createReferencesIssueLayoutFilter', () => {
    ...
    const screenType = new ObjectType({ elemID: new ElemID(JIRA, 'Screen'),
      fields: {
        id: { refType: BuiltinTypes.NUMBER },
      } })
    const screenInstance = new InstanceElement(
      'screen1',
      screenType,
      {
        id: 11,
    ...
    const screenSchemeInstance = new InstanceElement(
      'screenScheme1',
      screenSchemeType,
      {
        id: 111,
    ...
    const issueTypeScreenSchemeInstance = new InstanceElement(
    ...
    const fieldInstance1 = new InstanceElement(
      'testField1',
      fieldType,
      {
        id: 'testField1',
