...
describe('userFilter', () => {
  ...
  describe('onFetch', () => {
    it('should replace User types with account id field', async () => {
      const instance = new InstanceElement('instance', boardType, {
        admins: {
          users: [
            {
              accountId: 'John Doe',
      ...
      const instanceFilter = new InstanceElement('instance2', filterType, {
        owner: {
          accountId: 'John Doe2',
        },
        editPermissions: [
      ...
      const instanceDashboard = new InstanceElement('instance3', dashboardType, {
        owner: {
          accountId: 'John Doe3',
        },
      })
    ...
    it('should do nothing on wrong structure', async () => {
      ...
      const instance2 = new InstanceElement('instance2', boardType, {
        type: 'ACCOUNT_ID',
        value: 'bla',
      })
