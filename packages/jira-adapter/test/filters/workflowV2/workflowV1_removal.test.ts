...
describe('workflow filter', () => {
  describe('on fetch', () => {
      ...
      beforeEach(async () => {
        ...
        workflowV1Instance1 = new InstanceElement(
          'workflowV1Instance1',
          workflowType,
          {}
        )
        workflowV1Instance2 = new InstanceElement(
          'workflowV1Instance2',
          workflowType,
          {}
        )
        ...
        notWorkflowInstance = new InstanceElement(
          'notWorkflowInstance',
          createEmptyType('notWorkflowType'),
          {}
        )
    ...
    it('should remove workflowV1 instances when enableNewWorkflowAPI is true', async () => {
      ...
      it('should not remove workflowV1 instances when enableNewWorkflowAPI is false', async () => {
        ...
        expect(elements).toEqual([workflowType, workflowV1Instance1, workflowV1Instance2, workflowV2Instance, notWorkflowInstance])
      })
    })
  })
