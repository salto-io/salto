...
describe('automation_projects', () => {
  ...
  beforeEach(() => {
    projectInstance = new InstanceElement(
      'proj1',
      new ObjectType({ elemID: new ElemID(JIRA, PROJECT_TYPE) }),
    )
  ...
  describe('findWeakReferences', () => {
    it('should return weak references projects', async () => {
      ...
      expect(references).toEqual([
        ...
        { source: instance.elemID.createNestedID('2', 'projectId'), target: new ElemID(JIRA, PROJECT_TYPE, 'instance', 'proj2'), type: 'weak' },
      ])
    })
