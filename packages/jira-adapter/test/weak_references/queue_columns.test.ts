...
*/
import { BuiltinTypes, ElemID, InstanceElement, ListType, ObjectType, ReadOnlyElementsSource, ReferenceExpression } from '@salto-io/adapter-api'
  ...
  describe('findWeakReferences', () => {
    it('should return weak references fields', async () => {
      ...
      expect(references).toEqual([
        ...
        { source: queueInstance.elemID.createNestedID('2'), target: new ElemID(JIRA, FIELD_TYPE_NAME, 'instance', 'field2'), type: 'weak' },
      ])
    })
