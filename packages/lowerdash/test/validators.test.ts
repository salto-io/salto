  ...
  describe('validators', () => {
    describe('greaterThan', () => {
      ...
      describe('when created with a number', () => {
        ...
        it('should throw when not a number', () => {
          expect(
            () => validate(validator, 'foo' as unknown as number)
          ).toThrow(/should be a number, received: 'foo'/)
        })
      ...
      describe('when created with a function returning number', () => {
        ...
        it('should throw when not greater than', () => {
          opts.myNum = 12
          expect(
            () => validate(validator, opts.myNum, 'myNum', opts)
          ).toThrow(/myNum should be greater than 12/)
        })
        ...
        it('should throw when not a number', () => {
          ...
          expect(
            () => validate(validator, opts.myNum, 'myNum', opts)
          ).toThrow(/myNum should be a number/)
        })
    ...
    describe('greaterOrEqualThan', () => {
      ...
      describe('when created with a number', () => {
        ...
        it('should throw when not greater than', () => {
          expect(() => validate(validator, 11))
            .toThrow(/should be greater or equal than 12, received: 11/)
        })
        it('should throw when not a number', () => {
          expect(
            () => validate(validator, 'foo' as unknown as number)
      ...
      describe('when created with a function returning number', () => {
        ...
        it('should throw when not greater than', () => {
          ...
          expect(
            () => validate(validator, opts.myNum, 'myNum', opts)
          ).toThrow(/myNum should be greater or equal than 12/)
        })
        ...
        it('should throw when not a number', () => {
          ...
          expect(
            () => validate(validator, opts.myNum, 'myNum', opts)
          ).toThrow(/myNum should be a number, received: 'foo'/)
        })
    ...
    describe('inRangeInclusive', () => {
      ...
      describe('when created with numbers', () => {
        ...
        it('should throw when not in range', () => {
          expect(() => validate(validator, 11))
            .toThrow(/should be in range \[12, 13\], received: 11/)
        })
        it('should throw when not a number', () => {
          expect(
            () => validate(validator, 'foo' as unknown as number)
      ...
      describe('when created with a function returning number', () => {
        ...
        it('should throw when not in range', () => {
          ...
          expect(
            () => validate(validator, opts.myNum, 'myNum', opts)
          ).toThrow(/myNum should be in range \[12, 13\], received: 11/)
        })
    ...
    describe('undefinedOr', () => {
      ...
      it('should throw when the value is a string', () => {
        expect(() => validate(validator, 'foo' as unknown as number))
          .toThrow(/should be undefined or a number, received: 'foo'/)
      })
