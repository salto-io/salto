...
>[] = [
  ...
  },
  {
    ...
    target: { type: APPLICATION_API_TYPE_NAME },
    serializationStrategy: 'id',
  },
  {
    src: {
      field: DELEGATED_PERMISSION_IDS_FIELD_NAME,
      parentTypes: [toNestedTypeName(APPLICATION_API_TYPE_NAME, PRE_AUTHORIZED_APPLICATIONS_FIELD_NAME)],
    },
    target: { type: APPLICATION_OAUTH_2_PERMISSION_SCOPES_TYPE_NAME },
    serializationStrategy: 'id',
  },
  {
