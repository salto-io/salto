...
const TYPE_NAME_TO_READ_ONLY_FIELDS: Record<string, ReadOnlyFieldDefinition[]> = {
  /* Entra instances */
  [entraConstants.TOP_LEVEL_TYPES.ROLE_DEFINITION_TYPE_NAME]: [{ fieldName: 'inheritsPermissionsFrom' }],
  [entraConstants.TOP_LEVEL_TYPES.SERVICE_PRINCIPAL_TYPE_NAME]: [{ fieldName: 'appId' }, { fieldName: 'displayName' }],
  ...
  [entraConstants.TOP_LEVEL_TYPES.OAUTH2_PERMISSION_GRANT_TYPE_NAME]: [
    { fieldName: 'clientId' },
  ...
  [entraConstants.TOP_LEVEL_TYPES.CUSTOM_SECURITY_ATTRIBUTE_DEFINITION_TYPE_NAME]: [
  ...
  [entraConstants.TOP_LEVEL_TYPES.CUSTOM_SECURITY_ATTRIBUTE_SET_TYPE_NAME]: [{ fieldName: 'id' }],
  [entraConstants.TOP_LEVEL_TYPES.DOMAIN_TYPE_NAME]: [
    { fieldName: entraConstants.DOMAIN_NAME_REFERENCES_FIELD_NAME },
    { fieldName: 'id' },
  ],
  [entraConstants.TOP_LEVEL_TYPES.GROUP_TYPE_NAME]: [
