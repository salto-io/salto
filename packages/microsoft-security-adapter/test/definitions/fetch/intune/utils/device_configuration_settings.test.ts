    ...
    describe('when the instance has settings', () => {
      it('should set the script value as a static file', async () => {
        ...
        const expectedSettings = [
          ...PLATFORM_SCRIPT_VALUE_WITH_SETTINGS.settings.slice(0, 3),
          {
            settingInstance: {
              ...PLATFORM_SCRIPT_VALUE_WITH_SETTINGS.settings[3].settingInstance,
              simpleSettingValue: {
                ...PLATFORM_SCRIPT_VALUE_WITH_SETTINGS.settings[3].settingInstance.simpleSettingValue,
