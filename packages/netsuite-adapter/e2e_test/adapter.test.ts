...
//       return
//     }
//     // Due to a known SDF bug, sometimes
// we fail to fetch all types at once but succeed when trying
...
//     { name: randomString }
//   )
//   workflowToCreate.value.
// workflowstates.workflowstate[0].workflowtransitions.workflowtransition[0]
...
// createNestedID('workflowstates', 'workflowstate', '1', SCRIPT_ID)
//         )).toBe(true)
//     })
