...
export const centercategoryType = (): TypeAndInnerTypes => {
  ...
  innerTypes.centercategory_links_link = centercategory_links_link
  ...
  innerTypes.centercategory_links = centercategory_links

  const centercategory = new ObjectType({
  ...
  return { type: centercategory, innerTypes }
}
