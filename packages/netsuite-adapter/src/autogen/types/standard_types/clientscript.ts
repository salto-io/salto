...
export const clientscriptType = (): TypeAndInnerTypes => {
  ...
  innerTypes.clientscript_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilter = clientscript_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilter
  ...
  const clientscript_scriptcustomfields_scriptcustomfield_customfieldfilters = new ObjectType({
    ...
    fields: {
      customfieldfilter: {
        refType: createRefToElmWithValue(new ListType(clientscript_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilter)),
        annotations: {
        },
      },
    },
  ...
  innerTypes.clientscript_scriptcustomfields_scriptcustomfield_customfieldfilters = clientscript_scriptcustomfields_scriptcustomfield_customfieldfilters
  ...
  innerTypes.clientscript_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccess = clientscript_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccess
  ...
  const clientscript_scriptcustomfields_scriptcustomfield_roleaccesses = new ObjectType({
    ...
    fields: {
      roleaccess: {
        refType: createRefToElmWithValue(new ListType(clientscript_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccess)),
        annotations: {
        },
      },
    },
  ...
  innerTypes.clientscript_scriptcustomfields_scriptcustomfield_roleaccesses = clientscript_scriptcustomfields_scriptcustomfield_roleaccesses
