...
export const customrecordactionscriptType = (): TypeAndInnerTypes => {
  const innerTypes: Record<string, ObjectType> = {}

  const customrecordactionscriptElemID = new ElemID(constants.NETSUITE, 'customrecordactionscript')
  const customrecordactionscript_customplugintypes_plugintypeElemID = new ElemID(
    constants.NETSUITE,
    'customrecordactionscript_customplugintypes_plugintype',
  )
  ...
  innerTypes.customrecordactionscript_customplugintypes_plugintype =
    customrecordactionscript_customplugintypes_plugintype

  const customrecordactionscript_customplugintypesElemID = new ElemID(
    constants.NETSUITE,
    'customrecordactionscript_customplugintypes',
  )
  ...
  innerTypes.customrecordactionscript_customplugintypes = customrecordactionscript_customplugintypes

  const customrecordactionscript_libraries_libraryElemID = new ElemID(
    constants.NETSUITE,
    'customrecordactionscript_libraries_library',
  )
  ...
  innerTypes.customrecordactionscript_libraries_library = customrecordactionscript_libraries_library
  ...
  innerTypes.customrecordactionscript_libraries = customrecordactionscript_libraries

  const customrecordactionscript_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilterElemID =
    new ElemID(
      constants.NETSUITE,
      'customrecordactionscript_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilter',
    )

  const customrecordactionscript_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilter =
    new ObjectType({
  ...
  innerTypes.customrecordactionscript_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilter =
    customrecordactionscript_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilter

  const customrecordactionscript_scriptcustomfields_scriptcustomfield_customfieldfiltersElemID = new ElemID(
    constants.NETSUITE,
    'customrecordactionscript_scriptcustomfields_scriptcustomfield_customfieldfilters',
  )
  ...
  innerTypes.customrecordactionscript_scriptcustomfields_scriptcustomfield_customfieldfilters =
    customrecordactionscript_scriptcustomfields_scriptcustomfield_customfieldfilters

  const customrecordactionscript_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccessElemID = new ElemID(
    constants.NETSUITE,
    'customrecordactionscript_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccess',
  )
  ...
  innerTypes.customrecordactionscript_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccess =
    customrecordactionscript_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccess

  const customrecordactionscript_scriptcustomfields_scriptcustomfield_roleaccessesElemID = new ElemID(
    constants.NETSUITE,
    'customrecordactionscript_scriptcustomfields_scriptcustomfield_roleaccesses',
  )
  ...
  const customrecordactionscript_scriptcustomfields_scriptcustomfield_roleaccesses = new ObjectType({
    ...
    fields: {
      roleaccess: {
        refType: createRefToElmWithValue(
          new ListType(customrecordactionscript_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccess),
        ),
        annotations: {},
      },
    },
  ...
  innerTypes.customrecordactionscript_scriptcustomfields_scriptcustomfield_roleaccesses =
    customrecordactionscript_scriptcustomfields_scriptcustomfield_roleaccesses

  const customrecordactionscript_scriptcustomfields_scriptcustomfieldElemID = new ElemID(
    constants.NETSUITE,
    'customrecordactionscript_scriptcustomfields_scriptcustomfield',
  )
  ...
  innerTypes.customrecordactionscript_scriptcustomfields_scriptcustomfield =
    customrecordactionscript_scriptcustomfields_scriptcustomfield

  const customrecordactionscript_scriptcustomfieldsElemID = new ElemID(
    constants.NETSUITE,
    'customrecordactionscript_scriptcustomfields',
  )
  ...
  innerTypes.customrecordactionscript_scriptcustomfields = customrecordactionscript_scriptcustomfields

  const customrecordactionscript_scriptdeployments_scriptdeploymentElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.customrecordactionscript_scriptdeployments_scriptdeployment =
    customrecordactionscript_scriptdeployments_scriptdeployment

  const customrecordactionscript_scriptdeploymentsElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.customrecordactionscript_scriptdeployments = customrecordactionscript_scriptdeployments

  const customrecordactionscript = new ObjectType({
  ...
  return { type: customrecordactionscript, innerTypes }
}
