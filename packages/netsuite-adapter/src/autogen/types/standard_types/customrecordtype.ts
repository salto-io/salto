...
export const customrecordtypeType = (): TypeAndInnerTypes => {
  const innerTypes: Record<string, ObjectType> = {}

  const customrecordtypeElemID = new ElemID(constants.NETSUITE, 'customrecordtype')
  const customrecordtype_customrecordcustomfields_customrecordcustomfield_customfieldfilters_customfieldfilterElemID =
    new ElemID(
      constants.NETSUITE,
      'customrecordtype_customrecordcustomfields_customrecordcustomfield_customfieldfilters_customfieldfilter',
    )

  const customrecordtype_customrecordcustomfields_customrecordcustomfield_customfieldfilters_customfieldfilter =
    new ObjectType({
      elemID:
  ...
  innerTypes.customrecordtype_customrecordcustomfields_customrecordcustomfield_customfieldfilters_customfieldfilter =
    customrecordtype_customrecordcustomfields_customrecordcustomfield_customfieldfilters_customfieldfilter

  const customrecordtype_customrecordcustomfields_customrecordcustomfield_customfieldfiltersElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.customrecordtype_customrecordcustomfields_customrecordcustomfield_customfieldfilters =
    customrecordtype_customrecordcustomfields_customrecordcustomfield_customfieldfilters

  const customrecordtype_customrecordcustomfields_customrecordcustomfield_roleaccesses_roleaccessElemID = new ElemID(
    constants.NETSUITE,
    'customrecordtype_customrecordcustomfields_customrecordcustomfield_roleaccesses_roleaccess',
  )
  ...
  innerTypes.customrecordtype_customrecordcustomfields_customrecordcustomfield_roleaccesses_roleaccess =
    customrecordtype_customrecordcustomfields_customrecordcustomfield_roleaccesses_roleaccess

  const customrecordtype_customrecordcustomfields_customrecordcustomfield_roleaccessesElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.customrecordtype_customrecordcustomfields_customrecordcustomfield_roleaccesses =
    customrecordtype_customrecordcustomfields_customrecordcustomfield_roleaccesses

  const customrecordtype_customrecordcustomfields_customrecordcustomfieldElemID = new ElemID(
    constants.NETSUITE,
    'customrecordtype_customrecordcustomfields_customrecordcustomfield',
  )
  ...
  innerTypes.customrecordtype_customrecordcustomfields_customrecordcustomfield =
    customrecordtype_customrecordcustomfields_customrecordcustomfield

  const customrecordtype_customrecordcustomfieldsElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.customrecordtype_customrecordcustomfields = customrecordtype_customrecordcustomfields

  const customrecordtype_instances_instanceElemID = new ElemID(
    constants.NETSUITE,
    'customrecordtype_instances_instance',
  )
  ...
  innerTypes.customrecordtype_instances_instance = customrecordtype_instances_instance
  ...
  innerTypes.customrecordtype_instances = customrecordtype_instances
  ...
  innerTypes.customrecordtype_links_link = customrecordtype_links_link
  ...
  innerTypes.customrecordtype_links = customrecordtype_links

  const customrecordtype_permissions_permissionElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.customrecordtype_permissions_permission = customrecordtype_permissions_permission
  ...
  innerTypes.customrecordtype_permissions = customrecordtype_permissions

  const customrecordtype_recordsublists_recordsublistElemID = new ElemID(
    constants.NETSUITE,
    'customrecordtype_recordsublists_recordsublist',
  )
  ...
  innerTypes.customrecordtype_recordsublists_recordsublist = customrecordtype_recordsublists_recordsublist
  ...
  innerTypes.customrecordtype_recordsublists = customrecordtype_recordsublists
  ...
  innerTypes.customrecordtype_subtabs_subtab = customrecordtype_subtabs_subtab
  ...
  innerTypes.customrecordtype_subtabs = customrecordtype_subtabs
  ...
  return { type: customrecordtype, innerTypes }
}
