...
export const customsegmentType = (): TypeAndInnerTypes => {
  ...
  innerTypes.customsegment_permissions_permission = customsegment_permissions_permission
  ...
  innerTypes.customsegment_segmentapplication_transactionline = customsegment_segmentapplication_transactionline
