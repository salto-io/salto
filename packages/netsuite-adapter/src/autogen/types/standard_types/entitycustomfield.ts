...
export const entitycustomfieldType = (): TypeAndInnerTypes => {
  const innerTypes: Record<string, ObjectType> = {}

  const entitycustomfieldElemID = new ElemID(constants.NETSUITE, 'entitycustomfield')
  const entitycustomfield_customfieldfilters_customfieldfilterElemID = new ElemID(
    constants.NETSUITE,
    'entitycustomfield_customfieldfilters_customfieldfilter',
  )
  ...
  innerTypes.entitycustomfield_customfieldfilters_customfieldfilter =
    entitycustomfield_customfieldfilters_customfieldfilter

  const entitycustomfield_customfieldfiltersElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.entitycustomfield_customfieldfilters = entitycustomfield_customfieldfilters

  const entitycustomfield_roleaccesses_roleaccessElemID = new ElemID(
    constants.NETSUITE,
    'entitycustomfield_roleaccesses_roleaccess',
  )
  ...
  innerTypes.entitycustomfield_roleaccesses_roleaccess = entitycustomfield_roleaccesses_roleaccess
  ...
  innerTypes.entitycustomfield_roleaccesses = entitycustomfield_roleaccesses

  const entitycustomfield = new ObjectType({
  ...
  return { type: entitycustomfield, innerTypes }
}
