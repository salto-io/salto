...
export const fiparserpluginType = (): TypeAndInnerTypes => {
  const innerTypes: Record<string, ObjectType> = {}

  const fiparserpluginElemID = new ElemID(constants.NETSUITE, 'fiparserplugin')

  const fiparserplugin = new ObjectType({
    elemID: fiparserpluginElemID,
    annotations: {},
    fields: {
      scriptid: {
    ...
    path: [constants.NETSUITE, constants.TYPES_PATH, fiparserpluginElemID.name],
  })

  return { type: fiparserplugin, innerTypes }
}
