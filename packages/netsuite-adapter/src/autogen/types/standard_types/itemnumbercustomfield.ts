...
export const itemnumbercustomfieldType = (): TypeAndInnerTypes => {
  const innerTypes: Record<string, ObjectType> = {}

  const itemnumbercustomfieldElemID = new ElemID(constants.NETSUITE, 'itemnumbercustomfield')
  const itemnumbercustomfield_customfieldfilters_customfieldfilterElemID = new ElemID(
    constants.NETSUITE,
    'itemnumbercustomfield_customfieldfilters_customfieldfilter',
  )
  ...
  innerTypes.itemnumbercustomfield_customfieldfilters_customfieldfilter =
    itemnumbercustomfield_customfieldfilters_customfieldfilter

  const itemnumbercustomfield_customfieldfiltersElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.itemnumbercustomfield_customfieldfilters = itemnumbercustomfield_customfieldfilters

  const itemnumbercustomfield_roleaccesses_roleaccessElemID = new ElemID(
    constants.NETSUITE,
    'itemnumbercustomfield_roleaccesses_roleaccess',
  )
  ...
  innerTypes.itemnumbercustomfield_roleaccesses_roleaccess = itemnumbercustomfield_roleaccesses_roleaccess
  ...
  innerTypes.itemnumbercustomfield_roleaccesses = itemnumbercustomfield_roleaccesses

  const itemnumbercustomfield = new ObjectType({
  ...
  return { type: itemnumbercustomfield, innerTypes }
}
