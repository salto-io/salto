...
export const itemoptioncustomfieldType = (): TypeAndInnerTypes => {
  const innerTypes: Record<string, ObjectType> = {}

  const itemoptioncustomfieldElemID = new ElemID(constants.NETSUITE, 'itemoptioncustomfield')
  const itemoptioncustomfield_customfieldfilters_customfieldfilterElemID = new ElemID(
    constants.NETSUITE,
    'itemoptioncustomfield_customfieldfilters_customfieldfilter',
  )
  ...
  innerTypes.itemoptioncustomfield_customfieldfilters_customfieldfilter =
    itemoptioncustomfield_customfieldfilters_customfieldfilter

  const itemoptioncustomfield_customfieldfiltersElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.itemoptioncustomfield_customfieldfilters = itemoptioncustomfield_customfieldfilters

  const itemoptioncustomfield_roleaccesses_roleaccessElemID = new ElemID(
    constants.NETSUITE,
    'itemoptioncustomfield_roleaccesses_roleaccess',
  )
  ...
  innerTypes.itemoptioncustomfield_roleaccesses_roleaccess = itemoptioncustomfield_roleaccesses_roleaccess
  ...
  innerTypes.itemoptioncustomfield_roleaccesses = itemoptioncustomfield_roleaccesses

  const itemoptioncustomfield = new ObjectType({
  ...
  return { type: itemoptioncustomfield, innerTypes }
}
