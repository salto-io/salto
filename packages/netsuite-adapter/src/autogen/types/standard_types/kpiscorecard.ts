...
export const kpiscorecardType = (): TypeAndInnerTypes => {
  ...
  innerTypes.kpiscorecard_audience = kpiscorecard_audience
  ...
  innerTypes.kpiscorecard_highlightings_highlighting = kpiscorecard_highlightings_highlighting
  ...
  innerTypes.kpiscorecard_highlightings = kpiscorecard_highlightings
  ...
  innerTypes.kpiscorecard_kpis_kpi = kpiscorecard_kpis_kpi
  ...
  innerTypes.kpiscorecard_kpis = kpiscorecard_kpis
  ...
  innerTypes.kpiscorecard_ranges_range = kpiscorecard_ranges_range
