...
export const massupdatescriptType = (): TypeAndInnerTypes => {
  ...
  innerTypes.massupdatescript_libraries_library = massupdatescript_libraries_library
  ...
  const massupdatescript_libraries = new ObjectType({
    ...
    fields: {
      library: {
        refType: createRefToElmWithValue(new ListType(massupdatescript_libraries_library)),
        annotations: {},
      },
    },
    path: [constants.NETSUITE, constants.TYPES_PATH, massupdatescriptElemID.name],
  ...
  innerTypes.massupdatescript_libraries = massupdatescript_libraries

  const massupdatescript_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilterElemID = new ElemID(
    constants.NETSUITE,
    'massupdatescript_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilter',
  )
  ...
  innerTypes.massupdatescript_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilter =
    massupdatescript_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilter

  const massupdatescript_scriptcustomfields_scriptcustomfield_customfieldfiltersElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.massupdatescript_scriptcustomfields_scriptcustomfield_customfieldfilters =
    massupdatescript_scriptcustomfields_scriptcustomfield_customfieldfilters

  const massupdatescript_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccessElemID = new ElemID(
    constants.NETSUITE,
    'massupdatescript_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccess',
  )
  ...
  innerTypes.massupdatescript_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccess =
    massupdatescript_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccess

  const massupdatescript_scriptcustomfields_scriptcustomfield_roleaccessesElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.massupdatescript_scriptcustomfields_scriptcustomfield_roleaccesses =
    massupdatescript_scriptcustomfields_scriptcustomfield_roleaccesses

  const massupdatescript_scriptcustomfields_scriptcustomfieldElemID = new ElemID(
    constants.NETSUITE,
    'massupdatescript_scriptcustomfields_scriptcustomfield',
  )
  ...
  const massupdatescript_scriptcustomfields_scriptcustomfield = new ObjectType({
    ...
    fields: {
      ...
      customfieldfilters: {
        refType: createRefToElmWithValue(massupdatescript_scriptcustomfields_scriptcustomfield_customfieldfilters),
        annotations: {},
      },
      roleaccesses: {
        refType: createRefToElmWithValue(massupdatescript_scriptcustomfields_scriptcustomfield_roleaccesses),
        annotations: {},
      },
    },
    path: [constants.NETSUITE, constants.TYPES_PATH, massupdatescriptElemID.name],
  ...
  innerTypes.massupdatescript_scriptcustomfields_scriptcustomfield =
    massupdatescript_scriptcustomfields_scriptcustomfield

  const massupdatescript_scriptcustomfieldsElemID = new ElemID(
    constants.NETSUITE,
  ...
  const massupdatescript_scriptcustomfields = new ObjectType({
    ...
    fields: {
      scriptcustomfield: {
        refType: createRefToElmWithValue(new ListType(massupdatescript_scriptcustomfields_scriptcustomfield)),
        annotations: {},
      },
    },
    path: [constants.NETSUITE, constants.TYPES_PATH, massupdatescriptElemID.name],
  ...
  innerTypes.massupdatescript_scriptcustomfields = massupdatescript_scriptcustomfields

  const massupdatescript_scriptdeployments_scriptdeploymentElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.massupdatescript_scriptdeployments_scriptdeployment = massupdatescript_scriptdeployments_scriptdeployment
  ...
  const massupdatescript_scriptdeployments = new ObjectType({
    ...
    fields: {
      scriptdeployment: {
        refType: createRefToElmWithValue(new ListType(massupdatescript_scriptdeployments_scriptdeployment)),
        annotations: {},
      },
    },
    path: [constants.NETSUITE, constants.TYPES_PATH, massupdatescriptElemID.name],
  ...
  innerTypes.massupdatescript_scriptdeployments = massupdatescript_scriptdeployments

  const massupdatescript = new ObjectType({
    ...
    fields: {
      ...
      libraries: {
        refType: createRefToElmWithValue(massupdatescript_libraries),
        annotations: {},
      },
      scriptcustomfields: {
        refType: createRefToElmWithValue(massupdatescript_scriptcustomfields),
        annotations: {},
      },
      scriptdeployments: {
        refType: createRefToElmWithValue(massupdatescript_scriptdeployments),
        annotations: {},
      },
    },
    path: [constants.NETSUITE, constants.TYPES_PATH, massupdatescriptElemID.name],
  ...
  return { type: massupdatescript, innerTypes }
}
