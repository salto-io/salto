...
export const massupdatescriptType = (): TypeAndInnerTypes => {
  ...
  innerTypes.massupdatescript_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilter = massupdatescript_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilter
  ...
  const massupdatescript_scriptcustomfields_scriptcustomfield_customfieldfilters = new ObjectType({
    ...
    fields: {
      customfieldfilter: {
        refType: createRefToElmWithValue(new ListType(massupdatescript_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilter)),
        annotations: {
        },
      },
    },
  ...
  innerTypes.massupdatescript_scriptcustomfields_scriptcustomfield_customfieldfilters = massupdatescript_scriptcustomfields_scriptcustomfield_customfieldfilters
  ...
  innerTypes.massupdatescript_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccess = massupdatescript_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccess
  ...
  const massupdatescript_scriptcustomfields_scriptcustomfield_roleaccesses = new ObjectType({
    ...
    fields: {
      roleaccess: {
        refType: createRefToElmWithValue(new ListType(massupdatescript_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccess)),
        annotations: {
        },
      },
    },
  ...
  innerTypes.massupdatescript_scriptcustomfields_scriptcustomfield_roleaccesses = massupdatescript_scriptcustomfields_scriptcustomfield_roleaccesses
  ...
  innerTypes.massupdatescript_scriptcustomfields_scriptcustomfield = massupdatescript_scriptcustomfields_scriptcustomfield
