...
export const othercustomfieldType = (): TypeAndInnerTypes => {
  const innerTypes: Record<string, ObjectType> = {}

  const othercustomfieldElemID = new ElemID(constants.NETSUITE, 'othercustomfield')
  const othercustomfield_customfieldfilters_customfieldfilterElemID = new ElemID(
    constants.NETSUITE,
    'othercustomfield_customfieldfilters_customfieldfilter',
  )
  ...
  innerTypes.othercustomfield_customfieldfilters_customfieldfilter =
    othercustomfield_customfieldfilters_customfieldfilter

  const othercustomfield_customfieldfiltersElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.othercustomfield_customfieldfilters = othercustomfield_customfieldfilters

  const othercustomfield_roleaccesses_roleaccessElemID = new ElemID(
    constants.NETSUITE,
    'othercustomfield_roleaccesses_roleaccess',
  )
  ...
  innerTypes.othercustomfield_roleaccesses_roleaccess = othercustomfield_roleaccesses_roleaccess
  ...
  innerTypes.othercustomfield_roleaccesses = othercustomfield_roleaccesses

  const othercustomfield = new ObjectType({
  ...
  return { type: othercustomfield, innerTypes }
}
