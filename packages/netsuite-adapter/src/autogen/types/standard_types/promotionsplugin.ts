...
export const promotionspluginType = (): TypeAndInnerTypes => {
  ...
  innerTypes.promotionsplugin_libraries_library = promotionsplugin_libraries_library
  ...
  innerTypes.promotionsplugin_libraries = promotionsplugin_libraries

  const promotionsplugin = new ObjectType({
  ...
  return { type: promotionsplugin, innerTypes }
}
