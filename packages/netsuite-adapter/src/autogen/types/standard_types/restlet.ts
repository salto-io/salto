...
export const restletType = (): TypeAndInnerTypes => {
  ...
  innerTypes.restlet_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilter = restlet_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilter
  ...
  const restlet_scriptcustomfields_scriptcustomfield_customfieldfilters = new ObjectType({
    ...
    fields: {
      customfieldfilter: {
        refType: createRefToElmWithValue(new ListType(restlet_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilter)),
        annotations: {
        },
      },
    },
  ...
  innerTypes.restlet_scriptcustomfields_scriptcustomfield_customfieldfilters = restlet_scriptcustomfields_scriptcustomfield_customfieldfilters
  ...
  innerTypes.restlet_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccess = restlet_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccess
  ...
  const restlet_scriptcustomfields_scriptcustomfield_roleaccesses = new ObjectType({
    ...
    fields: {
      roleaccess: {
        refType: createRefToElmWithValue(new ListType(restlet_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccess)),
        annotations: {
        },
      },
    },
  ...
  innerTypes.restlet_scriptcustomfields_scriptcustomfield_roleaccesses = restlet_scriptcustomfields_scriptcustomfield_roleaccesses
