...
export const sdfinstallationscriptType = (): TypeAndInnerTypes => {
  const innerTypes: Record<string, ObjectType> = {}

  const sdfinstallationscriptElemID = new ElemID(constants.NETSUITE, 'sdfinstallationscript')
  const sdfinstallationscript_customplugintypes_plugintypeElemID = new ElemID(
    constants.NETSUITE,
    'sdfinstallationscript_customplugintypes_plugintype',
  )
  ...
  innerTypes.sdfinstallationscript_customplugintypes_plugintype = sdfinstallationscript_customplugintypes_plugintype

  const sdfinstallationscript_customplugintypesElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.sdfinstallationscript_customplugintypes = sdfinstallationscript_customplugintypes

  const sdfinstallationscript_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilterElemID =
    new ElemID(
      constants.NETSUITE,
      'sdfinstallationscript_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilter',
    )

  const sdfinstallationscript_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilter =
    new ObjectType({
  ...
  innerTypes.sdfinstallationscript_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilter =
    sdfinstallationscript_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilter

  const sdfinstallationscript_scriptcustomfields_scriptcustomfield_customfieldfiltersElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.sdfinstallationscript_scriptcustomfields_scriptcustomfield_customfieldfilters =
    sdfinstallationscript_scriptcustomfields_scriptcustomfield_customfieldfilters

  const sdfinstallationscript_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccessElemID = new ElemID(
    constants.NETSUITE,
    'sdfinstallationscript_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccess',
  )
  ...
  innerTypes.sdfinstallationscript_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccess =
    sdfinstallationscript_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccess

  const sdfinstallationscript_scriptcustomfields_scriptcustomfield_roleaccessesElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.sdfinstallationscript_scriptcustomfields_scriptcustomfield_roleaccesses =
    sdfinstallationscript_scriptcustomfields_scriptcustomfield_roleaccesses

  const sdfinstallationscript_scriptcustomfields_scriptcustomfieldElemID = new ElemID(
    constants.NETSUITE,
    'sdfinstallationscript_scriptcustomfields_scriptcustomfield',
  )
  ...
  innerTypes.sdfinstallationscript_scriptcustomfields_scriptcustomfield =
    sdfinstallationscript_scriptcustomfields_scriptcustomfield

  const sdfinstallationscript_scriptcustomfieldsElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.sdfinstallationscript_scriptcustomfields = sdfinstallationscript_scriptcustomfields

  const sdfinstallationscript_scriptdeployments_scriptdeploymentElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.sdfinstallationscript_scriptdeployments_scriptdeployment =
    sdfinstallationscript_scriptdeployments_scriptdeployment

  const sdfinstallationscript_scriptdeploymentsElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.sdfinstallationscript_scriptdeployments = sdfinstallationscript_scriptdeployments

  const sdfinstallationscript = new ObjectType({
  ...
  return { type: sdfinstallationscript, innerTypes }
}
