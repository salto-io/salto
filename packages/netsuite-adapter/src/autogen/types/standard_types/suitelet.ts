...
export const suiteletType = (): TypeAndInnerTypes => {
  const innerTypes: Record<string, ObjectType> = {}

  const suiteletElemID = new ElemID(constants.NETSUITE, 'suitelet')
  const suitelet_customplugintypes_plugintypeElemID = new ElemID(
    constants.NETSUITE,
    'suitelet_customplugintypes_plugintype',
  )
  ...
  innerTypes.suitelet_customplugintypes_plugintype = suitelet_customplugintypes_plugintype
  ...
  innerTypes.suitelet_customplugintypes = suitelet_customplugintypes
  ...
  innerTypes.suitelet_libraries_library = suitelet_libraries_library
  ...
  innerTypes.suitelet_libraries = suitelet_libraries

  const suitelet_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilterElemID = new ElemID(
    constants.NETSUITE,
    'suitelet_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilter',
  )
  ...
  innerTypes.suitelet_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilter =
    suitelet_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilter

  const suitelet_scriptcustomfields_scriptcustomfield_customfieldfiltersElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.suitelet_scriptcustomfields_scriptcustomfield_customfieldfilters =
    suitelet_scriptcustomfields_scriptcustomfield_customfieldfilters

  const suitelet_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccessElemID = new ElemID(
    constants.NETSUITE,
    'suitelet_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccess',
  )
  ...
  innerTypes.suitelet_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccess =
    suitelet_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccess

  const suitelet_scriptcustomfields_scriptcustomfield_roleaccessesElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.suitelet_scriptcustomfields_scriptcustomfield_roleaccesses =
    suitelet_scriptcustomfields_scriptcustomfield_roleaccesses

  const suitelet_scriptcustomfields_scriptcustomfieldElemID = new ElemID(
    constants.NETSUITE,
    'suitelet_scriptcustomfields_scriptcustomfield',
  )
  ...
  innerTypes.suitelet_scriptcustomfields_scriptcustomfield = suitelet_scriptcustomfields_scriptcustomfield
  ...
  innerTypes.suitelet_scriptcustomfields = suitelet_scriptcustomfields

  const suitelet_scriptdeployments_scriptdeployment_links_linkElemID = new ElemID(
    constants.NETSUITE,
    'suitelet_scriptdeployments_scriptdeployment_links_link',
  )
  ...
  innerTypes.suitelet_scriptdeployments_scriptdeployment_links_link =
    suitelet_scriptdeployments_scriptdeployment_links_link

  const suitelet_scriptdeployments_scriptdeployment_linksElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.suitelet_scriptdeployments_scriptdeployment_links = suitelet_scriptdeployments_scriptdeployment_links

  const suitelet_scriptdeployments_scriptdeploymentElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.suitelet_scriptdeployments_scriptdeployment = suitelet_scriptdeployments_scriptdeployment
  ...
  innerTypes.suitelet_scriptdeployments = suitelet_scriptdeployments

  const suitelet = new ObjectType({
  ...
  return { type: suitelet, innerTypes }
}
