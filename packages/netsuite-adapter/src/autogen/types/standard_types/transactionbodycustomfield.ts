...
export const transactionbodycustomfieldType = (): TypeAndInnerTypes => {
  const innerTypes: Record<string, ObjectType> = {}

  const transactionbodycustomfieldElemID = new ElemID(constants.NETSUITE, 'transactionbodycustomfield')
  const transactionbodycustomfield_customfieldfilters_customfieldfilterElemID = new ElemID(
    constants.NETSUITE,
    'transactionbodycustomfield_customfieldfilters_customfieldfilter',
  )
  ...
  innerTypes.transactionbodycustomfield_customfieldfilters_customfieldfilter =
    transactionbodycustomfield_customfieldfilters_customfieldfilter

  const transactionbodycustomfield_customfieldfiltersElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.transactionbodycustomfield_customfieldfilters = transactionbodycustomfield_customfieldfilters

  const transactionbodycustomfield_roleaccesses_roleaccessElemID = new ElemID(
    constants.NETSUITE,
    'transactionbodycustomfield_roleaccesses_roleaccess',
  )
  ...
  innerTypes.transactionbodycustomfield_roleaccesses_roleaccess = transactionbodycustomfield_roleaccesses_roleaccess

  const transactionbodycustomfield_roleaccessesElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.transactionbodycustomfield_roleaccesses = transactionbodycustomfield_roleaccesses

  const transactionbodycustomfield = new ObjectType({
  ...
  return { type: transactionbodycustomfield, innerTypes }
}
