...
export const transactioncolumncustomfieldType = (): TypeAndInnerTypes => {
  const innerTypes: Record<string, ObjectType> = {}

  const transactioncolumncustomfieldElemID = new ElemID(constants.NETSUITE, 'transactioncolumncustomfield')
  const transactioncolumncustomfield_customfieldfilters_customfieldfilterElemID = new ElemID(
    constants.NETSUITE,
    'transactioncolumncustomfield_customfieldfilters_customfieldfilter',
  )
  ...
  innerTypes.transactioncolumncustomfield_customfieldfilters_customfieldfilter =
    transactioncolumncustomfield_customfieldfilters_customfieldfilter

  const transactioncolumncustomfield_customfieldfiltersElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.transactioncolumncustomfield_customfieldfilters = transactioncolumncustomfield_customfieldfilters

  const transactioncolumncustomfield_roleaccesses_roleaccessElemID = new ElemID(
    constants.NETSUITE,
    'transactioncolumncustomfield_roleaccesses_roleaccess',
  )
  ...
  innerTypes.transactioncolumncustomfield_roleaccesses_roleaccess = transactioncolumncustomfield_roleaccesses_roleaccess

  const transactioncolumncustomfield_roleaccessesElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.transactioncolumncustomfield_roleaccesses = transactioncolumncustomfield_roleaccesses

  const transactioncolumncustomfield = new ObjectType({
  ...
  return { type: transactioncolumncustomfield, innerTypes }
}
