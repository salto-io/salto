...
export const usereventscriptType = (): TypeAndInnerTypes => {
  ...
  innerTypes.usereventscript_customplugintypes_plugintype = usereventscript_customplugintypes_plugintype
  ...
  innerTypes.usereventscript_customplugintypes = usereventscript_customplugintypes
  ...
  innerTypes.usereventscript_libraries_library = usereventscript_libraries_library
  ...
  innerTypes.usereventscript_scriptcustomfields_scriptcustomfield = usereventscript_scriptcustomfields_scriptcustomfield
  ...
  innerTypes.usereventscript_scriptdeployments_scriptdeployment = usereventscript_scriptdeployments_scriptdeployment
