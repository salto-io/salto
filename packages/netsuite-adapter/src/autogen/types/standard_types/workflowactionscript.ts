...
export const workflowactionscriptType = (): TypeAndInnerTypes => {
  const innerTypes: Record<string, ObjectType> = {}

  const workflowactionscriptElemID = new ElemID(constants.NETSUITE, 'workflowactionscript')
  const workflowactionscript_customplugintypes_plugintypeElemID = new ElemID(
    constants.NETSUITE,
    'workflowactionscript_customplugintypes_plugintype',
  )
  ...
  innerTypes.workflowactionscript_customplugintypes_plugintype = workflowactionscript_customplugintypes_plugintype

  const workflowactionscript_customplugintypesElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.workflowactionscript_customplugintypes = workflowactionscript_customplugintypes

  const workflowactionscript_libraries_libraryElemID = new ElemID(
    constants.NETSUITE,
    'workflowactionscript_libraries_library',
  )
  ...
  innerTypes.workflowactionscript_libraries_library = workflowactionscript_libraries_library
  ...
  innerTypes.workflowactionscript_libraries = workflowactionscript_libraries

  const workflowactionscript_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilterElemID =
    new ElemID(
      constants.NETSUITE,
      'workflowactionscript_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilter',
    )
  ...
  innerTypes.workflowactionscript_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilter =
    workflowactionscript_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilter

  const workflowactionscript_scriptcustomfields_scriptcustomfield_customfieldfiltersElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.workflowactionscript_scriptcustomfields_scriptcustomfield_customfieldfilters =
    workflowactionscript_scriptcustomfields_scriptcustomfield_customfieldfilters

  const workflowactionscript_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccessElemID = new ElemID(
    constants.NETSUITE,
    'workflowactionscript_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccess',
  )
  ...
  innerTypes.workflowactionscript_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccess =
    workflowactionscript_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccess

  const workflowactionscript_scriptcustomfields_scriptcustomfield_roleaccessesElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.workflowactionscript_scriptcustomfields_scriptcustomfield_roleaccesses =
    workflowactionscript_scriptcustomfields_scriptcustomfield_roleaccesses

  const workflowactionscript_scriptcustomfields_scriptcustomfieldElemID = new ElemID(
    constants.NETSUITE,
    'workflowactionscript_scriptcustomfields_scriptcustomfield',
  )
  ...
  innerTypes.workflowactionscript_scriptcustomfields_scriptcustomfield =
    workflowactionscript_scriptcustomfields_scriptcustomfield

  const workflowactionscript_scriptcustomfieldsElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.workflowactionscript_scriptcustomfields = workflowactionscript_scriptcustomfields

  const workflowactionscript_scriptdeployments_scriptdeploymentElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.workflowactionscript_scriptdeployments_scriptdeployment =
    workflowactionscript_scriptdeployments_scriptdeployment

  const workflowactionscript_scriptdeploymentsElemID = new ElemID(
    constants.NETSUITE,
  ...
  innerTypes.workflowactionscript_scriptdeployments = workflowactionscript_scriptdeployments

  const workflowactionscript = new ObjectType({
  ...
  return { type: workflowactionscript, innerTypes }
}
