...
const customrecordactionscript_customplugintypes = new ObjectType({
  ...
  fields: {
    plugintype: {
      refType: new ListType(customrecordactionscript_customplugintypes_plugintype),
      annotations: {
      },
    },
  },
...
const customrecordactionscript_libraries = new ObjectType({
  ...
  fields: {
    library: {
      refType: new ListType(customrecordactionscript_libraries_library),
      annotations: {
      },
    },
  },
...
const customrecordactionscript_scriptcustomfields_scriptcustomfield_customfieldfilters = new ObjectType({
  ...
  fields: {
    customfieldfilter: {
      refType: new ListType(customrecordactionscript_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilter),
      annotations: {
      },
    },
  },
...
const customrecordactionscript_scriptcustomfields_scriptcustomfield_roleaccesses = new ObjectType({
  ...
  fields: {
    roleaccess: {
      refType: new ListType(customrecordactionscript_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccess),
      annotations: {
      },
    },
  },
...
const customrecordactionscript_scriptcustomfields_scriptcustomfield = new ObjectType({
  ...
  fields: {
    ...
    customfieldfilters: {
      refType: customrecordactionscript_scriptcustomfields_scriptcustomfield_customfieldfilters,
      annotations: {
      },
    },
    roleaccesses: {
      refType: customrecordactionscript_scriptcustomfields_scriptcustomfield_roleaccesses,
      annotations: {
      },
    },
  },
...
const customrecordactionscript_scriptcustomfields = new ObjectType({
  ...
  fields: {
    scriptcustomfield: {
      refType: new ListType(customrecordactionscript_scriptcustomfields_scriptcustomfield),
      annotations: {
      },
    },
  },
...
export const customrecordactionscript_scriptdeployments = new ObjectType({
  ...
  fields: {
    scriptdeployment: {
      refType: new ListType(customrecordactionscript_scriptdeployments_scriptdeployment),
      annotations: {
      },
    },
  },
...
export const customrecordactionscript = new ObjectType({
  ...
  fields: {
    ...
    customplugintypes: {
      refType: customrecordactionscript_customplugintypes,
      annotations: {
      },
    },
    libraries: {
      refType: customrecordactionscript_libraries,
      annotations: {
      },
    },
    scriptcustomfields: {
      refType: customrecordactionscript_scriptcustomfields,
      annotations: {
      },
    },
    scriptdeployments: {
      refType: customrecordactionscript_scriptdeployments,
      annotations: {
      },
    },
  },
