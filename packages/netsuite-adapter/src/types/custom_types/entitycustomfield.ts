...
const entitycustomfield_customfieldfilters = new ObjectType({
  ...
  fields: {
    customfieldfilter: {
      refType: new ListType(entitycustomfield_customfieldfilters_customfieldfilter),
      annotations: {
      },
    },
  },
...
const entitycustomfield_roleaccesses = new ObjectType({
  ...
  fields: {
    roleaccess: {
      refType: new ListType(entitycustomfield_roleaccesses_roleaccess),
      annotations: {
      },
    },
  },
...
export const entitycustomfield = new ObjectType({
  ...
  fields: {
    ...
    customfieldfilters: {
      refType: entitycustomfield_customfieldfilters,
      annotations: {
      },
    },
    roleaccesses: {
      refType: entitycustomfield_roleaccesses,
      annotations: {
      },
    },
  },
