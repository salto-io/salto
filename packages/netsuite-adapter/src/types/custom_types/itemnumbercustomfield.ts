...
const itemnumbercustomfield_customfieldfilters = new ObjectType({
  ...
  fields: {
    customfieldfilter: {
      refType: new ListType(itemnumbercustomfield_customfieldfilters_customfieldfilter),
      annotations: {
      },
    },
  },
...
const itemnumbercustomfield_roleaccesses = new ObjectType({
  ...
  fields: {
    roleaccess: {
      refType: new ListType(itemnumbercustomfield_roleaccesses_roleaccess),
      annotations: {
      },
    },
  },
...
export const itemnumbercustomfield = new ObjectType({
  ...
  fields: {
    ...
    customfieldfilters: {
      refType: itemnumbercustomfield_customfieldfilters,
      annotations: {
      },
    },
    roleaccesses: {
      refType: itemnumbercustomfield_roleaccesses,
      annotations: {
      },
    },
  },
