...
const itemoptioncustomfield_customfieldfilters = new ObjectType({
  ...
  fields: {
    customfieldfilter: {
      refType: new ListType(itemoptioncustomfield_customfieldfilters_customfieldfilter),
      annotations: {
      },
    },
  },
...
const itemoptioncustomfield_roleaccesses = new ObjectType({
  ...
  fields: {
    roleaccess: {
      refType: new ListType(itemoptioncustomfield_roleaccesses_roleaccess),
      annotations: {
      },
    },
  },
...
export const itemoptioncustomfield = new ObjectType({
  ...
  fields: {
    ...
    customfieldfilters: {
      refType: itemoptioncustomfield_customfieldfilters,
      annotations: {
      },
    },
    roleaccesses: {
      refType: itemoptioncustomfield_roleaccesses,
      annotations: {
      },
    },
  },
