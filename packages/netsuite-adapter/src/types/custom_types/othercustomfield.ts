...
const othercustomfield_customfieldfilters = new ObjectType({
  ...
  fields: {
    customfieldfilter: {
      refType: new ListType(othercustomfield_customfieldfilters_customfieldfilter),
      annotations: {
      },
    },
  },
...
const othercustomfield_roleaccesses = new ObjectType({
  ...
  fields: {
    roleaccess: {
      refType: new ListType(othercustomfield_roleaccesses_roleaccess),
      annotations: {
      },
    },
  },
...
export const othercustomfield = new ObjectType({
  ...
  fields: {
    ...
    rectype: {
      refType: enums.generic_customrecordothercustomfield_rectype,
      annotations: {
        [CORE_ANNOTATIONS.REQUIRED]: true,
      },
    ...
    customfieldfilters: {
      refType: othercustomfield_customfieldfilters,
      annotations: {
      },
    },
    roleaccesses: {
      refType: othercustomfield_roleaccesses,
      annotations: {
      },
    },
  },
