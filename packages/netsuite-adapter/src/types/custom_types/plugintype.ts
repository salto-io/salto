...
const plugintype_libraries = new ObjectType({
  ...
  fields: {
    library: {
      refType: new ListType(plugintype_libraries_library),
      annotations: {
      },
    },
  },
...
const plugintype_methods = new ObjectType({
  ...
  fields: {
    method: {
      refType: new ListType(plugintype_methods_method),
      annotations: {
      },
    },
  },
...
export const plugintype = new ObjectType({
  ...
  fields: {
    ...
    deploymentmodel: {
      refType: enums.plugintype_deployment_model,
      annotations: {
        [CORE_ANNOTATIONS.REQUIRED]: true,
      },
    ...
    libraries: {
      refType: plugintype_libraries,
      annotations: {
      },
    },
    methods: {
      refType: plugintype_methods,
      annotations: {
      },
    },
  },
