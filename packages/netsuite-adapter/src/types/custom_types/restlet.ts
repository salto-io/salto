...
const restlet_customplugintypes = new ObjectType({
  ...
  fields: {
    plugintype: {
      refType: new ListType(restlet_customplugintypes_plugintype),
      annotations: {
      },
    },
  },
...
const restlet_libraries = new ObjectType({
  ...
  fields: {
    library: {
      refType: new ListType(restlet_libraries_library),
      annotations: {
      },
    },
  },
...
const restlet_scriptcustomfields_scriptcustomfield_customfieldfilters = new ObjectType({
  ...
  fields: {
    customfieldfilter: {
      refType: new ListType(restlet_scriptcustomfields_scriptcustomfield_customfieldfilters_customfieldfilter),
      annotations: {
      },
    },
  },
...
const restlet_scriptcustomfields_scriptcustomfield_roleaccesses = new ObjectType({
  ...
  fields: {
    roleaccess: {
      refType: new ListType(restlet_scriptcustomfields_scriptcustomfield_roleaccesses_roleaccess),
      annotations: {
      },
    },
  },
...
const restlet_scriptcustomfields_scriptcustomfield = new ObjectType({
  ...
  fields: {
    ...
    customfieldfilters: {
      refType: restlet_scriptcustomfields_scriptcustomfield_customfieldfilters,
      annotations: {
      },
    },
    roleaccesses: {
      refType: restlet_scriptcustomfields_scriptcustomfield_roleaccesses,
      annotations: {
      },
    },
  },
...
const restlet_scriptcustomfields = new ObjectType({
  ...
  fields: {
    scriptcustomfield: {
      refType: new ListType(restlet_scriptcustomfields_scriptcustomfield),
      annotations: {
      },
    },
  },
...
export const restlet_scriptdeployments = new ObjectType({
  ...
  fields: {
    scriptdeployment: {
      refType: new ListType(restlet_scriptdeployments_scriptdeployment),
      annotations: {
      },
    },
  },
...
export const restlet = new ObjectType({
  ...
  fields: {
    ...
    customplugintypes: {
      refType: restlet_customplugintypes,
      annotations: {
      },
    },
    libraries: {
      refType: restlet_libraries,
      annotations: {
      },
    },
    scriptcustomfields: {
      refType: restlet_scriptcustomfields,
      annotations: {
      },
    },
    scriptdeployments: {
      refType: restlet_scriptdeployments,
      annotations: {
      },
    },
  },
