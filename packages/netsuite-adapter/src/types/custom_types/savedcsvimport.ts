...
export const savedcsvimport_filemappings = new ObjectType({
  ...
  fields: {
    filemapping: {
      refType: new ListType(savedcsvimport_filemappings_filemapping),
      annotations: {
      },
    },
  },
...
const savedcsvimport_recordmappings_recordmapping_fieldmappings_fieldmapping_columnreference = new ObjectType({
  ...
  fields: {
    ...
    type: {
      refType: enums.csvimport_referencetype,
      annotations: {
      },
...
const savedcsvimport_recordmappings_recordmapping_fieldmappings_fieldmapping = new ObjectType({
  ...
  fields: {
    ...
    columnreference: {
      refType: savedcsvimport_recordmappings_recordmapping_fieldmappings_fieldmapping_columnreference,
      annotations: {
      },
    },
  },
...
const savedcsvimport_recordmappings_recordmapping_fieldmappings = new ObjectType({
  ...
  fields: {
    fieldmapping: {
      refType: new ListType(savedcsvimport_recordmappings_recordmapping_fieldmappings_fieldmapping),
      annotations: {
      },
    },
  },
...
const savedcsvimport_recordmappings_recordmapping = new ObjectType({
  ...
  fields: {
    ...
    fieldmappings: {
      refType: savedcsvimport_recordmappings_recordmapping_fieldmappings,
      annotations: {
      },
    },
  },
...
const savedcsvimport_recordmappings = new ObjectType({
  ...
  fields: {
    recordmapping: {
      refType: new ListType(savedcsvimport_recordmappings_recordmapping),
      annotations: {
      },
    },
  },
...
export const savedcsvimport = new ObjectType({
  ...
  fields: {
    ...
    recordtype: {
      refType: enums.csvimport_recordtypes,
      annotations: {
        [CORE_ANNOTATIONS.REQUIRED]: true,
      },
    ...
    charencoding: {
      refType: enums.csvimport_encoding,
      annotations: {
      },
    ...
    audience: {
      refType: savedcsvimport_audience,
      annotations: {
      },
    },
    filemappings: {
      refType: savedcsvimport_filemappings,
      annotations: {
      },
    },
    recordmappings: {
      refType: savedcsvimport_recordmappings,
      annotations: {
      },
    },
  },
