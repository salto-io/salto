...
const sspapplication_entrypoints_entrypoint = new ObjectType({
  ...
  fields: {
    entrytype: {
      refType: enums.webapp_entrytype,
      annotations: {
...
const sspapplication_entrypoints = new ObjectType({
  ...
  fields: {
    entrypoint: {
      refType: new ListType(sspapplication_entrypoints_entrypoint),
      annotations: {
      },
    },
  },
...
const sspapplication_libraries = new ObjectType({
  ...
  fields: {
    library: {
      refType: new ListType(sspapplication_libraries_library),
      annotations: {
      },
    },
  },
...
export const sspapplication = new ObjectType({
  ...
  fields: {
    ...
    appfolder: {
      refType: BuiltinTypes.STRING /* Original type was folderreference */,
      annotations: {
        [CORE_ANNOTATIONS.REQUIRED]: true,
      },
    },
    ...
    entrypoints: {
      refType: sspapplication_entrypoints,
      annotations: {
      },
    },
    libraries: {
      refType: sspapplication_libraries,
      annotations: {
      },
    },
  },
