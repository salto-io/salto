...
const transactionbodycustomfield_customfieldfilters = new ObjectType({
  ...
  fields: {
    customfieldfilter: {
      refType: new ListType(transactionbodycustomfield_customfieldfilters_customfieldfilter),
      annotations: {
      },
    },
  },
...
const transactionbodycustomfield_roleaccesses = new ObjectType({
  ...
  fields: {
    roleaccess: {
      refType: new ListType(transactionbodycustomfield_roleaccesses_roleaccess),
      annotations: {
      },
    },
  },
...
export const transactionbodycustomfield = new ObjectType({
  ...
  fields: {
    ...
    customfieldfilters: {
      refType: transactionbodycustomfield_customfieldfilters,
      annotations: {
      },
    },
    roleaccesses: {
      refType: transactionbodycustomfield_roleaccesses,
      annotations: {
      },
    },
  },
