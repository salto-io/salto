...
const transactioncolumncustomfield_customfieldfilters = new ObjectType({
  ...
  fields: {
    customfieldfilter: {
      refType: new ListType(transactioncolumncustomfield_customfieldfilters_customfieldfilter),
      annotations: {
      },
    },
  },
...
const transactioncolumncustomfield_roleaccesses = new ObjectType({
  ...
  fields: {
    roleaccess: {
      refType: new ListType(transactioncolumncustomfield_roleaccesses_roleaccess),
      annotations: {
      },
    },
  },
...
export const transactioncolumncustomfield = new ObjectType({
  ...
  fields: {
    ...
    customfieldfilters: {
      refType: transactioncolumncustomfield_customfieldfilters,
      annotations: {
      },
    },
    roleaccesses: {
      refType: transactioncolumncustomfield_roleaccesses,
      annotations: {
      },
    },
  },
