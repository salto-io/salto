...
import { simpleReportDefinition, simpleReportDefinitionResult, fullReportDefinition, fullReportDefinitionResult } from './report_definitions_consts'
...
describe('fields and inner fields test', () => {
  ...
  it('should have the same fields as the auto generated type', async () => {
    Object.keys(oldType.fields).forEach(key =>
      expect(oldType.fields[key].isEqual(parsedType.fields[key])).toBeTruthy())
  })
