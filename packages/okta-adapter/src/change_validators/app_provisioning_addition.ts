 ...
 */
import { AdditionChange, ChangeValidator, getChangeData, InstanceElement, isAdditionChange, isAdditionOrModificationChange, isInstanceChange, ModificationChange } from '@salto-io/adapter-api'
...
const hasAddedProvisioning = (
  ...
  return APP_PROVISIONING_FIELD_NAMES.some(field => 
    beforeValue[field] === undefined && instance.value[field] !== undefined
  )
}
 ...
 */
export const appProvisioningAdditionValidator: ChangeValidator = async (changes) => awu(changes)
