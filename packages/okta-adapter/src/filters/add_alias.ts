...
import { POLICY_TYPE_NAMES, POLICY_RULE_TYPE_NAMES, APPLICATION_TYPE_NAME, GROUP_TYPE_NAME, GROUP_RULE_TYPE_NAME, BEHAVIOR_RULE_TYPE_NAME, APP_USER_SCHEMA_TYPE_NAME, BRAND_TYPE_NAME, FEATURE_TYPE_NAME, IDENTITY_PROVIDER_TYPE_NAME, INLINE_HOOK_TYPE_NAME, NETWORK_ZONE_TYPE_NAME, ROLE_TYPE_NAME, USERTYPE_TYPE_NAME, USER_SCHEMA_TYPE_NAME, AUTHENTICATOR_TYPE_NAME, GROUP_SCHEMA_TYPE_NAME, PROFILE_MAPPING_TYPE_NAME, AUTHORIZATION_POLICY_RULE, AUTHORIZATION_POLICY, AUTHORIZATION_SERVER, DEVICE_ASSURANCE, EVENT_HOOK, GROUP_PUSH_RULE_TYPE_NAME, GROUP_PUSH_TYPE_NAME } from '../constants'

const SECOND_ITERATION_TYPES = [USER_SCHEMA_TYPE_NAME, PROFILE_MAPPING_TYPE_NAME]
...
const aliasMap: Record<string, AliasData> = {
  ...
  ...Object.fromEntries(
    DEFAULT_ALIAS_TYPES.map(typeName => [typeName, DEFAULT_ALIAS_DATA])
  ),
}
