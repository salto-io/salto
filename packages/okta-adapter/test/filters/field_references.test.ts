...
import { APPLICATION_TYPE_NAME, GROUP_RULE_TYPE_NAME, GROUP_TYPE_NAME, OKTA, USERTYPE_TYPE_NAME } from '../../src/constants'
...
describe('fieldReferencesFilter', () => {
    ...
    describe('onFetch', () => {
      ...
      it('should create missing references if enableMissingReferences flag is enabled', async () => {
        ...
        expect(rule.value?.assignUserToGroups?.groupIds[0].elemID.getFullName()).toEqual('okta.Group.instance.missing_missingId')
      })
