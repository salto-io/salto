...
describe('Salesforce adapter E2E with real account', () => {
  ...
  describe('should fetch account settings', () => {
    ...
    it('should fetch sobject', async () => {
      ...
      expect(lead.fields.description.annotations[Type.ANNOTATIONS.REQUIRED]).toBe(false)
      expect(lead.fields.created_date.annotations[Type.ANNOTATIONS.REQUIRED]).toBe(true)

      // Test picklist restriction.enforce_value prop
      expect(lead.fields.industry
        .annotations[Type.ANNOTATIONS.RESTRICTION][Type.ANNOTATIONS.ENFORCE_VALUE]).toBe(
        false
      )
      expect(
      ...
      expect(lead.fields.lead_source.annotations[Type.ANNOTATIONS.VALUES]).toEqual(
      ...
      expect(
        lead.fields.clean_status.annotations[Type.ANNOTATIONS.VALUES]
      ).toEqual([
        'Acknowledged',
        'Different',
        'Inactive',
      ...
      expect(lead.fields.status.annotations[Type.ANNOTATIONS.DEFAULT]).toBe(
        'Open - Not Contacted'
      )
