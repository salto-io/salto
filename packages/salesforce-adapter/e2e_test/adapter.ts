...
import { SalesforceConfig, Credentials, RateLimitConfig } from '../src/types'
...
const realAdapter = ({
  ...
  credentials,
  rateLimit,
}: Opts, config?: SalesforceConfig): Reals => {
  const client = (adapterParams && adapterParams.client) || new SalesforceClient({
