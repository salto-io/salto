...
var flows_filter_1 = require("./filters/flows_filter");
var custom_metadata_to_object_type_1 = require("./filters/custom_metadata_to_object_type");
var installed_package_generated_dependencies_1 = require("./filters/installed_package_generated_dependencies");
var create_missing_installed_packages_instances_1 = require("./filters/create_missing_installed_packages_instances");
var metadata_instances_aliases_1 = require("./filters/metadata_instances_aliases");
var formula_deps_1 = require("./filters/formula_deps");
var remove_unix_time_zero_1 = require("./filters/remove_unix_time_zero");
var organization_wide_sharing_defaults_1 = require("./filters/organization_wide_sharing_defaults");
var centralize_tracking_info_1 = require("./filters/centralize_tracking_info");
var changed_at_singleton_1 = require("./filters/changed_at_singleton");
...
var nested_instances_1 = require("./filters/author_information/nested_instances");
var fetch_profile_1 = require("./fetch_profile/fetch_profile");
var constants_1 = require("./constants");
var metadata_query_1 = require("./fetch_profile/metadata_query");
...
exports.allFilters = [
    { creator: create_missing_installed_packages_instances_1["default"], addsNewInformation: true },
    ...
    { creator: flows_filter_1["default"], addsNewInformation: true },
    ...
    { creator: organization_wide_sharing_defaults_1["default"], addsNewInformation: true },
    ...
    { creator: nested_instances_1["default"], addsNewInformation: true },
    ...
    { creator: installed_package_generated_dependencies_1["default"] },
    ...
    { creator: remove_unix_time_zero_1["default"] },
    { creator: metadata_instances_aliases_1["default"] },
    // createChangedAtSingletonInstanceFilter should run last
    { creator: changed_at_singleton_1["default"] },
];
...
var getMetadataTypesFromElementsSource = function (elementsSource) { return __awaiter(void 0, void 0, void 0, function () {
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1: return [2 /*return*/, (_a.apply(void 0, [_b.sent()])
                    ...
                    .filter(function (metadataType) { return !utils_1.isCustomObjectSync(metadataType); })
                    // custom types (CustomMetadata / CustomObject (non standard) / CustomSettings)
                    .filter(function (metadataType) { return !utils_1.isCustomType(metadataType); })
                    // settings types
                    .filter(function (metadataType) { return !metadataType.isSettings; })
                    .toArray())];
        }
    });
}); };
var SalesforceAdapter = /** @class */ (function () {
    function SalesforceAdapter(_a) {
        ...
        this.createFiltersRunner = function (_a) {
            var _b, _c, _d;
            var fetchProfile = _a.fetchProfile, lastChangeDateOfTypesWithNestedInstances = _a.lastChangeDateOfTypesWithNestedInstances;
            return adapter_utils_1.filter.filtersRunner({
                client: client,
                config: {
                    unsupportedSystemFields: unsupportedSystemFields,
                    systemFields: systemFields,
                    enumFieldPermissions: (_b = config.enumFieldPermissions) !== null && _b !== void 0 ? _b : constants.DEFAULT_ENUM_FIELD_PERMISSIONS,
                    fetchProfile: fetchProfile,
                    elementsSource: elementsSource,
                    separateFieldToFiles: (_d = (_c = config.fetch) === null || _c === void 0 ? void 0 : _c.metadata) === null || _d === void 0 ? void 0 : _d.objectsToSeperateFieldsToFiles,
    ...
    SalesforceAdapter.prototype.fetch = function (_a) {
        var _b, _c, _d;
        var progressReporter = _a.progressReporter, _e = _a.withChangesDetection, withChangesDetection = _e === void 0 ? false : _e;
        return __awaiter(this, void 0, void 0, function () {
            var fetchParams, baseQuery, lastChangeDateOfTypesWithNestedInstances, metadataQuery, _f, fetchProfile, fieldTypes, hardCodedTypes, metadataTypeInfosPromise, metadataTypesPromise, metadataTypes, metadataInstancesPromise, _g, metadataInstancesElements, metadataInstancesConfigInstances, elements, fetchFiltersRunner, onFetchFilterResult, configChangeSuggestions, updatedConfig;
            return __generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        fetchParams = (_b = this.userConfig.fetch) !== null && _b !== void 0 ? _b : {};
                        baseQuery = metadata_query_1.buildMetadataQuery({ fetchParams: fetchParams });
                        return [4 /*yield*/, last_change_date_of_types_with_nested_instances_1.getLastChangeDateOfTypesWithNestedInstances({
                                client: this.client,
                                metadataQuery: metadata_query_1.buildFilePropsMetadataQuery(baseQuery),
                            })];
                    case 1:
                        lastChangeDateOfTypesWithNestedInstances = _h.sent();
                        if (!withChangesDetection) return [3 /*break*/, 3];
                        return [4 /*yield*/, metadata_query_1.buildMetadataQueryForFetchWithChangesDetection({
                    ...
                    case 4:
                        metadataQuery = _f;
                        fetchProfile = fetch_profile_1.buildFetchProfile({ fetchParams: fetchParams, metadataQuery: metadataQuery });
                        if (!fetchProfile.isFeatureEnabled('fetchCustomObjectUsingRetrieveApi')) {
                            ...
                            lodash_1["default"].pull(this.metadataToRetrieve, constants_1.CUSTOM_OBJECT, constants_1.PROFILE_METADATA_TYPE);
                        }
                        if (fetchProfile.isFeatureEnabled('fetchProfilesUsingReadApi')) {
                            lodash_1["default"].pull(this.metadataToRetrieve, constants_1.PROFILE_METADATA_TYPE);
                        }
                        log.debug('going to fetch salesforce account configuration..');
                        fieldTypes = transformer_1.Types.getAllFieldTypes();
                        hardCodedTypes = __spreadArrays(withChangesDetection ? [] : transformer_1.Types.getAllMissingTypes(), transformer_1.Types.getAnnotationTypes(), Object.values(constants_1.ArtificialTypes));
                        metadataTypeInfosPromise = this.listMetadataTypes(fetchProfile.metadataQuery);
                        metadataTypesPromise = withChangesDetection
                    ...
                    case 5:
                        metadataTypes = _h.sent();
                        metadataInstancesPromise = this.fetchMetadataInstances(metadataTypeInfosPromise, metadataTypesPromise, fetchProfile);
                        progressReporter.reportProgress({ message: 'Fetching instances' });
                        return [4 /*yield*/, metadataInstancesPromise];
                    case 6:
                        _g = _h.sent(), metadataInstancesElements = _g.elements, metadataInstancesConfigInstances = _g.configChanges;
                        elements = __spreadArrays(fieldTypes, hardCodedTypes, metadataTypes, metadataInstancesElements);
                        progressReporter.reportProgress({ message: 'Running filters for additional information' });
                        fetchFiltersRunner = this.createFiltersRunner({ fetchProfile: fetchProfile, lastChangeDateOfTypesWithNestedInstances: lastChangeDateOfTypesWithNestedInstances });
                        return [4 /*yield*/, fetchFiltersRunner.onFetch(elements)];
                    case 7:
                        onFetchFilterResult = _h.sent();
                        configChangeSuggestions = __spreadArrays(metadataInstancesConfigInstances, ((_c = onFetchFilterResult.configSuggestions) !== null && _c !== void 0 ? _c : []));
                        updatedConfig = config_change_1.getConfigFromConfigChanges(configChangeSuggestions, this.userConfig);
                        return [2 /*return*/, {
                                elements: elements,
                                errors: (_d = onFetchFilterResult.errors) !== null && _d !== void 0 ? _d : [],
                                updatedConfig: updatedConfig,
                                partialFetchData: adapter_api_1.setPartialFetchData(fetchProfile.metadataQuery.isPartialFetch()),
                            }];
                }
            });
        });
    ...
    SalesforceAdapter.prototype.deployOrValidate = function (_a, checkOnly) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var fetchParams, fetchProfile, isDataDeployGroup, getLookupNameFunc, resolvedChanges, filtersRunner, deployResult, appliedChangesBeforeRestore, sourceChanges, appliedChanges;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        fetchParams = (_b = this.userConfig.fetch) !== null && _b !== void 0 ? _b : {};
                        fetchProfile = fetch_profile_1.buildFetchProfile({ fetchParams: fetchParams });
                        log.debug("about to " + (checkOnly ? 'validate' : 'deploy') + " group " + changeGroup.groupID + " with scope (first 100): " + adapter_utils_1.safeJsonStringify(changeGroup.changes.slice(0, 100).map(adapter_api_1.getChangeData).map(function (e) { return e.elemID.getFullName(); })));
                        return [4 /*yield*/, custom_object_instances_deploy_1.isCustomObjectInstanceChanges(changeGroup.changes)];
                    case 1:
                        isDataDeployGroup = _g.sent();
                        getLookupNameFunc = isDataDeployGroup
                            ? reference_mapping_1.getLookupNameWithFallbackToElement
                            : reference_mapping_1.getLookUpName;
                        return [4 /*yield*/, awu(changeGroup.changes)
                                .map(function (change) { return adapter_utils_1.resolveChangeElement(change, getLookupNameFunc); })
                                .toArray()];
                    case 2:
                        resolvedChanges = _g.sent();
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, custom_object_instances_deploy_1.deployCustomObjectInstancesGroup(resolvedChanges, this.client, changeGroup.groupID, fetchProfile.dataManagement)];
                    case 5:
                        deployResult = _g.sent();
                        return [3 /*break*/, 8];
                    case 6: return [4 /*yield*/, metadata_deploy_1.deployMetadata(resolvedChanges, this.client, changeGroup.groupID, this.nestedMetadataTypes, (_d = (_c = this.userConfig.client) === null || _c === void 0 ? void 0 : _c.deploy) === null || _d === void 0 ? void 0 : _d.deleteBeforeUpdate, checkOnly, (_f = (_e = this.userConfig.client) === null || _e === void 0 ? void 0 : _e.deploy) === null || _f === void 0 ? void 0 : _f.quickDeployParams)];
                    case 7:
                        deployResult = _g.sent();
                        _g.label = 8;
                    case 8:
                    ...
                    case 9:
                        ...
                        return [4 /*yield*/, awu(appliedChangesBeforeRestore)
                                .map(function (change) { return adapter_utils_1.restoreChangeElement(change, sourceChanges, getLookupNameFunc); })
                                .toArray()];
                    case 10:
                        appliedChanges = _g.sent();
                        return [2 /*return*/, {
    ...
    SalesforceAdapter.prototype.listMetadataTypes = function (metadataQuery) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.listMetadataTypes()];
                    case 1: return [2 /*return*/, (_a.sent())
                            .filter(function (info) { return metadataQuery.isTypeMatch(info.xmlName); })];
                }
            });
        });
    };
    ...
    SalesforceAdapter.prototype.fetchMetadataInstances = function (typeInfoPromise, types, fetchProfile) {
        return __awaiter(this, void 0, void 0, function () {
                                ...
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        ...
                                        return [4 /*yield*/, Promise.all(metadataTypesToRead
                                                .map(function (type) { return _this.createMetadataInstances(type, fetchProfile); }))];
                                    case 2:
                                        result = _a.sent();
                                        return [2 /*return*/, {
     ...
     */
    SalesforceAdapter.prototype.createMetadataInstances = function (type, fetchProfile) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        typeName = _b.sent();
                        return [4 /*yield*/, utils_1.listMetadataObjects(this.client, typeName)];
                    case 2:
