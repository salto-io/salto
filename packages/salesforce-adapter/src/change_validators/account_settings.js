...
var isRecordTypeInvalid = function (globalSharingSettings, instance) { return (globalSharingSettings.value.defaultAccountAccess !== 'Read'
    && instance.value.enableAccountOwnerReport !== undefined); };
var invalidRecordTypeError = function (instance) { return ({
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, elementsSource.get(new adapter_api_1.ElemID(constants_1.SALESFORCE, constants_1.ORGANIZATION_SETTINGS, 'instance'))];
            case 1:
                orgWideSettings = _a.sent();
                if (!adapter_api_1.isInstanceElement(orgWideSettings)) {
                ...
                return [2 /*return*/, awu(changes)
                        ...
                        .filter(utils_1.isInstanceOfType(constants_1.ACCOUNT_SETTINGS_METADATA_TYPE))
                        .filter(function (accountSettingsInstance) { return isRecordTypeInvalid(orgWideSettings, accountSettingsInstance); })
