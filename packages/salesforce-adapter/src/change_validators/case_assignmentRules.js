...
exports.CASE = 'Case';
var RULE_ENTRY = joi_1["default"].object({
    team: joi_1["default"].string().required(),
}).unknown(true);
var ASSIGNMENT_RULE = joi_1["default"].object({
    ruleEntry: joi_1["default"].array().has(RULE_ENTRY),
}).unknown(true);
var ASSIGNMENT_RULES = joi_1["default"].object({
    assignmentRule: joi_1["default"].array().items(ASSIGNMENT_RULE).required(),
}).unknown(true);
var isAssignmentRulesWithTeam = adapter_utils_1.createSchemeGuard(ASSIGNMENT_RULES);
var createChangeError = function (instance) { return ({
...
var changeValidator = function (changes) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, awu(changes)
                ...
                .filter(utils_1.isInstanceOfType(constants_1.ASSIGNMENT_RULES_METADATA_TYPE))
                .filter(function (change) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, transformer_1.apiName(change)];
                    case 1: return [2 /*return*/, (_a.sent()) === exports.CASE];
                }
            }); }); })
                .filter(function (instance) { return isAssignmentRulesWithTeam(instance.value); })
