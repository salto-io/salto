...
var isInvalidTypeChange = function (change) { return __awaiter(void 0, void 0, void 0, function () {
    var changeData, afterFieldType, isAfterTypeAllowed, isSystemField;
    return __generator(this, function (_a) {
        changeData = adapter_api_1.getChangeData(change);
        afterFieldType = transformer_1.fieldTypeName(changeData.refType.elemID.name);
        isAfterTypeAllowed = constants_1.CUSTOM_FIELD_UPDATE_CREATE_ALLOWED_TYPES.includes(afterFieldType);
        isSystemField = adapter_1.SYSTEM_FIELDS.includes(changeData.name);
        if (isSystemField || isAfterTypeAllowed) {
            return [2 /*return*/, false];
        }
        if (adapter_api_1.isAdditionChange(change)) {
            return [2 /*return*/, true];
        }
        // it's a modification change and the target type is invalid
        return [2 /*return*/, change.data.before.refType.elemID.typeName !== afterFieldType];
    });
}); };
var createChangeError = function (field) { return ({
    elemID: field.elemID,
    severity: 'Warning',
