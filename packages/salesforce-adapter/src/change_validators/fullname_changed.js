...
exports.wasFullNameChanged = void 0;
/*
...
var wasFullNameChanged = function (change) {
    var _a = change.data, before = _a.before, after = _a.after;
    return before.value[constants_1.INSTANCE_FULL_NAME_FIELD] !== after.value[constants_1.INSTANCE_FULL_NAME_FIELD];
};
exports.wasFullNameChanged = wasFullNameChanged;
var fullNameChangeError = function (change) {
    var _a = change.data, before = _a.before, after = _a.after;
    return {
        elemID: after.elemID,
        severity: 'Error',
        ...
        detailedMessage: 'You cannot change the fullName property of an element. '
            ...
            + ("'" + before.value[constants_1.INSTANCE_FULL_NAME_FIELD] + "' to '" + after.value[constants_1.INSTANCE_FULL_NAME_FIELD] + "'"),
    };
};
/**
...
var changeValidator = function (changes) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, (changes
                ...
                .filter(exports.wasFullNameChanged)
