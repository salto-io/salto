...
var createInstalledPackageInstanceChangeError = function (change) { return __awaiter(void 0, void 0, void 0, function () {
    var instance, namespace;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                instance = adapter_api_1.getChangeData(change);
                return [4 /*yield*/, utils_1.safeApiName(instance)];
            case 1:
                namespace = _a.sent();
                if (namespace === undefined) {
                    return [2 /*return*/, undefined];
                }
                if (adapter_api_1.isModificationChange(change)) {
                    return [2 /*return*/, {
...
var changeValidator = function (changes) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, (awu(changes)
                ...
                .filter(utils_1.isInstanceOfTypeChange(constants_1.INSTALLED_PACKAGE_METADATA))
