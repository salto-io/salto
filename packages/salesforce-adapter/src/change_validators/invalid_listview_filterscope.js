...
exports.isFilterScopeInvalid = void 0;
/*
...
var isFilterScopeInvalid = function (instance) { return __awaiter(void 0, void 0, void 0, function () {
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                return [2 /*return*/, INVALID_FILTERSCOPES.some(function (filterScopeDef) { return (adapter_utils_1.getParents(instance).some(function (parentType) { return parentType === filterScopeDef.parentType; })
                        && instance.value.filterScope === filterScopeDef.filterScope); })];
        }
    });
}); };
exports.isFilterScopeInvalid = isFilterScopeInvalid;
var invalidListViewFilterScopeError = function (element) { return ({
...
var changeValidator = function (changes) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        typesOfInterest = INVALID_FILTERSCOPES.map(function (scopeDef) { return scopeDef.parentType; });
        return [2 /*return*/, awu(changes)
                ...
                return [2 /*return*/, adapter_utils_1.getParents(elem).some(utils_1.isInstanceOfType.apply(void 0, typesOfInterest))];
            }); }); })
                .filter(function (elem) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                return [2 /*return*/, exports.isFilterScopeInvalid(elem)];
            }); }); })
