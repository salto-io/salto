...
var isStandardValueSet = function (picklistField) { return __awaiter(void 0, void 0, void 0, function () {
    var standardVSchecker;
    return __generator(this, function (_a) {
        standardVSchecker = utils_1.isInstanceOfType(standard_value_sets_1.STANDARD_VALUE_SET);
        return [2 /*return*/, utils_1.isValueSetReference(picklistField)
                && standardVSchecker(picklistField.annotations[constants_1.VALUE_SET_FIELDS.VALUE_SET_NAME].value)];
    });
}); };
var shouldCreateChangeError = function (changeData) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                _b = utils_1.isPicklistField(changeData);
                if (!_b) return [3 /*break*/, 2];
                _c = transformer_1.isCustom;
                return [4 /*yield*/, transformer_1.apiName(changeData)];
            case 1:
            ...
            case 2:
                ...
                return [4 /*yield*/, isStandardValueSet(changeData)];
            case 3:
                _a = !(_d.sent());
                _d.label = 4;
...
var createChangeError = function (field) {
    return ({
        elemID: field.elemID,
        severity: 'Error',
...
var changeValidator = function (changes) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, (awu(changes)
                ...
                .map(function (field) { return createChangeError(field); })
                .toArray())];
    });
}); };
