...
var isTypeDeletion = function (changedElement) { return (changedElement.elemID.idType === 'type'); };
var isRecordTypeOfDeletedType = function (instance, deletedTypes) { return __awaiter(void 0, void 0, void 0, function () {
    var type;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, utils_1.parentApiName(instance)];
            case 1:
                type = _a.sent();
                return [2 /*return*/, deletedTypes.includes(type)];
        }
    });
}); };
var createChangeError = function (instance) {
    return ({
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, awu(changes)
                    ...
                    return [2 /*return*/, transformer_1.apiName(obj)];
                }); }); })
                    .toArray()
                // We want to allow to delete record type if the entire type is being deleted
            ];
            case 1:
                deletedTypes = _a.sent();
                // We want to allow to delete record type if the entire type is being deleted
                return [2 /*return*/, awu(changes)
                        .filter(adapter_api_1.isInstanceChange)
                        .filter(adapter_api_1.isRemovalChange)
                        .map(adapter_api_1.getChangeData)
                        .filter(utils_1.isInstanceOfType(constants_1.RECORD_TYPE_METADATA_TYPE))
                        .filter(function (instance) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, isRecordTypeOfDeletedType(instance, deletedTypes)];
