...
var isStandardFieldChange = function (change) {
    return (!transformer_1.isCustom(adapter_api_1.getChangeData(change).elemID.getFullName()));
};
var isLabelModification = function (change) {
    var beforeAnnotations = change.data.before.annotations;
    var afterAnnotations = change.data.after.annotations;
    return beforeAnnotations[constants_1.LABEL] !== afterAnnotations[constants_1.LABEL];
};
