...
var isUnknownField = function (changedElement) { return (adapter_api_1.isField(changedElement)
    && changedElement.refType.elemID.isEqual(transformer_1.Types.primitiveDataTypes.Unknown.elemID)); };
exports.isUnknownField = isUnknownField;
