...
var jsforce_1 = require("@salto-io/jsforce");
...
var isOrganizationRecord = function (record) { return (lodash_1["default"].isString(record.OrganizationType) && lodash_1["default"].isBoolean(record.IsSandbox)); };
var queryOrganization = function (conn, orgId) { return __awaiter(void 0, void 0, void 0, function () {
    var result, organizationRecord, e_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, conn.query("SELECT OrganizationType, IsSandbox FROM Organization WHERE Id = '" + orgId + "'")];
            case 1:
                result = _a.sent();
                organizationRecord = result.records[0];
                log.debug('organization record: %o', organizationRecord);
                return [2 /*return*/, isOrganizationRecord(organizationRecord)
                        ? organizationRecord
                        : undefined];
            case 2:
                e_2 = _a.sent();
                log.error('Failed to query the organization record from salesforce', e_2);
                return [2 /*return*/, undefined];
            case 3: return [2 /*return*/];
        }
    });
}); };
var PRODUCTION_ACCOUNT_TYPES = [
    'Team Edition',
...
var getConnectionDetails = function (creds, connection) { return __awaiter(void 0, void 0, void 0, function () {
    var options, conn, orgId, limits, organizationRecord;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                options = {
            ...
            case 2:
                limits = _a.sent();
                return [4 /*yield*/, queryOrganization(conn, orgId)];
            case 3:
                organizationRecord = _a.sent();
...
var validateCredentials = function (creds, minApiRequestsRemaining, connection) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var _a, remainingDailyRequests, orgId, accountType, isProduction, instanceUrl;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, exports.getConnectionDetails(creds, connection)];
                case 1:
                    _a = _b.sent(), remainingDailyRequests = _a.remainingDailyRequests, orgId = _a.orgId, accountType = _a.accountType, isProduction = _a.isProduction, instanceUrl = _a.instanceUrl;
