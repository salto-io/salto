...
var DUPLICATE_VALUE = constants_1.SALESFORCE_ERRORS.DUPLICATE_VALUE, INVALID_CROSS_REFERENCE_KEY = constants_1.SALESFORCE_ERRORS.INVALID_CROSS_REFERENCE_KEY, INVALID_FIELD = constants_1.SALESFORCE_ERRORS.INVALID_FIELD, INVALID_ID_FIELD = constants_1.SALESFORCE_ERRORS.INVALID_ID_FIELD, INVALID_TYPE = constants_1.SALESFORCE_ERRORS.INVALID_TYPE, UNKNOWN_EXCEPTION = constants_1.SALESFORCE_ERRORS.UNKNOWN_EXCEPTION, INVALID_QUERY_FILTER_OPERATOR = constants_1.SALESFORCE_ERRORS.INVALID_QUERY_FILTER_OPERATOR;
var CONFIG_SUGGESTIONS_GENERAL_MESSAGE = 'Salto failed to fetch some items from Salesforce.'
...
var getConfigChangeMessage = function (configChanges) {
    ...
    return adapter_utils_1.formatConfigSuggestionsReasons(__spreadArrays([CONFIG_SUGGESTIONS_GENERAL_MESSAGE], reasons));
};
...
var isInvalidCrossReferenceKeyError = function (e) {
    ...
    return lodash_1["default"].isString(errorCode) && errorCode === INVALID_CROSS_REFERENCE_KEY;
};
...
var CONFIG_SUGGESTION_CREATORS = (_a = {},
    ...
    _a[INVALID_CROSS_REFERENCE_KEY] = {
...
var createRetrieveConfigChange = function (result) {
    var configChanges = makeArray(result.messages)
