...
exports.COMPLIANCE_GROUP = exports.SECURITY_CLASSIFICATION = exports.BUSINESS_STATUS = exports.BUSINESS_OWNER_GROUP = exports.BUSINESS_OWNER_USER = exports.DEFAULT_VALUE_FORMULA = exports.FORMULA = exports.HELP_TEXT = exports.DESCRIPTION = exports.PLURAL_LABEL = exports.LABEL = exports.FEED_HISTORY_TRACKED_FIELDS = exports.HISTORY_TRACKED_FIELDS = exports.INTERNAL_ID_ANNOTATION = exports.FOLDER_CONTENT_TYPE = exports.IS_ATTRIBUTE = exports.LIST_CUSTOM_SETTINGS_TYPE = exports.CUSTOM_SETTINGS_TYPE = exports.FOREIGN_KEY_DOMAIN = exports.TOPICS_FOR_OBJECTS_ANNOTATION = exports.METADATA_TYPE = exports.API_NAME = exports.OWNER_ID = exports.ANNOTATION_TYPE_NAMES = exports.FIELD_SOAP_TYPE_NAMES = exports.CUSTOM_FIELD_UPDATE_CREATE_ALLOWED_TYPES = exports.COMPOUND_FIELDS_SOAP_TYPE_NAMES = exports.LOCATION_INTERNAL_COMPOUND_FIELD_TYPE_NAME = exports.COMPOUND_FIELD_TYPE_NAMES = exports.INTERNAL_FIELD_TYPE_NAMES = exports.FIELD_TYPE_NAMES = exports.SALESFORCE_DATE_PLACEHOLDER = exports.DEFAULT_NAMESPACE = exports.XML_ATTRIBUTE_PREFIX = exports.INTERNAL_ID_FIELD = exports.CUSTOM_OBJECT_ID_FIELD = exports.API_NAME_SEPARATOR = exports.NAMESPACE_SEPARATOR = exports.ADMIN_PROFILE = exports.GLOBAL_VALUE_SET_SUFFIX = exports.CUSTOM_METADATA_SUFFIX = exports.SALESFORCE_CUSTOM_SUFFIX = exports.FORMULA_TYPE_NAME = exports.METADATA_CONTENT_FIELD = exports.INSTANCE_FULL_NAME_FIELD = exports.CUSTOM_OBJECT = exports.CUSTOM_FIELD = exports.SALESFORCE = exports.UNIX_TIME_ZERO_STRING = exports.RATE_LIMIT_UNLIMITED_MAX_CONCURRENT_REQUESTS = void 0;
exports.LEAD_CONVERT_SETTINGS_METADATA_TYPE = exports.RECORD_TYPE_METADATA_TYPE = exports.BUSINESS_PROCESS_METADATA_TYPE = exports.VALIDATION_RULES_METADATA_TYPE = exports.ASSIGNMENT_RULES_METADATA_TYPE = exports.WORKFLOW_METADATA_TYPE = exports.FIELD_PERMISSIONS = exports.PERMISSION_SET_METADATA_TYPE = exports.PROFILE_METADATA_TYPE = exports.TOPICS_FOR_OBJECTS_METADATA_TYPE = exports.PATH_ASSISTANT_METADATA_TYPE = exports.ACTIVE = exports.STATUS = exports.ACTIVE_VERSION_NUMBER = exports.CURRENCY_ISO_CODE = exports.MAX_TYPES_TO_SEPARATE_TO_FILE_PER_FIELD = exports.DEFAULT_CUSTOM_OBJECTS_DEFAULT_RETRY_OPTIONS = exports.DEFAULT_ENUM_FIELD_PERMISSIONS = exports.MAX_QUERY_LENGTH = exports.MAXIMUM_MAX_ITEMS_IN_RETRIEVE_REQUEST = exports.MINIMUM_MAX_ITEMS_IN_RETRIEVE_REQUEST = exports.DEFAULT_MAX_INSTANCES_PER_TYPE = exports.DEFAULT_MAX_ITEMS_IN_RETRIEVE_REQUEST = exports.DEFAULT_MAX_CONCURRENT_API_REQUESTS = exports.MAX_TOTAL_CONCURRENT_API_REQUEST = exports.MAX_METADATA_RESTRICTION_VALUES = exports.OBJECT_FIELDS_PATH = exports.INSTALLED_PACKAGES_PATH = exports.SUBTYPES_PATH = exports.TYPES_PATH = exports.OBJECTS_PATH = exports.SETTINGS_PATH = exports.RECORDS_PATH = exports.TOPICS_FOR_OBJECTS_FIELDS = exports.GEOLOCATION_FIELDS = exports.NAME_FIELDS = exports.ADDRESS_FIELDS = exports.FILTER_ITEM_FIELDS = exports.LOOKUP_FILTER_FIELDS = exports.CUSTOM_VALUE = exports.VALUE_SET_DEFINITION_FIELDS = exports.VALUE_SETTINGS_FIELDS = exports.FIELD_DEPENDENCY_FIELDS = exports.VALUE_SET_FIELDS = exports.FIELD_ANNOTATIONS = exports.RECORD_TYPE_FEED_HISTORY_TRACKING_ENABLED = exports.OBJECT_FEED_HISTORY_TRACKING_ENABLED = exports.RECORD_TYPE_HISTORY_TRACKING_ENABLED = exports.OBJECT_HISTORY_TRACKING_ENABLED = exports.KEY_PREFIX = void 0;
exports.ORGANIZATION_SETTINGS = exports.ArtificialTypes = exports.CHANGED_AT_SINGLETON = exports.CURRENCY_CODE_TYPE_NAME = exports.ESCALATION_RULE_TYPE = exports.ESCALATION_RULES_TYPE = exports.SHARING_RULE_METADATA_TYPE = exports.AUTO_RESPONSE_RULE_METADATA_TYPE = exports.AUTO_RESPONSE_RULES_METADATA_TYPE = exports.ASSIGNMENT_RULE_METADATA_TYPE = exports.APEX_PAGE_METADATA_TYPE = exports.APEX_CLASS_METADATA_TYPE = exports.CUSTOM_APPLICATION_METADATA_TYPE = exports.DATA_CATEGORY_GROUP_METADATA_TYPE = exports.PERMISSION_SET_TYPE_ID_METADATA_TYPE = exports.ACCOUNT_SETTINGS_METADATA_TYPE = exports.INSTALLED_PACKAGE_METADATA = exports.FLOW_DEFINITION_METADATA_TYPE = exports.CUSTOM_METADATA = exports.EMAIL_TEMPLATE_METADATA_TYPE = exports.FLOW_METADATA_TYPE = exports.GROUP_METADATA_TYPE = exports.ROLE_METADATA_TYPE = exports.CUSTOM_LABELS_METADATA_TYPE = exports.CUSTOM_LABEL_METADATA_TYPE = exports.FLEXI_PAGE_TYPE = exports.LIGHTNING_PAGE_TYPE = exports.TERRITORY2_RULE_TYPE = exports.TERRITORY2_MODEL_TYPE = exports.TERRITORY2_TYPE = exports.SETTINGS_METADATA_TYPE = exports.BUSINESS_HOURS_METADATA_TYPE = exports.WEBLINK_METADATA_TYPE = exports.WORKFLOW_TASK_METADATA_TYPE = exports.WORKFLOW_RULE_METADATA_TYPE = exports.WORKFLOW_OUTBOUND_MESSAGE_METADATA_TYPE = exports.WORKFLOW_KNOWLEDGE_PUBLISH_METADATA_TYPE = exports.WORKFLOW_FLOW_ACTION_METADATA_TYPE = exports.WORKFLOW_FIELD_UPDATE_METADATA_TYPE = exports.WORKFLOW_ACTION_REFERENCE_METADATA_TYPE = exports.WORKFLOW_ACTION_ALERT_METADATA_TYPE = exports.SUMMARY_LAYOUT_ITEM_METADATA_TYPE = exports.LIGHTNING_COMPONENT_BUNDLE_METADATA_TYPE = exports.LAYOUT_ITEM_METADATA_TYPE = exports.LAYOUT_TYPE_ID_METADATA_TYPE = exports.SHARING_RULES_TYPE = exports.CUSTOM_OBJECT_TRANSLATION_METADATA_TYPE = exports.DUPLICATE_RULE_METADATA_TYPE = exports.CUSTOM_TAB_METADATA_TYPE = exports.QUICK_ACTION_METADATA_TYPE = void 0;
exports.CPQ_QUOTE_NAME = exports.DEFAULT_OBJECT_TO_API_MAPPING = exports.CPQ_ACCOUNT_NO_PRE = exports.CPQ_QUOTE_LINE_GROUP_NO_PRE = exports.CPQ_QUOTE_NO_PRE = exports.CPQ_TARGET_OBJECT = exports.CPQ_TARGET_FIELD = exports.CPQ_HIDDEN_SOURCE_OBJECT = exports.CPQ_HIDDEN_SOURCE_FIELD = exports.CPQ_FILTER_SOURCE_OBJECT = exports.CPQ_FILTER_SOURCE_FIELD = exports.CPQ_ACCOUNT = exports.CPQ_CONSTRAINT_FIELD = exports.CPQ_TESTED_OBJECT = exports.CPQ_DEFAULT_OBJECT_FIELD = exports.CPQ_CODE_FIELD = exports.CPQ_QUOTE_LINE_FIELDS = exports.CPQ_QUOTE_FIELDS = exports.CPQ_GROUP_FIELDS = exports.CPQ_CONSUMPTION_SCHEDULE_FIELDS = exports.CPQ_CONSUMPTION_RATE_FIELDS = exports.CPQ_OBJECT_NAME = exports.CPQ_SOURCE_LOOKUP_FIELD = exports.CPQ_RULE_LOOKUP_OBJECT_FIELD = exports.CPQ_LOOKUP_FIELD = exports.CPQ_LOOKUP_TYPE_FIELD = exports.CPQ_LOOKUP_REQUIRED_FIELD = exports.CPQ_LOOKUP_MESSAGE_FIELD = exports.CPQ_LOOKUP_PRODUCT_FIELD = exports.CPQ_LOOKUP_OBJECT_NAME = exports.CPQ_SUBSCRIPTION = exports.CPQ_DISCOUNT_SCHEDULE = exports.CPQ_PRICE_SCHEDULE = exports.CPQ_PRODUCT_OPTION = exports.CPQ_QUOTE_LINE = exports.CPQ_QUOTE_LINE_GROUP = exports.CPQ_QUOTE = exports.CPQ_CONFIGURATION_ATTRIBUTE = exports.CPQ_CUSTOM_SCRIPT = exports.CPQ_FIELD_METADATA = exports.CPQ_PRICE_ACTION = exports.CPQ_LOOKUP_QUERY = exports.CPQ_PRICE_RULE = exports.CPQ_PRODUCT_RULE = exports.CPQ_NAMESPACE = exports.ADD_CUSTOM_APPROVAL_RULE_AND_CONDITION_GROUP = exports.DETECTS_PARENTS_INDICATOR = exports.KEY_PREFIX_LENGTH = exports.RETRIEVE_SIZE_LIMIT_ERROR = exports.RETRIEVE_LOAD_OF_METADATA_ERROR_REGEX = void 0;
exports.isSalesforceError = exports.SALESFORCE_ERRORS = exports.SALESFORCE_ERROR_PREFIX = exports.ERROR_PROPERTIES = exports.ERROR_HTTP_502 = exports.ENOTFOUND = exports.INVALID_GRANT = exports.SOCKET_TIMEOUT = exports.UNLIMITED_INSTANCES_VALUE = exports.SBAA_CONDITIONS_MET = exports.SBAA_APPROVAL_RULE = exports.SBAA_APPROVAL_CONDITION = exports.SBAA_NAMESPACE = exports.SCHEDULE_CONTRAINT_FIELD_TO_API_MAPPING = exports.TEST_OBJECT_TO_API_MAPPING = exports.CPQ_PRODUCT_OPTION_NAME = exports.CPQ_QUOTE_LINE_NAME = void 0;
/*
...
exports.UNIX_TIME_ZERO_STRING = '1970-01-01T00:00:00.000Z';
...
exports.GLOBAL_VALUE_SET_SUFFIX = '__gvs';
...
exports.HISTORY_TRACKED_FIELDS = 'historyTrackedFields';
exports.FEED_HISTORY_TRACKED_FIELDS = 'feedHistoryTrackedFields';
// Salesforce annotations
exports.LABEL = 'label';
exports.PLURAL_LABEL = 'pluralLabel';
...
exports.OBJECT_HISTORY_TRACKING_ENABLED = 'enableHistory';
exports.RECORD_TYPE_HISTORY_TRACKING_ENABLED = 'recordTypeTrackHistory';
exports.OBJECT_FEED_HISTORY_TRACKING_ENABLED = 'enableFeeds';
exports.RECORD_TYPE_FEED_HISTORY_TRACKING_ENABLED = 'recordTypeTrackFeedHistory';
...
exports.ACTIVE_VERSION_NUMBER = 'activeVersionNumber';
exports.STATUS = 'status';
exports.ACTIVE = 'Active';
// Metadata types
exports.PATH_ASSISTANT_METADATA_TYPE = 'PathAssistant';
...
exports.FIELD_PERMISSIONS = 'fieldPermissions';
...
exports.ACCOUNT_SETTINGS_METADATA_TYPE = 'AccountSettings';
exports.PERMISSION_SET_TYPE_ID_METADATA_TYPE = 'PermissionSet';
exports.DATA_CATEGORY_GROUP_METADATA_TYPE = 'DataCategoryGroup';
exports.CUSTOM_APPLICATION_METADATA_TYPE = 'CustomApplication';
exports.APEX_CLASS_METADATA_TYPE = 'ApexClass';
exports.APEX_PAGE_METADATA_TYPE = 'ApexPage';
exports.ASSIGNMENT_RULE_METADATA_TYPE = 'AssignmentRule';
exports.AUTO_RESPONSE_RULES_METADATA_TYPE = 'AutoResponseRules';
exports.AUTO_RESPONSE_RULE_METADATA_TYPE = 'AutoResponseRule';
exports.SHARING_RULE_METADATA_TYPE = 'SharingRuleMetadataType';
exports.ESCALATION_RULES_TYPE = 'EscalationRules';
exports.ESCALATION_RULE_TYPE = 'EscalationRule';
// Artificial Types
exports.CURRENCY_CODE_TYPE_NAME = 'CurrencyIsoCodes';
exports.CHANGED_AT_SINGLETON = 'ChangedAtSingleton';
exports.ArtificialTypes = (_a = {},
    _a[exports.CHANGED_AT_SINGLETON] = new adapter_api_1.ObjectType({
        elemID: new adapter_api_1.ElemID(exports.SALESFORCE, exports.CHANGED_AT_SINGLETON),
        isSettings: true,
        annotations: (_b = {},
            _b[adapter_api_1.CORE_ANNOTATIONS.HIDDEN] = true,
            _b[adapter_api_1.CORE_ANNOTATIONS.HIDDEN_VALUE] = true,
            _b),
    }),
    _a);
// Standard Object Types
exports.ORGANIZATION_SETTINGS = 'Organization';
// Retrieve constants
...
// Magics
exports.DETECTS_PARENTS_INDICATOR = '##allMasterDetailFields##';
// Change Groups
exports.ADD_CUSTOM_APPROVAL_RULE_AND_CONDITION_GROUP = 'add_Custom_ApprovalRule_and_ApprovalCondition_instances';
// CPQ CustomObjects
...
exports.DEFAULT_OBJECT_TO_API_MAPPING = (_c = {},
    _c[exports.CPQ_QUOTE_NO_PRE] = exports.CPQ_QUOTE,
    _c[exports.CPQ_QUOTE_LINE_GROUP_NO_PRE] = exports.CPQ_QUOTE_LINE_GROUP,
    _c);
exports.CPQ_QUOTE_NAME = 'Quote';
exports.CPQ_QUOTE_LINE_NAME = 'Quote Line';
exports.CPQ_PRODUCT_OPTION_NAME = 'Product Option';
exports.TEST_OBJECT_TO_API_MAPPING = (_d = {},
    _d[exports.CPQ_QUOTE_NAME] = exports.CPQ_QUOTE,
    _d[exports.CPQ_QUOTE_LINE_NAME] = exports.CPQ_QUOTE_LINE,
    _d[exports.CPQ_PRODUCT_OPTION_NAME] = exports.CPQ_PRODUCT_OPTION,
    _d);
exports.SCHEDULE_CONTRAINT_FIELD_TO_API_MAPPING = (_e = {},
    _e[exports.CPQ_ACCOUNT_NO_PRE] = exports.CPQ_ACCOUNT,
    _e);
// sbaa
...
// sbaa Fields
exports.SBAA_CONDITIONS_MET = 'sbaa__ConditionsMet__c';
...
// Salesforce Errors
exports.SALESFORCE_ERROR_PREFIX = 'sf:';
exports.SALESFORCE_ERRORS = {
    INVALID_CROSS_REFERENCE_KEY: exports.SALESFORCE_ERROR_PREFIX + "INVALID_CROSS_REFERENCE_KEY",
    DUPLICATE_VALUE: exports.SALESFORCE_ERROR_PREFIX + "DUPLICATE_VALUE",
    INVALID_ID_FIELD: exports.SALESFORCE_ERROR_PREFIX + "INVALID_ID_FIELD",
    INVALID_FIELD: exports.SALESFORCE_ERROR_PREFIX + "INVALID_FIELD",
    INVALID_TYPE: exports.SALESFORCE_ERROR_PREFIX + "INVALID_TYPE",
    UNKNOWN_EXCEPTION: exports.SALESFORCE_ERROR_PREFIX + "UNKNOWN_EXCEPTION",
    REQUEST_LIMIT_EXCEEDED: exports.SALESFORCE_ERROR_PREFIX + "REQUEST_LIMIT_EXCEEDED",
    INVALID_QUERY_FILTER_OPERATOR: exports.SALESFORCE_ERROR_PREFIX + "INVALID_QUERY_FILTER_OPERATOR",
};
var isSalesforceError = function (error) {
    var errorCode = lodash_1["default"].get(error, exports.ERROR_PROPERTIES.ERROR_CODE);
    return lodash_1["default"].isString(errorCode) && Object.values(exports.SALESFORCE_ERRORS).includes(errorCode);
};
