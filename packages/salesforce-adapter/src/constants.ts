...
export const CUSTOM_FIELD_TRANSLATION_METADATA_TYPE = 'CustomFieldTranslation'
export const VALIDATION_RULE_TRANSLATION_METADATA_TYPE = 'ValidationRuleTranslation'
