...
var generalConstantsResolver = function (element, baseUrl) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b, _c, _d;
...
var customObjectSubInstanceResolver = function (element, baseUrl, elementIDResolver) { return __awaiter(void 0, void 0, void 0, function () {
    var instanceType, _a, instanceUri, internalId, parentRef, parent, parentIdentifier;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 2:
                ...
                instanceUri = METADATA_TYPE_TO_URI[instanceType];
                internalId = utils_1.getInternalId(element);
                parentRef = adapter_utils_1.getParents(element)[0];
                if (instanceUri === undefined || internalId === undefined || !adapter_api_1.isReferenceExpression(parentRef)) {
                    return [2 /*return*/, undefined];
                }
                return [4 /*yield*/, elementIDResolver(parentRef.elemID)];
            case 3:
                parent = _b.sent();
                return [4 /*yield*/, getTypeIdentifier(parent)];
            case 4:
                parentIdentifier = _b.sent();
                if (parentIdentifier !== undefined) {
                    return [2 /*return*/, new URL(baseUrl + "lightning/setup/ObjectManager/" + parentIdentifier + "/" + instanceUri + "/" + internalId + "/view")];
                }
                return [2 /*return*/, undefined];
        }
    });
...
var pathAssistantResolver = function (element, baseUrl) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, utils_1.isInstanceOfType(constants_1.PATH_ASSISTANT_METADATA_TYPE)(element)];
            case 1:
                if (_a.sent()) {
                    return [2 /*return*/, new URL(baseUrl + "lightning/setup/PathAssistantSetupHome/page?address=%2Fui%2Fsetup%2Fpathassistant%2FPathAssistantSetupPage%3Fisdtp%3Dp1")];
                }
                return [2 /*return*/, undefined];
        }
    });
...
exports.resolvers = [generalConstantsResolver,
