...
exports.WARNING_MESSAGE = exports.SHARING_RULES_API_NAMES = void 0;
/*
...
exports.SHARING_RULES_API_NAMES = ['SharingCriteriaRule', 'SharingGuestRule', 'SharingOwnerRule'];
...
var getSharingRulesFileProperties = function (client) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, client.listMetadataObjects(exports.SHARING_RULES_API_NAMES.map(function (ruleType) { return ({ type: ruleType }); }))];
            case 1:
