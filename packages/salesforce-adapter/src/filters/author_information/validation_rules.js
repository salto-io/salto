...
var VALIDATION_RULES_API_NAME = 'ValidationRule';
var isValidationRulesInstance = utils_1.isInstanceOfType(constants_1.VALIDATION_RULES_METADATA_TYPE);
var getValidationRulesFileProperties = function (client) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, result, errors;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, client.listMetadataObjects({ type: VALIDATION_RULES_API_NAME })];
            case 1:
...
var fetchAllValidationRules = function (client) { return __awaiter(void 0, void 0, void 0, function () {
    var allRules;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getValidationRulesFileProperties(client)];
            case 1:
                allRules = _a.sent();
                return [2 /*return*/, lodash_1["default"].keyBy(allRules, 'fullName')];
        }
    });
}); };
    ...
    return ({
        onFetch: utils_1.ensureSafeFilterFetch({
            ...
            fetchFilterFunc: function (elements) { return __awaiter(void 0, void 0, void 0, function () {
                var ValidationRulesMap, validationRulesInstances;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fetchAllValidationRules(client)];
                        case 1:
                            ValidationRulesMap = _a.sent();
                            return [4 /*yield*/, (awu(elements)
                                    .filter(adapter_api_1.isInstanceElement)
                                    .filter(isValidationRulesInstance)
                                    .toArray())];
                        case 2:
                            validationRulesInstances = _a.sent();
                            validationRulesInstances.forEach(function (validationRule) {
                                if (isDefined(ValidationRulesMap[validationRule.value.fullName])) {
                                    validationRule.annotate(transformer_1.getAuthorAnnotations(ValidationRulesMap[validationRule.value.fullName]));
                                }
                            });
                            return [2 /*return*/];
                    }
