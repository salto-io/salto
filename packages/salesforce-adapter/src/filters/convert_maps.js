 ...
 */
var filePathMapper = function (val) {
    var splitPath = val.split('/');
    if (splitPath.length >= 3) {
        return [adapter_utils_1.naclCase(splitPath.slice(2).join('/'))];
    }
    log.warn("Path " + val + " has less than two levels, using only the last part as the key");
    return [adapter_utils_1.naclCase(lodash_1["default"].last(splitPath))];
};
...
var LIGHTNING_COMPONENT_BUNDLE_MAP = {
    'lwcResources.lwcResource': { key: 'filePath', mapper: (function (item) { return filePathMapper(item); }) },
};
...
var convertInstanceFieldsToMaps = function (instancesToConvert, instanceMapFieldDef) { return __awaiter(void 0, void 0, void 0, function () {
    var nonUniqueMapFields;
    return __generator(this, function (_a) {
        nonUniqueMapFields = lodash_1["default"].uniq(instancesToConvert.flatMap(function (instance) {
            var nonUniqueFields = convertArraysToMaps(instance, instanceMapFieldDef);
        ...
        return [2 /*return*/, nonUniqueMapFields];
    });
}); };
/**
