        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, awu(elements)
                        ...
                        .filter(function (instance) { return __awaiter(void 0, void 0, void 0, function () { var _a; return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                        ...
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                ...
                                case 1: return [4 /*yield*/, _b.apply(void 0, [(_c.type = _d.sent(),
                                            _c.transformFunc = transformer_1.transformPrimitive,
                                            _c.strict = false,
                                            _c.allowEmpty = true,
                                            _c)])];
                                case 2:
