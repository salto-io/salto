...
var filterCreator = function () { return ({
    ...
    onFetch: function (elements) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            wu_1["default"](elements)
                .filter(adapter_api_1.isInstanceElement)
                .filter(function (instance) { return adapter_api_1.isObjectType(instance.getTypeSync()); })
                .forEach(function (instance) {
                instance.value = adapter_utils_1.transformValuesSync({
