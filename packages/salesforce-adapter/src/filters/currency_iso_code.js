...
var filterCreator = function (_a) {
    ...
    return ({
        ...
        preDeploy: function (changes) { return __awaiter(void 0, void 0, void 0, function () {
            var objectTypesWithIsoCodeFields;
            return __generator(this, function (_a) {
                objectTypesWithIsoCodeFields = changes
                    .filter(adapter_api_1.isAdditionChange)
                    .filter(adapter_api_1.isObjectTypeChange)
                    .map(adapter_api_1.getChangeData)
                    .filter(function (objType) { var _a, _b; return ((_b = (_a = objType.fields) === null || _a === void 0 ? void 0 : _a.CurrencyIsoCode) === null || _b === void 0 ? void 0 : _b.annotations.valueSetName) !== undefined; });
                objectTypesWithIsoCodeFields
                    .forEach(function (objType) {
                    var _a;
                    (_a = objType.fields.CurrencyIsoCode) === null || _a === void 0 ? true : delete _a.annotations.valueSetName;
                });
                return [2 /*return*/];
            });
        }); },
        onDeploy: function (changes) { return __awaiter(void 0, void 0, void 0, function () {
            var currencyCodeInstance, objectTypesWithIsoCodeFields;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, config.elementsSource.get(currencyCodeType.elemID.createNestedID('instance', adapter_api_1.ElemID.CONFIG_NAME))];
                    case 1:
                        currencyCodeInstance = _a.sent();
                        objectTypesWithIsoCodeFields = changes
                            .filter(adapter_api_1.isAdditionChange)
                            .filter(adapter_api_1.isObjectTypeChange)
                            .map(adapter_api_1.getChangeData)
                            .filter(function (objType) { return objType.fields[constants_1.CURRENCY_ISO_CODE] !== undefined; });
                        objectTypesWithIsoCodeFields
                            .forEach(function (objType) { return transformCurrencyIsoCodes(objType, currencyCodeInstance); });
                        return [2 /*return*/];
                }
            });
        }); },
