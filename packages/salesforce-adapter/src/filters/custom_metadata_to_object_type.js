...
var createCustomMetadataRecordType = function (instance, customMetadataType, config) { return __awaiter(void 0, void 0, void 0, function () {
    var objectType;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, custom_objects_to_object_type_1.createCustomTypeFromCustomObjectInstance({
                    instance: instance,
                    metadataType: constants_1.CUSTOM_METADATA,
                    config: config,
                })];
            case 1:
                objectType = _a.sent();
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, awu(customMetadataInstances)
                                .map(function (instance) { return createCustomMetadataRecordType(instance, customMetadataType, config); })
                                .toArray()];
                    case 2:
