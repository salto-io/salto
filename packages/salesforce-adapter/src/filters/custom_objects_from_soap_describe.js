...
var addSObjectInformationToInstance = function (instance, sobject, systemFields) { return __awaiter(void 0, void 0, void 0, function () {
    var fieldsFromMetadataApi, getCompoundTypeName, objCompoundFieldNames, sobjectFields, addedFieldNames, modifiedFieldNames, instanceFullName;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                objCompoundFieldNames = lodash_1["default"].mapValues(lodash_1["default"].groupBy(sobject.fields.filter(transformer_1.isSubfieldOfCompound), function (field) { return field.compoundFieldName; }), getCompoundTypeName);
                return [4 /*yield*/, Promise.all(sobject.fields
                        .filter(function (field) { return !transformer_1.isSubfieldOfCompound(field); }) // Filter out nested fields of compound fields
            ...
            case 1:
                ...
                instanceFullName = instance.elemID.getFullName();
