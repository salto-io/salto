...
var createNestedMetadataInstances = function (instance, objectType, nestedMetadataTypes) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        path = __spreadArrays(objectType.path.slice(0, -1), [
                            typeFolderName,
                            instanceFileName,
                        ]);
                        return [2 /*return*/, new adapter_api_1.InstanceElement(instanceName, type, nestedInstanceValues, path, (_a = {}, _a[adapter_api_1.CORE_ANNOTATIONS.PARENT] = [new adapter_api_1.ReferenceExpression(objectType.elemID, objectType)], _a))];
                }
            });
        }); });
    }).toArray();
...
var createCustomTypeFromCustomObjectInstance = function (_a) {
    var instance = _a.instance, _b = _a.typesFromInstance, typesFromInstance = _b === void 0 ? DEFAULT_TYPES_FROM_INSTANCE : _b, _c = _a.fieldsToSkip, fieldsToSkip = _c === void 0 ? [] : _c, objectMetadataType = _a.metadataType, config = _a.config;
    return __awaiter(void 0, void 0, void 0, function () {
        var name, label, pluralLabel, keyPrefix, serviceIds, object, _d, annotationTypes, instanceFields, _e, _f;
        var _g;
        return __generator(this, function (_h) {
            switch (_h.label) {
                case 0:
                    ...
                    pluralLabel = instance.value[constants_1.PLURAL_LABEL];
                    keyPrefix = instance.value[constants_1.KEY_PREFIX];
                    serviceIds = (_g = {},
                        _g[constants_1.API_NAME] = name,
                    ...
                    if (pluralLabel !== undefined) {
                        utils_1.addPluralLabel(object, pluralLabel);
                    }
                    utils_1.addKeyPrefix(object, keyPrefix === null ? undefined : keyPrefix);
                    _d = object;
                    return [4 /*yield*/, exports.getObjectDirectoryPath(object)];
                case 1:
                    _d.path = __spreadArrays.apply(void 0, [_h.sent(), [adapter_utils_1.pathNaclCase(object.elemID.name)]]);
                ...
                case 3:
                    _h.sent();
                    if (!!config.fetchProfile.isFeatureEnabled('skipAliases')) return [3 /*break*/, 5];
                    _e = object.annotations;
                    _f = adapter_api_1.CORE_ANNOTATIONS.ALIAS;
                    return [4 /*yield*/, utils_1.getInstanceAlias(instance, config.fetchProfile.isFeatureEnabled('useLabelAsAlias'))];
                case 4:
                    _e[_f] = _h.sent();
                    _h.label = 5;
...
var createFromInstance = function (instance, typesFromInstance, config, fieldsToSkip) { return __awaiter(void 0, void 0, void 0, function () {
...
var createCustomObjectChange = function (fieldsToSkip, fullName, changes) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_l) {
            switch (_l.label) {
                case 0:
                    objectChange = changes.find(adapter_api_1.isObjectTypeChange);
                    if (!(objectChange !== undefined && objectChange.action === 'remove')) return [3 /*break*/, 3];
                ...
                case 2: return [2 /*return*/, (_j.data = (_k.before = _a.apply(void 0, [__assign.apply(void 0, _c.concat([_l.sent()]))]),
                        _k),
                        _j)];
                case 3:
                ...
                case 5:
                    ...
                    if (!(beforeParent === undefined)) return [3 /*break*/, 6];
                    _h = {};
                    return [3 /*break*/, 8];
                case 6: return [4 /*yield*/, transformer_1.toCustomProperties(beforeParent, false)];
                case 7:
                    _h = _l.sent();
                    _l.label = 8;
                case 8:
...
var typesToMergeFromInstance = function (elements) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                fixTypesDefinitions = function (typesFromInstance) {
                    var listViewType = typesFromInstance[exports.NESTED_INSTANCE_VALUE_NAME.LIST_VIEWS];
                    listViewType.fields.columns.refType = adapter_api_1.createRefToElmWithValue(utils_1.toListType(listViewType.fields.columns.getTypeSync()));
                    listViewType.fields.filters.refType = adapter_api_1.createRefToElmWithValue(utils_1.toListType(listViewType.fields.filters.getTypeSync()));
                    var fieldSetType = typesFromInstance[exports.NESTED_INSTANCE_VALUE_NAME.FIELD_SETS];
                    fieldSetType.fields.availableFields.refType = adapter_api_1.createRefToElmWithValue(utils_1.toListType(fieldSetType.fields.availableFields.getTypeSync()));
                    fieldSetType.fields.displayedFields.refType = adapter_api_1.createRefToElmWithValue(utils_1.toListType(fieldSetType.fields.displayedFields.getTypeSync()));
                    var compactLayoutType = typesFromInstance[exports.NESTED_INSTANCE_VALUE_NAME.COMPACT_LAYOUTS];
                    compactLayoutType.fields.fields.refType = adapter_api_1.createRefToElmWithValue(utils_1.toListType(compactLayoutType.fields.fields.getTypeSync()));
...
var filterCreator = function (_a) {
    ...
    return {
        ...
        onFetch: function (elements) { return __awaiter(void 0, void 0, void 0, function () {
            var typesFromInstance, existingElementIDs, fieldsToSkip, customObjectInstances, _a, customObjectType;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, awu(customObjectInstances)
                                .flatMap(function (instance) { return createFromInstance(instance, typesFromInstance, config, fieldsToSkip); })
                    ...
                    case 3:
                        _b.sent();
                        // Remove CustomObject instances & hide the CustomObject metadata type
                        lodash_1["default"].remove(elements, utils_1.isInstanceOfTypeSync(constants_1.CUSTOM_OBJECT));
                        customObjectType = elements
                            .filter(transformer_1.isMetadataObjectType)
                            .find(function (type) { return type.elemID.name === constants_1.CUSTOM_OBJECT; });
                        if (customObjectType !== undefined) {
                            customObjectType.annotations[adapter_api_1.CORE_ANNOTATIONS.HIDDEN] = true;
                        }
