...
const CUSTOM_SETTINGS_ONLY_ANNOTATION_TYPE_NAMES = [
  'customSettingsType',
  'apiName',
  'metadataType',
  'enableFeeds',
...
const ANNOTATIONS_TO_IGNORE_FROM_INSTANCE = [
  'eventType',
  'publishBehavior',
  'fields',
  INSTANCE_FULL_NAME_FIELD,
...
const annotationTypesForObject = (
...
const transformObjectAnnotationValues = (
  instance: InstanceElement,
...
const shouldIncludeFieldChange =
...
const isSideEffectRemoval =
  ...
  async (change: Change): Promise<boolean> => {
    ...
    return (
      ...
      removedObjectNames.includes(parentName)
    )
  }
