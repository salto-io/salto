...
var isEmailTemplateAttachment = function (attachment) {
    var name = lodash_1["default"].get(attachment, 'name');
    var content = lodash_1["default"].get(attachment, 'content');
    return lodash_1["default"].isString(name) && (Buffer.isBuffer(content) || lodash_1["default"].isString(content) || adapter_api_1.isStaticFile(content));
};
var isEmailAttachmentsArray = function (attachments) { return (attachments.every(isEmailTemplateAttachment)); };
            ...
            case 3:
                ...
                try {
                    ...
                    if (isEmailAttachmentsArray(instance.value.attachments)) {
                        ...
                        log.debug('email template attachments are not an array: %s', adapter_utils_1.safeJsonStringify(instance.value.attachments, function (_key, value) { return (lodash_1["default"].isString(value) ? lodash_1["default"].truncate(value) : value); }));
                    }
                    else if (instance.value.attachments.length > 0) {
                        log.debug('email template attachments exist, but failed JOI validation: %s', adapter_utils_1.safeJsonStringify(instance.value.attachments, function (_key, value) { return (lodash_1["default"].isString(value) ? lodash_1["default"].truncate(value) : value); }));
                    }
                }
                catch (err) {
...
var getAttachmentsFromChanges = function (changes) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, (awu(changes)
                ...
                .filter(utils_1.isInstanceOfTypeChange(constants_1.EMAIL_TEMPLATE_METADATA_TYPE))
                .map(adapter_api_1.getChangeData)
                .flatMap(function (instance) { return makeArray(instance.value.attachments); })
...
var filter = function () { return ({
    ...
    preDeploy: function (changes) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getAttachmentsFromChanges(changes)];
                case 1:
                    (_a.sent())
                        .forEach(function (attachment) {
                        if (lodash_1["default"].isBuffer(attachment.content)) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    (_a.sent())
                        .forEach(function (attachment) {
                        if (lodash_1["default"].isString(attachment.content)) {
