 ...
 */
var createQueries = function (whereClauses, toolingDepsOfCurrentNamespace, orgNamespace) {
    var baseQueries = whereClauses.map(function (clause) { return "SELECT \n    MetadataComponentId, MetadataComponentType, MetadataComponentName, \n    RefMetadataComponentId, RefMetadataComponentType, RefMetadataComponentName \n  FROM MetadataComponentDependency WHERE " + clause; });
    if (!toolingDepsOfCurrentNamespace) {
        return baseQueries;
    }
    var nonNamespaceDepsQueries = baseQueries.map(function (query) { return query + " AND MetadataComponentNamespace = '" + orgNamespace + "'"; });
    var namespaceDepsQueries = baseQueries.map(function (query) { return query + " AND MetadataComponentNamespace != '" + orgNamespace + "'"; });
    return nonNamespaceDepsQueries.concat(namespaceDepsQueries);
};
var getDependencies = function (client, toolingDepsOfCurrentNamespace) { return __awaiter(void 0, void 0, void 0, function () {
    var allTypes, whereClauses, allQueries, allDepsIters, queriesRecordsCount, allDepsResults, deps;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                allQueries = createQueries(whereClauses, toolingDepsOfCurrentNamespace, client.orgNamespace);
                return [4 /*yield*/, Promise.all(allQueries.map(function (q) { return client.queryAll(q, true); }))];
            case 1:
                allDepsIters = _a.sent();
                queriesRecordsCount = [];
                allDepsResults = allDepsIters.map(function (iter) { return lowerdash_1.collections.asynciterable.mapAsync(iter, function (recs) {
                    queriesRecordsCount.push(recs.length);
                    return recs.map(function (rec) { return ({
                        from: {
        ...
        onFetch: utils_1.ensureSafeFilterFetch({
            ...
            fetchFilterFunc: function (elements) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0: return [4 /*yield*/, getDependencies(client, config.fetchProfile.isFeatureEnabled('toolingDepsOfCurrentNamespace'))];
                        case 1:
                            groupedDeps = _e.sent();
