...
exports.FLOW_METADATA_TYPE_ID = void 0;
/*
...
exports.FLOW_METADATA_TYPE_ID = new adapter_api_1.ElemID(constants_1.SALESFORCE, 'FlowMetadataValue');
/**
...
var filterCreator = function () { return ({
    ...
    onFetch: function (elements) { return __awaiter(void 0, void 0, void 0, function () {
        var flowMetadataValue;
        return __generator(this, function (_a) {
            flowMetadataValue = adapter_utils_1.findObjectType(elements, exports.FLOW_METADATA_TYPE_ID);
            if (flowMetadataValue && flowMetadataValue.fields.name) {
                // eslint-disable-next-line camelcase
                adapter_api_1.getRestriction(flowMetadataValue.fields.name).enforce_value = false;
            }
            return [2 /*return*/];
        });
    }); },
