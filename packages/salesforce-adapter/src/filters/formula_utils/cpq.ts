...
const cpqMapping: Record<string, Record<string, string>> = {
  ...
  SBQQ__DIMENSION__C: {
    ...
    SBQQ__PRICEBOOK__R: 'Pricebook2',
    SBQQ__DISCOUNTSCHEDULE__R: 'SBQQ__DiscountSchedule__c',
    SBQQ__TERMDISCOUNTSCHEDULE__C: 'SBQQ__DiscountSchedule__c',
  },
  ...
  SBQQ__OPTIONCONSTRAINT__C: {
    SBQQ__CONSTRAINEDOPTION__R: 'SBQQ__ProductOption__c',
    SBQQ__CONFIGUREDSKU__R: 'Product2',
    SBQQ__CONSTRAININGOPTION__R: 'SBQQ__ProductOption__c',
  },
}
