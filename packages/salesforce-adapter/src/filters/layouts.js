...
exports.WEBLINK_TYPE_ID = exports.LAYOUT_TYPE_ID = void 0;
/*
                ...
                switch (_d.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, awu(layouts).forEach(function (layout) { return __awaiter(void 0, void 0, void 0, function () {
                                var _a, layoutObjName, layoutName, _b, layoutObjId, layoutObj, _c, _d;
                                return __generator(this, function (_e) {
                                    switch (_e.label) {
                                        case 0:
                                            _b = utils_1.layoutObjAndName;
                                            return [4 /*yield*/, transformer_1.apiName(layout)];
                                        case 1:
                                            _a = _b.apply(void 0, [_e.sent()]), layoutObjName = _a[0], layoutName = _a[1];
