...
var toMinifiedChange = function (change) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, before, after, detailedChanges, minifiedAfter, _b, _c, newLayoutAssignmentNames, profileSections;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 1:
                ...
                profileSections = lodash_1["default"](after.value)
                    .pickBy(lodash_1["default"].isPlainObject)
                    .mapValues(function () { return ({}); })
                    .value();
                minifiedAfter.value = lodash_1["default"].assign(profileSections, minifiedAfter.value);
