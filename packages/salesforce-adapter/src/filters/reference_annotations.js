 ...
 * @param annotationNames List of field annotations where references may be found
 */
var convertAnnotationsToReferences = function (elements, nameToElement, annotationNames) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            case 0:
                resolveTypeReference = function (ref) {
                    ...
                    if (lodash_1["default"].isString(ref)) {
                        ...
                        var referenceElement = (_a = nameToElement.get(ref, ref)) !== null && _a !== void 0 ? _a : nameToElement.get(constants_1.CUSTOM_OBJECT, ref);
                        // SALTO-5063
                        if (referenceElement !== undefined && utils_1.apiNameSync(referenceElement) !== constants_1.CUSTOM_OBJECT) {
                            return new adapter_api_1.ReferenceExpression(referenceElement.elemID, referenceElement);
                        }
                    }
                    return ref;
                };
...
var filter = function (_a) {
    ...
    return ({
        ...
        onFetch: function (elements) { return __awaiter(void 0, void 0, void 0, function () {
            var referenceElements, nameToElement, _a, _b;
            var _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1: return [4 /*yield*/, _b.apply(_a, [(_c.iter = _d.sent(),
                                ...
                                _c)])];
                    case 2:
                        nameToElement = _d.sent();
                        return [4 /*yield*/, convertAnnotationsToReferences(elements, nameToElement, [REFERENCE_TO, constants_1.FOREIGN_KEY_DOMAIN])];
                    case 3:
                        _d.sent();
                        return [2 /*return*/];
                }
