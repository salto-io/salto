...
var FIELDS_TO_REMOVE_RESTRICTION_FROM_BY_TYPE = {
 ...
 */
var makeFilter = function (typeNameToFieldMapping) { return function () { return ({
    onFetch: function (elements) { return __awaiter(void 0, void 0, void 0, function () {
        var removeRestrictionsFromTypeFields;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    removeRestrictionsFromTypeFields = function (type) { return __awaiter(void 0, void 0, void 0, function () {
                        var relevantFields, _a;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    _a = typeNameToFieldMapping;
                                    return [4 /*yield*/, transformer_1.metadataType(type)];
                                case 1:
                                    relevantFields = _a[_b.sent()];
                                    relevantFields.forEach(function (fieldName) {
                                        var field = type.fields[fieldName];
                                        if (field !== undefined && field.annotations[adapter_api_1.CORE_ANNOTATIONS.RESTRICTION] !== undefined) {
                                            delete field.annotations[adapter_api_1.CORE_ANNOTATIONS.RESTRICTION];
                                        }
                                    });
                                    return [2 /*return*/];
                            }
                    ...
                    return [4 /*yield*/, awu(elements)
                            ...
                            .filter(function (type) { return __awaiter(void 0, void 0, void 0, function () { var _a; return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    _a = typeNameToFieldMapping;
                                    return [4 /*yield*/, transformer_1.metadataType(type)];
...
exports["default"] = exports.makeFilter(FIELDS_TO_REMOVE_RESTRICTION_FROM_BY_TYPE);
