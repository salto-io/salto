            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        ...
                        if (!!config.fetchProfile.metadataQuery.isPartialFetch()) return [3 /*break*/, 5];
                        _a = fetchedSVSInstances;
                        return [3 /*break*/, 8];
                    case 5:
                        _b = awu;
                        return [4 /*yield*/, adapter_utils_1.buildElementsSourceFromElements(elements, [config.elementsSource]).getAll()];
                    case 6: return [4 /*yield*/, _b.apply(void 0, [_c.sent()])
                            .filter(utils_1.isInstanceOfTypeSync(exports.STANDARD_VALUE_SET))
                            .toArray()];
                    case 7:
                        _a = _c.sent();
                        _c.label = 8;
                    case 8:
                        svsInstances = _a;
                        if (!lowerdash_1.types.isNonEmptyArray(svsInstances)) return [3 /*break*/, 10];
