...
exports.deployMetadata = exports.DEPLOY_WRAPPER_INSTANCE_MARKER = void 0;
/*
...
var addChangeToPackage = function (pkg, change, nestedMetadataTypes) { return __awaiter(void 0, void 0, void 0, function () {
    var instance, isWrapperInstance, instanceMetadataType, instanceApiName, addInstanceToManifest, addedIds, _a, _b, _c, nestedTypeInfo, _d, addChildInstancesToManifest, nestedInstanceIds;
    var _e;
    return __generator(this, function (_f) {
        switch (_f.label) {
            ...
            case 1:
                instanceMetadataType = _f.sent();
                return [4 /*yield*/, transformer_1.apiName(instance)];
            case 2:
                instanceApiName = _f.sent();
                addInstanceToManifest = !isWrapperInstance;
                addedIds = addInstanceToManifest
                    ? (_e = {}, _e[instanceMetadataType] = new Set([instanceApiName]), _e) : {};
                if (!adapter_api_1.isRemovalChange(change)) return [3 /*break*/, 4];
                _b = (_a = pkg)["delete"];
                _c = transformer_1.assertMetadataObjectType;
                return [4 /*yield*/, instance.getType()];
            case 3:
                _b.apply(_a, [_c.apply(void 0, [_f.sent()]), instanceApiName]);
                return [3 /*break*/, 6];
            case 4: return [4 /*yield*/, pkg.add(instance, addInstanceToManifest)];
            case 5:
                _f.sent();
                _f.label = 6;
            case 6:
                _d = nestedMetadataTypes;
                return [4 /*yield*/, transformer_1.metadataType(instance)];
            case 7:
                nestedTypeInfo = _d[_f.sent()];
                if (!(nestedTypeInfo !== undefined)) return [3 /*break*/, 9];
            ...
            case 9:
                ...
                if (instanceMetadataType === global_value_sets_1.GLOBAL_VALUE_SET && !instanceApiName.endsWith(constants_1.GLOBAL_VALUE_SET_SUFFIX)) {
                    addedIds[instanceMetadataType].add("" + instanceApiName + constants_1.GLOBAL_VALUE_SET_SUFFIX);
                }
                return [2 /*return*/, addedIds];
        }
    });
}); };
...
var processDeployResponse = function (result, deletionsPackageName, typeAndNameToElemId) {
    ...
    var componentErrors = allFailureMessages
        ...
        var _a;
        return ({
            elemID: (_a = typeAndNameToElemId[failure.componentType]) === null || _a === void 0 ? void 0 : _a[failure.fullName],
    ...
    var testErrors = testFailures
        .map(function (failure) { return ({
        message: util_1["default"].format('Test failed for class %s method %s with error:\n%s\n%s', failure.name, failure.methodName, failure.message, failure.stackTrace),
        severity: 'Error',
    }); });
    var codeCoverageWarningErrors = makeArray(result.details)
        ...
        .map(function (message) { return ({ message: message, severity: 'Error' }); });
    var errors = __spreadArrays(testErrors, componentErrors, codeCoverageWarningErrors);
    if (isDefined(result.errorMessage)) {
        errors.push({ message: result.errorMessage, severity: 'Error' });
    }
        ...
        switch (_b.label) {
            ...
            case 1:
                if ((_b.sent()) === undefined) {
                    return [2 /*return*/, { elemID: changeElem.elemID, message: "Cannot " + change.action + " element because it has no api name", severity: 'Error' }];
                }
            ...
            case 3:
                ...
                if (beforeName !== afterName) {
                    return [2 /*return*/, { elemID: changeElem.elemID, message: "Failed to update element because api names prev=" + beforeName + " and new=" + afterName + " are different", severity: 'Error' }];
                }
                _b.label = 4;
            case 4:
            ...
            case 6:
                if (_a) {
                    return [2 /*return*/, { elemID: changeElem.elemID, message: 'Cannot deploy because it is not a metadata instance', severity: 'Error' }];
                }
        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                errors = invalidChanges
                    .filter(function (change) { return isDefined(change.error); })
                    .map(function (_a) {
                    var error = _a.error;
                    return error;
                });
...
var quickDeployOrDeploy = function (client, pkgData, checkOnly, quickDeployParams) { return __awaiter(void 0, void 0, void 0, function () {
    var e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!(quickDeployParams !== undefined)) return [3 /*break*/, 4];
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
            ...
            case 3:
                e_1 = _a.sent();
                log.warn("preforming regular deploy instead of quick deploy due to error: " + e_1.message);
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/, client.deploy(pkgData, { checkOnly: checkOnly })];
        }
    });
}); };
...
var deployMetadata = function (changes, client, groupId, nestedMetadataTypes, deleteBeforeUpdate, checkOnly, quickDeployParams) { return __awaiter(void 0, void 0, void 0, function () {
    var pkg, _a, validChanges, validationErrors, changeToDeployedIds, deployedComponentsElemIdsByType, pkgData, planHash, sfDeployRes, _b, errors, successfulFullNames, isSuccessfulChange, deploymentUrl;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    Object.entries(deployedIds).forEach(function (_a) {
            ...
            case 3:
                pkgData = _d.sent();
                planHash = lowerdash_1.hash.toMD5(pkgData);
                ...
                return [4 /*yield*/, quickDeployOrDeploy(client, pkgData, checkOnly, quickDeployParams)];
            case 4:
                sfDeployRes = _d.sent();
                ...
                _b = processDeployResponse(sfDeployRes, pkg.getDeletionsPackageName(), deployedComponentsElemIdsByType), errors = _b.errors, successfulFullNames = _b.successfulFullNames;
