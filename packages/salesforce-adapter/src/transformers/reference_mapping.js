...
exports.getLookupNameWithFallbackToElement = exports.getLookUpName = exports.generateReferenceResolverFinder = exports.FieldReferenceResolver = exports.getReferenceMappingDefs = exports.referencesFromProfile = exports.fieldPermissionEnumDisabledExtraMappingDefs = exports.defaultFieldNameToTypeMappingDefs = void 0;
/*
...
exports.defaultFieldNameToTypeMappingDefs = __spreadArrays([
    ...
    },
    {
        ...
        serializationStrategy: 'relativeApiName',
        target: { parentContext: 'neighborSobjectLookup', type: constants_1.CUSTOM_FIELD },
    },
    {
...
exports.fieldPermissionEnumDisabledExtraMappingDefs = [
    {
        src: { field: 'field', parentTypes: ['ProfileFieldLevelSecurity'] },
        target: { type: constants_1.CUSTOM_FIELD },
    },
];
exports.referencesFromProfile = [
    {
    ...
    },
    {
        ...
        serializationStrategy: 'relativeApiName',
        target: { type: constants_1.CUSTOM_FIELD, parentContext: 'instanceParent' },
    },
];
/**
 ...
 */
var fieldNameToTypeMappingDefs = __spreadArrays(exports.defaultFieldNameToTypeMappingDefs, exports.fieldPermissionEnumDisabledExtraMappingDefs, exports.referencesFromProfile);
var getReferenceMappingDefs = function (args) {
    var refDefs = exports.defaultFieldNameToTypeMappingDefs;
    if (args.enumFieldPermissions) {
        refDefs = refDefs.concat(exports.fieldPermissionEnumDisabledExtraMappingDefs);
    }
    if (args.otherProfileRefs) {
        refDefs = refDefs.concat(exports.referencesFromProfile);
    }
    return refDefs;
};
exports.getReferenceMappingDefs = getReferenceMappingDefs;
...
var getLookUpNameImpl = function (_a) {
    var defs = _a.defs, resolveToElementFallback = _a.resolveToElementFallback;
    ...
    return function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var isInstanceAnnotation, strategy, defaultStrategy, resolvedValue;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        isInstanceAnnotation = (path === null || path === void 0 ? void 0 : path.idType) === 'instance' && path.isAttrID();
                        if (!!isInstanceAnnotation) return [3 /*break*/, 3];
                    ...
                    case 1:
                        ...
                        if (!adapter_api_1.isElement(ref.value)) return [3 /*break*/, 3];
                        defaultStrategy = ReferenceSerializationStrategyLookup.absoluteApiName;
                        return [4 /*yield*/, defaultStrategy.serialize({ ref: ref, element: element })];
                    case 2:
                        ...
                        if (resolveToElementFallback) {
                            ...
                            return [2 /*return*/, ref.value];
                        }
                        log.warn('could not resolve reference to %s in path %s, resolving to undefined', ref.elemID.getFullName(), path === null || path === void 0 ? void 0 : path.getFullName());
                        return [2 /*return*/, undefined];
                    case 3: return [2 /*return*/, ref.value];
                }
            });
        });
    };
 ...
 */
exports.getLookUpName = getLookUpNameImpl({ defs: fieldNameToTypeMappingDefs, resolveToElementFallback: false });
exports.getLookupNameWithFallbackToElement = getLookUpNameImpl({
