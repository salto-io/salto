...
var _20 = lowerdash_1.promises.object, mapValuesAsync = _20.mapValuesAsync, pickAsync = _20.pickAsync;
...
var isCustom = function (fullName) { var _a; return (_a = fullName === null || fullName === void 0 ? void 0 : fullName.endsWith(constants_1.SALESFORCE_CUSTOM_SUFFIX)) !== null && _a !== void 0 ? _a : false; };
...
var Types = /** @class */ (function () {
    ...
    Types.primitiveDataTypes = {
        ...
        Text: new adapter_api_1.PrimitiveType({
            ...
            primitive: adapter_api_1.PrimitiveTypes.STRING,
            annotationRefsOrTypes: __assign(__assign({}, Types.commonAnnotationTypes), (_v = {}, _v[constants_1.FIELD_ANNOTATIONS.UNIQUE] = adapter_api_1.BuiltinTypes.BOOLEAN, _v[constants_1.FIELD_ANNOTATIONS.CASE_SENSITIVE] = adapter_api_1.BuiltinTypes.BOOLEAN, _v[constants_1.FIELD_ANNOTATIONS.LENGTH] = restrictedNumberTypes.TextLength, _v[constants_1.DEFAULT_VALUE_FORMULA] = adapter_api_1.BuiltinTypes.STRING, _v)),
        }),
        Number: new adapter_api_1.PrimitiveType({
            ...
            primitive: adapter_api_1.PrimitiveTypes.NUMBER,
            annotationRefsOrTypes: __assign(__assign({}, Types.commonAnnotationTypes), (_w = {}, _w[constants_1.FIELD_ANNOTATIONS.SCALE] = adapter_api_1.BuiltinTypes.NUMBER, _w[constants_1.FIELD_ANNOTATIONS.PRECISION] = adapter_api_1.BuiltinTypes.NUMBER, _w[constants_1.FIELD_ANNOTATIONS.UNIQUE] = adapter_api_1.BuiltinTypes.BOOLEAN, _w[constants_1.DEFAULT_VALUE_FORMULA] = adapter_api_1.BuiltinTypes.STRING, _w)),
        }),
        AutoNumber: new adapter_api_1.PrimitiveType({
            ...
            primitive: adapter_api_1.PrimitiveTypes.STRING,
            annotationRefsOrTypes: __assign(__assign({}, Types.commonAnnotationTypes), (_x = {}, _x[constants_1.FIELD_ANNOTATIONS.DISPLAY_FORMAT] = adapter_api_1.BuiltinTypes.STRING, _x)),
        }),
        Checkbox: new adapter_api_1.PrimitiveType({
            ...
            annotationRefsOrTypes: __assign(__assign({}, Types.commonAnnotationTypes), (_y = {}, _y[constants_1.FIELD_ANNOTATIONS.DEFAULT_VALUE] = adapter_api_1.BuiltinTypes.BOOLEAN, _y)),
        }),
        Date: new adapter_api_1.PrimitiveType({
            ...
            primitive: adapter_api_1.PrimitiveTypes.STRING,
            annotationRefsOrTypes: __assign(__assign({}, Types.commonAnnotationTypes), (_z = {}, _z[constants_1.DEFAULT_VALUE_FORMULA] = adapter_api_1.BuiltinTypes.STRING, _z)),
        }),
        ...
        Currency: new adapter_api_1.PrimitiveType({
            ...
            primitive: adapter_api_1.PrimitiveTypes.NUMBER,
            annotationRefsOrTypes: __assign(__assign({}, Types.commonAnnotationTypes), (_2 = {}, _2[constants_1.FIELD_ANNOTATIONS.SCALE] = adapter_api_1.BuiltinTypes.NUMBER, _2[constants_1.FIELD_ANNOTATIONS.PRECISION] = adapter_api_1.BuiltinTypes.NUMBER, _2[constants_1.DEFAULT_VALUE_FORMULA] = adapter_api_1.BuiltinTypes.STRING, _2)),
        }),
        Picklist: new adapter_api_1.PrimitiveType({
            ...
            primitive: adapter_api_1.PrimitiveTypes.STRING,
            annotationRefsOrTypes: __assign(__assign({}, Types.commonAnnotationTypes), (_3 = {}, _3[constants_1.FIELD_ANNOTATIONS.FIELD_DEPENDENCY] = Types.fieldDependencyType, _3[constants_1.FIELD_ANNOTATIONS.VALUE_SET] = new adapter_api_1.ListType(Types.valueSetType), _3[constants_1.FIELD_ANNOTATIONS.RESTRICTED] = adapter_api_1.BuiltinTypes.BOOLEAN, _3[constants_1.VALUE_SET_FIELDS.VALUE_SET_NAME] = adapter_api_1.BuiltinTypes.STRING, _3[constants_1.VALUE_SET_DEFINITION_FIELDS.SORTED] = adapter_api_1.BuiltinTypes.BOOLEAN, _3[constants_1.DEFAULT_VALUE_FORMULA] = adapter_api_1.BuiltinTypes.STRING, _3)),
        }),
        ...
        Email: new adapter_api_1.PrimitiveType({
            ...
            primitive: adapter_api_1.PrimitiveTypes.STRING,
            annotationRefsOrTypes: __assign(__assign({}, Types.commonAnnotationTypes), (_5 = {}, _5[constants_1.FIELD_ANNOTATIONS.UNIQUE] = adapter_api_1.BuiltinTypes.BOOLEAN, _5[constants_1.DEFAULT_VALUE_FORMULA] = adapter_api_1.BuiltinTypes.STRING, _5)),
        }),
        Percent: new adapter_api_1.PrimitiveType({
            ...
            primitive: adapter_api_1.PrimitiveTypes.NUMBER,
            annotationRefsOrTypes: __assign(__assign({}, Types.commonAnnotationTypes), (_6 = {}, _6[constants_1.FIELD_ANNOTATIONS.SCALE] = adapter_api_1.BuiltinTypes.NUMBER, _6[constants_1.FIELD_ANNOTATIONS.PRECISION] = adapter_api_1.BuiltinTypes.NUMBER, _6[constants_1.DEFAULT_VALUE_FORMULA] = adapter_api_1.BuiltinTypes.STRING, _6)),
        }),
        Phone: new adapter_api_1.PrimitiveType({
            ...
            primitive: adapter_api_1.PrimitiveTypes.STRING,
            annotationRefsOrTypes: __assign(__assign({}, Types.commonAnnotationTypes), (_7 = {}, _7[constants_1.DEFAULT_VALUE_FORMULA] = adapter_api_1.BuiltinTypes.STRING, _7)),
        }),
        LongTextArea: new adapter_api_1.PrimitiveType({
            ...
            primitive: adapter_api_1.PrimitiveTypes.STRING,
            annotationRefsOrTypes: __assign(__assign({}, Types.commonAnnotationTypes), (_8 = {}, _8[constants_1.FIELD_ANNOTATIONS.VISIBLE_LINES] = restrictedNumberTypes.LongTextAreaVisibleLines, _8[constants_1.FIELD_ANNOTATIONS.LENGTH] = restrictedNumberTypes.TextAreaLength, _8[constants_1.DEFAULT_VALUE_FORMULA] = adapter_api_1.BuiltinTypes.STRING, _8)),
        }),
        Html: new adapter_api_1.PrimitiveType({
            ...
            primitive: adapter_api_1.PrimitiveTypes.STRING,
            annotationRefsOrTypes: __assign(__assign({}, Types.commonAnnotationTypes), (_9 = {}, _9[constants_1.FIELD_ANNOTATIONS.VISIBLE_LINES] = restrictedNumberTypes.RichTextAreaVisibleLines, _9[constants_1.FIELD_ANNOTATIONS.LENGTH] = restrictedNumberTypes.TextAreaLength, _9)),
        }),
        TextArea: new adapter_api_1.PrimitiveType({
            ...
            primitive: adapter_api_1.PrimitiveTypes.STRING,
            annotationRefsOrTypes: __assign(__assign({}, Types.commonAnnotationTypes), (_10 = {}, _10[constants_1.DEFAULT_VALUE_FORMULA] = adapter_api_1.BuiltinTypes.STRING, _10)),
        }),
        EncryptedText: new adapter_api_1.PrimitiveType({
            ...
            primitive: adapter_api_1.PrimitiveTypes.STRING,
            annotationRefsOrTypes: __assign(__assign({}, Types.commonAnnotationTypes), (_11 = {}, _11[constants_1.FIELD_ANNOTATIONS.MASK_CHAR] = Types.encryptedTextMaskCharType, _11[constants_1.FIELD_ANNOTATIONS.MASK_TYPE] = Types.encryptedTextMaskTypeType, _11[constants_1.FIELD_ANNOTATIONS.LENGTH] = restrictedNumberTypes.EncryptedTextLength, _11)),
        }),
        Url: new adapter_api_1.PrimitiveType({
            ...
            primitive: adapter_api_1.PrimitiveTypes.STRING,
            annotationRefsOrTypes: __assign(__assign({}, Types.commonAnnotationTypes), (_12 = {}, _12[constants_1.DEFAULT_VALUE_FORMULA] = adapter_api_1.BuiltinTypes.STRING, _12)),
        }),
        ...
        MasterDetail: new adapter_api_1.PrimitiveType({
            ...
            primitive: adapter_api_1.PrimitiveTypes.STRING,
            annotationRefsOrTypes: __assign(__assign({}, Types.commonAnnotationTypes), (_13 = {}, _13[constants_1.FIELD_ANNOTATIONS.REPARENTABLE_MASTER_DETAIL] = adapter_api_1.BuiltinTypes.BOOLEAN, _13[constants_1.FIELD_ANNOTATIONS.WRITE_REQUIRES_MASTER_READ] = adapter_api_1.BuiltinTypes.BOOLEAN, _13[constants_1.FIELD_ANNOTATIONS.LOOKUP_FILTER] = Types.lookupFilterType, _13[constants_1.FIELD_ANNOTATIONS.REFERENCE_TO] = new adapter_api_1.ListType(adapter_api_1.BuiltinTypes.STRING), _13[constants_1.FIELD_ANNOTATIONS.RELATIONSHIP_ORDER] = restrictedNumberTypes.RelationshipOrder, _13[constants_1.FIELD_ANNOTATIONS.RELATIONSHIP_NAME] = adapter_api_1.BuiltinTypes.STRING, _13[constants_1.FIELD_ANNOTATIONS.RELATIONSHIP_LABEL] = adapter_api_1.BuiltinTypes.STRING, _13)),
        }),
        Summary: new adapter_api_1.PrimitiveType({
            ...
            primitive: adapter_api_1.PrimitiveTypes.STRING,
            annotationRefsOrTypes: __assign(__assign({}, Types.commonAnnotationTypes), (_14 = {}, _14[constants_1.FIELD_ANNOTATIONS.SUMMARIZED_FIELD] = adapter_api_1.BuiltinTypes.STRING, _14[constants_1.FIELD_ANNOTATIONS.SUMMARY_FILTER_ITEMS] = new adapter_api_1.ListType(Types.rollupSummaryFilterItemsType), _14[constants_1.FIELD_ANNOTATIONS.SUMMARY_FOREIGN_KEY] = adapter_api_1.BuiltinTypes.STRING, _14[constants_1.FIELD_ANNOTATIONS.SUMMARY_OPERATION] = Types.rollupSummaryOperationType, _14)),
        }),
    ...
    Types.nameInnerFields = (_15 = {},
        _15[constants_1.NAME_FIELDS.FIRST_NAME] = {
            refType: adapter_api_1.BuiltinTypes.STRING,
        },
        _15[constants_1.NAME_FIELDS.LAST_NAME] = {
            refType: adapter_api_1.BuiltinTypes.STRING,
        },
        _15[constants_1.NAME_FIELDS.SALUTATION] = {
            refType: Types.primitiveDataTypes.Picklist,
        },
        _15[constants_1.NAME_FIELDS.MIDDLE_NAME] = {
            refType: adapter_api_1.BuiltinTypes.STRING,
        },
        _15[constants_1.NAME_FIELDS.SUFFIX] = {
            refType: adapter_api_1.BuiltinTypes.STRING,
        },
        _15);
    ...
    Types.compoundDataTypes = {
        Address: new adapter_api_1.ObjectType({
            ...
            fields: (_16 = {},
                _16[constants_1.ADDRESS_FIELDS.CITY] = {
                    refType: adapter_api_1.BuiltinTypes.STRING,
                },
                _16[constants_1.ADDRESS_FIELDS.COUNTRY] = {
                    refType: adapter_api_1.BuiltinTypes.STRING,
                },
                _16[constants_1.ADDRESS_FIELDS.GEOCODE_ACCURACY] = {
                    refType: Types.primitiveDataTypes.Picklist,
                },
                _16[constants_1.ADDRESS_FIELDS.LATITUDE] = {
                    refType: adapter_api_1.BuiltinTypes.NUMBER,
                },
                _16[constants_1.ADDRESS_FIELDS.LONGITUDE] = {
                    refType: adapter_api_1.BuiltinTypes.NUMBER,
                },
                _16[constants_1.ADDRESS_FIELDS.POSTAL_CODE] = {
                    refType: adapter_api_1.BuiltinTypes.STRING,
                },
                _16[constants_1.ADDRESS_FIELDS.STATE] = {
                    refType: adapter_api_1.BuiltinTypes.STRING,
                },
                _16[constants_1.ADDRESS_FIELDS.STREET] = {
        ...
        Location: new adapter_api_1.ObjectType({
            ...
            fields: (_17 = {},
                _17[constants_1.GEOLOCATION_FIELDS.LATITUDE] = {
                    refType: adapter_api_1.BuiltinTypes.NUMBER,
                },
                _17[constants_1.GEOLOCATION_FIELDS.LONGITUDE] = {
                    refType: adapter_api_1.BuiltinTypes.NUMBER,
                },
                _17),
            annotationRefsOrTypes: __assign((_18 = {}, _18[constants_1.FIELD_ANNOTATIONS.DISPLAY_LOCATION_IN_DECIMAL] = adapter_api_1.BuiltinTypes.BOOLEAN, _18[constants_1.FIELD_ANNOTATIONS.SCALE] = adapter_api_1.BuiltinTypes.NUMBER, _18), Types.commonAnnotationTypes),
        }),
    };
...
exports.Types = Types;
var isFormulaField = function (element) {
    if (!adapter_api_1.isField(element)) {
        return false;
    }
    var formulaTypes = Object.values(Types.formulaDataTypes);
    return formulaTypes.some(function (type) { return element.refType.elemID.isEqual(type.elemID); });
};
...
var toRecord = function (instance, fieldAnnotationToFilterBy, withNulls) { return __awaiter(void 0, void 0, void 0, function () {
    var instanceType, values, filteredRecordValues;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                values = __assign(__assign({}, withNulls ? lodash_1["default"].mapValues(instanceType.fields, function () { return null; }) : {}), lodash_1["default"].mapValues(instance.value, function (val) {
                    // Lookups to the same types will have an Id value only after the referenced Record was deployed
                    if (adapter_api_1.isInstanceElement(val)) {
                        var referencedRecordId = val.value[constants_1.CUSTOM_OBJECT_ID_FIELD];
                    ...
                    if (adapter_api_1.isElement(val)) {
                ...
                filteredRecordValues = __assign((_a = {}, _a[constants_1.CUSTOM_OBJECT_ID_FIELD] = instance.value[constants_1.CUSTOM_OBJECT_ID_FIELD], _a), lodash_1["default"].pickBy(values, function (v, k) { var _a; return v !== undefined && ((_a = (instanceType).fields[k]) === null || _a === void 0 ? void 0 : _a.annotations[fieldAnnotationToFilterBy]); }));
                return [2 /*return*/, transformCompoundValues(filteredRecordValues, instance)];
        }
    });
}); };
var instancesToUpdateRecords = function (instances, withNulls) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, Promise.all(instances.map(function (instance) { return toRecord(instance, constants_1.FIELD_ANNOTATIONS.UPDATEABLE, withNulls); }))];
    });
}); };
exports.instancesToUpdateRecords = instancesToUpdateRecords;
var instancesToCreateRecords = function (instances) {
    return Promise.all(instances.map(function (instance) { return toRecord(instance, constants_1.FIELD_ANNOTATIONS.CREATABLE, false); }));
};
...
var transformPrimitive = function (_a) {
    ...
    if (lodash_1["default"].isObject(value) && Object.keys(value).includes('_')) {
        var convertFunc = getXsdConvertFunc(lodash_1["default"].get(value, ['$', 'xsi:type']));
        return exports.transformPrimitive({ value: convertFunc(lodash_1["default"].get(value, '_')), path: path, field: field });
    }
    var fieldType = field === null || field === void 0 ? void 0 : field.getTypeSync();
...
var isSubfieldOfCompound = function (field) { return (field.compoundFieldName !== undefined && field.compoundFieldName !== field.name); };
exports.isSubfieldOfCompound = isSubfieldOfCompound;
...
var getSObjectFieldElement = function (parent, field, parentServiceIds, objCompoundFieldNames, systemFields) {
    ...
    else if (field.type === 'string' && !exports.isSubfieldOfCompound(field)) { // string
        naclFieldType = getFieldType(constants_1.FIELD_TYPE_NAMES.TEXT);
    }
    else if (field.type === 'double' && !exports.isSubfieldOfCompound(field)) {
...
var toDeployableInstance = function (element) { return __awaiter(void 0, void 0, void 0, function () {
    var removeNonDeployableValues;
    return __generator(this, function (_a) {
        removeNonDeployableValues = function (_a) {
            var value = _a.value, field = _a.field;
            if (exports.isLocalOnly(field)) {
                return undefined;
            }
            ...
            if (adapter_api_1.isElement(value)) {
                log.warn('The value of the field %s is Element with Id %s in toDeployableInstance', field === null || field === void 0 ? void 0 : field.elemID.getFullName(), value.elemID.getFullName());
                return undefined;
            }
            return value;
        };
...
exports.metadataAnnotationTypes = (_19 = {},
    _19[constants_1.METADATA_TYPE] = adapter_api_1.createRefToElmWithValue(adapter_api_1.BuiltinTypes.SERVICE_ID),
    _19.hasMetaFile = adapter_api_1.createRefToElmWithValue(adapter_api_1.BuiltinTypes.BOOLEAN),
    _19.folderType = adapter_api_1.createRefToElmWithValue(adapter_api_1.BuiltinTypes.STRING),
    _19.folderContentType = adapter_api_1.createRefToElmWithValue(adapter_api_1.BuiltinTypes.STRING),
    _19.suffix = adapter_api_1.createRefToElmWithValue(adapter_api_1.BuiltinTypes.STRING),
    _19.dirName = adapter_api_1.createRefToElmWithValue(adapter_api_1.BuiltinTypes.STRING),
    _19);
