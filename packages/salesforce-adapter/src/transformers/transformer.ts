...
import {
  API_NAME, CUSTOM_OBJECT, LABEL, SALESFORCE, FORMULA, FIELD_TYPE_NAMES, CPQ_LOOKUP_REQUIRED_FIELD,
  ...
  VALUE_SET_DEFINITION_FIELDS, CUSTOM_FIELD, CPQ_LOOKUP_DATA,
  LAYOUT_ITEM_METADATA_TYPE, WORKFLOW_FIELD_UPDATE_METADATA_TYPE, CPQ_LOOKUP_PRODUCT_FIELD,
  WORKFLOW_RULE_METADATA_TYPE, WORKFLOW_ACTION_REFERENCE_METADATA_TYPE, CPQ_LOOKUP_FIELD,
...
const lookUpRelative = (field?: Field): boolean => {
  const lookUpRelativeTypes = new Map<string, string[]>(
    [
      // TODO: check we didn't ruin the first three
      ...
      [CPQ_LOOKUP_DATA, [CPQ_LOOKUP_FIELD]],
      [CPQ_PRODUCT_RULE, [
