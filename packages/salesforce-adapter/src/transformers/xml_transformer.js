...
var fixPath = function (path) { return (
...
var extractFileNameToData = function (_a) {
    var zip = _a.zip, fileName = _a.fileName, withMetadataSuffix = _a.withMetadataSuffix, complexType = _a.complexType, namespacePrefix = _a.namespacePrefix, fixRetrieveFilePaths = _a.fixRetrieveFilePaths;
    return __awaiter(void 0, void 0, void 0, function () {
        var path, fixedFilePath, zipFile, _b, instanceFolderName, zipFiles, _c, _d, _e;
        var _f;
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    if (!!complexType) return [3 /*break*/, 2];
                    path = exports.PACKAGE + "/" + fileName + (withMetadataSuffix ? METADATA_XML_SUFFIX : '');
                    fixedFilePath = fixRetrieveFilePaths ? fixPath(path) : path;
                    zipFile = zip.file(fixedFilePath);
                    if (zipFile === null) {
                ...
                case 1: return [2 /*return*/, (_f[_b] = _g.sent(), _f)];
                case 2:
                    ...
                    if (!lodash_1["default"].isEmpty(zipFiles)) return [3 /*break*/, 3];
                    _c = {};
                    return [3 /*break*/, 5];
                case 3:
...
var fromRetrieveResult = function (result, fileProps, typesWithMetaFile, typesWithContent, fixRetrieveFilePaths) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                fromZip = function (zip, file) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_f) {
                        switch (_f.label) {
                            case 0: return [4 /*yield*/, extractFileNameToData({
                                    zip: zip,
                                    fileName: file.fileName,
                                    withMetadataSuffix: typesWithMetaFile.has(file.type) || exports.isComplexType(file.type),
                                    complexType: exports.isComplexType(file.type),
                                    namespacePrefix: file.namespacePrefix,
                                    fixRetrieveFilePaths: fixRetrieveFilePaths,
                                })];
                            case 1:
                                ...
                                return [4 /*yield*/, extractFileNameToData({
                                        zip: zip,
                                        fileName: file.fileName,
            ...
            case 1:
                zip = _a.sent();
                log.debug("retrieved zip contains the following files: " + adapter_utils_1.safeJsonStringify(Object.keys(zip.files)));
...
var createDeployPackage = function (deleteBeforeUpdate) {
    ...
    return {
        ...
        getZip: function () {
            ...
            var date = new Date('2023-06-15T00:00:00.000+01:00');
            Object.values(zip.files).forEach(function (info) {
                info.date = date;
            });
