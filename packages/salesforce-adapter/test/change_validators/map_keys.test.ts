...
const generatePermissionSetInstance = (permissionSetObj: ObjectType): InstanceElement =>
...
const breakPermissionSetInstanceMaps = (permissionSetInstance: InstanceElement): void => {
...
describe('profile permission set map keys change validator', () => {
  ...
  describe('Profile', () => {
    ...
    it('should have error for invalid keys on update', async () => {
      ...
      expect(changeErrors[0].elemID).toEqual(
        afterProfileInstance.elemID.createNestedID('applicationVisibilities', 'otherApp'),
      )
      ...
      expect(changeErrors[1].elemID).toEqual(
        afterProfileInstance.elemID.createNestedID('fieldPermissions', 'Account', 'wrongName'),
      )
      ...
      expect(changeErrors[2].elemID).toEqual(
        afterProfileInstance.elemID.createNestedID('fieldPermissions', 'Something'),
      )
      ...
      expect(changeErrors[3].elemID).toEqual(
        afterProfileInstance.elemID.createNestedID('layoutAssignments', 'Account_Account_Layout@bs'),
      )
    ...
    it('should have error for invalid keys on add', async () => {
      ...
      expect(changeErrors.map(c => c.severity)).toEqual(['Error', 'Error', 'Error', 'Error'])
      expect(changeErrors[0].elemID).toEqual(
        profileInstance.elemID.createNestedID('applicationVisibilities', 'otherApp'),
      )
      expect(changeErrors[0].detailedMessage).toEqual(
        'Profile Admin field applicationVisibilities: Incorrect map key otherApp, should be other_app@s',
      )
      expect(changeErrors[1].elemID).toEqual(
        profileInstance.elemID.createNestedID('fieldPermissions', 'Account', 'wrongName'),
      )
      expect(changeErrors[1].detailedMessage).toEqual(
        'Profile Admin field fieldPermissions: Incorrect map key Account.wrongName, should be Account.AccountNumber',
      )
      ...
      expect(changeErrors[3].elemID).toEqual(
        profileInstance.elemID.createNestedID('layoutAssignments', 'Account_Account_Layout@bs'),
      )
      expect(changeErrors[3].detailedMessage).toEqual(
        'Profile Admin field layoutAssignments: Incorrect map key Account_Account_Layout@bs, should be new_account_layout_name@s',
      )
    ...
    it('should have error on invalid nacl structure', async () => {
      const afterProfileObj = generateProfileType(true)
      const afterProfileInstance = new InstanceElement('Admin', afterProfileObj, {
        [INSTANCE_FULL_NAME_FIELD]: 'Admin',
        applicationVisibilities: {
          app1: { application: 'app1', default: true, visible: false },
          app2: { application: 'app2', default: true, visible: false },
      ...
      expect(changeErrors[0].elemID).toEqual(
        afterProfileInstance.elemID.createNestedID('fieldPermissions', 'Account', 'Contact'),
      )
      expect(changeErrors[0].detailedMessage).toEqual(
  ...
  describe('Permission set', () => {
    ...
    it('should have no errors if keys are valid', async () => {
      ...
      const afterPermissionSetInstance = generatePermissionSetInstance(afterPermissionSetObj)
      const changeErrors = await runChangeValidator(permissionSetInstance, afterPermissionSetInstance)
      expect(changeErrors).toHaveLength(0)
    })
    ...
    it('should have error for invalid keys on update', async () => {
      ...
      expect(changeErrors[0].elemID).toEqual(
        afterPermissionSetInstance.elemID.createNestedID('applicationVisibilities', 'otherApp'),
      )
      expect(changeErrors[0].detailedMessage).toEqual(
        'PermissionSet Buyer field applicationVisibilities: Incorrect map key otherApp, should be other_app@s',
      )
      expect(changeErrors[1].elemID).toEqual(
        afterPermissionSetInstance.elemID.createNestedID('fieldPermissions', 'Account', 'wrongName'),
      )
      expect(changeErrors[1].detailedMessage).toEqual(
        'PermissionSet Buyer field fieldPermissions: Incorrect map key Account.wrongName, should be Account.AccountNumber',
      )
      expect(changeErrors[2].elemID).toEqual(
        afterPermissionSetInstance.elemID.createNestedID('fieldPermissions', 'Something'),
      )
      expect(changeErrors[2].detailedMessage).toEqual(
    ...
    it('should have error for invalid keys on add', async () => {
      ...
      const changeErrors = await runChangeValidator(undefined, permissionSetInstance)
      expect(changeErrors).toHaveLength(3)
      expect(changeErrors.map(c => c.severity)).toEqual(['Error', 'Error', 'Error'])
      expect(changeErrors[0].elemID).toEqual(
        permissionSetInstance.elemID.createNestedID('applicationVisibilities', 'otherApp'),
      )
      expect(changeErrors[0].detailedMessage).toEqual(
        'PermissionSet Buyer field applicationVisibilities: Incorrect map key otherApp, should be other_app@s',
      )
      expect(changeErrors[1].elemID).toEqual(
        permissionSetInstance.elemID.createNestedID('fieldPermissions', 'Account', 'wrongName'),
      )
      expect(changeErrors[1].detailedMessage).toEqual(
        'PermissionSet Buyer field fieldPermissions: Incorrect map key Account.wrongName, should be Account.AccountNumber',
      )
      expect(changeErrors[2].elemID).toEqual(
        permissionSetInstance.elemID.createNestedID('fieldPermissions', 'Something'),
      )
      expect(changeErrors[2].detailedMessage).toEqual(
        'PermissionSet Buyer field fieldPermissions: Incorrect map key Something.wrong, should be Correct.Path',
      )
    ...
    it('should have error on invalid nacl structure', async () => {
      const afterPermissionSetObj = generatePermissionSetType(true)
      const afterPermissionSetInstance = new InstanceElement('Buyer', afterPermissionSetObj, {
        [INSTANCE_FULL_NAME_FIELD]: 'Buyer',
        applicationVisibilities: {
          app1: { application: 'app1', default: true, visible: false },
          app2: { application: 'app2', default: true, visible: false },
      ...
      expect(changeErrors[0].severity).toEqual('Error')
      expect(changeErrors[0].elemID).toEqual(
        afterPermissionSetInstance.elemID.createNestedID('fieldPermissions', 'Account', 'Contact'),
      )
      expect(changeErrors[0].detailedMessage).toEqual(
    ...
    it('should not validate map keys on delete', async () => {
      ...
      const changeErrors = await runChangeValidator(permissionSetInstance, undefined)
      expect(changeErrors).toHaveLength(0)
    })
  })
})
