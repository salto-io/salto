    ...
    describe('When valid add group', () => {
      ...
      describe('When loadBulk partially succeeds', () => {
        ...
        it('Should have three applied add change with the right ids', () => {
          ...
          expect((changeData as InstanceElement).value[constants.SALESFORCE_OBJECT_ID_FIELD]).toBe('newId1')
          ...
          expect((anotherChangeData as InstanceElement).value[constants.SALESFORCE_OBJECT_ID_FIELD]).toBe('newId3')
          ...
          expect((anotherNewChangeData as InstanceElement).value[constants.SALESFORCE_OBJECT_ID_FIELD]).toBe('anotherQueryId')
        })
      })
    })
