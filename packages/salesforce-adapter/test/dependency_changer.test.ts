...
describe('Dependency Changer', () => {
  ...
  describe('if there is no matching type', () => {
    beforeEach(async () => {
      instanceChange = toChange({ after: new InstanceElement('testInstance', objectType) })
  ...
  describe('if the change is not of a custom object', () => {
    beforeEach(async () => {
      ...
      instanceChange = toChange({ after: new InstanceElement('testInstance', standardType) })
  ...
  describe('if the change is instance removal', () => {
    beforeEach(async () => {
      instanceChange = toChange({ before: new InstanceElement('testInstance', objectType) })
