...
describe('flow coordinates filter', () => {
  ...
  describe('onFetch', () => {
    ...
    describe('when the type has the right fields but is not a flow', () => {
      ...
      it('should not modify anything', () => {
        expect((elements[0] as InstanceElement).value).toHaveProperty(
          'assignments',
    ...
    describe('when a flow is in auto-layout mode', () => {
      ...
      it('should remove the coordinate fields', () => {
        expect(
          (elements[0] as InstanceElement).value.assignments[0],
        ).not.toHaveProperty('locationX')
        expect(
          (elements[0] as InstanceElement).value.assignments[0],
        ).not.toHaveProperty('locationX')
      })
  ...
  describe('preDeploy', () => {
    ...
    describe('when the type has the right fields but is not a flow', () => {
      ...
      it('should not modify anything', () => {
        expect(
          (getChangeData(changes[0]) as InstanceElement).value,
        ).toHaveProperty('assignments', instance.value.assignments)
      })
    })
    describe('when a field of flow has the right fields but is not of a known type', () => {
      const instance = new InstanceElement('SomeInstance', flowType, {
      ...
      it('should not modify anything', () => {
        expect(
          (getChangeData(changes[0]) as InstanceElement).value,
        ).toHaveProperty('irrelevantField', instance.value.irrelevantField)
      })
    })
  ...
  describe('onDeploy', () => {
    ...
    describe('when a flow is in auto-layout mode', () => {
      ...
      it('should remove the coordinate fields', () => {
        ...
        expect(instanceAfterTest.value.assignments[0]).not.toHaveProperty(
          'locationX',
        )
        expect(instanceAfterTest.value.assignments[0]).not.toHaveProperty(
          'locationX',
