...
exports.mockFetchOpts = exports.defaultFilterContext = exports.createCustomSettingsObject = exports.generatePermissionSetType = exports.generateProfileType = exports.findFullCustomObject = exports.findAnnotationsObject = exports.findStandardFieldsObject = exports.findCustomFieldsObject = exports.createEncodedZipContent = exports.createValueSetEntry = exports.createCustomMetadataType = exports.createCustomObjectType = exports.createMetadataTypeElement = exports.createField = exports.findElements = void 0;
/*
...
var createCustomObjectType = function (typeName, params) {
    var _a, _b, _c;
    var _d;
    return new adapter_api_1.ObjectType(__assign(__assign({}, params), { fields: __assign({ Id: { refType: adapter_api_1.BuiltinTypes.SERVICE_ID, annotations: (_a = {}, _a[constants_1.FIELD_ANNOTATIONS.QUERYABLE] = true, _a[constants.API_NAME] = 'Id', _a) }, Name: {
                ...
                annotations: (_b = {},
                    ...
                    _b),
            } }, params.fields), annotations: __assign((_c = {}, _c[constants.METADATA_TYPE] = constants.CUSTOM_OBJECT, _c[constants.API_NAME] = typeName, _c), ((_d = params.annotations) !== null && _d !== void 0 ? _d : {})), elemID: new adapter_api_1.ElemID(constants.SALESFORCE, typeName) }));
};
exports.createCustomObjectType = createCustomObjectType;
var createCustomMetadataType = function (typeName, params) {
    var _a;
    var _b;
    return new adapter_api_1.ObjectType(__assign(__assign({}, params), { annotations: __assign((_a = {}, _a[constants.METADATA_TYPE] = constants.CUSTOM_METADATA, _a[constants.API_NAME] = typeName, _a), ((_b = params.annotations) !== null && _b !== void 0 ? _b : {})), elemID: new adapter_api_1.ElemID(constants.SALESFORCE, typeName) }));
};
exports.createCustomMetadataType = createCustomMetadataType;
