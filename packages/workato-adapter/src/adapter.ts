...
import recipeBlockExtendedInputSchemaFormatFilter from './filters/recipe_block_format/block_extended_input_format'
...
export const DEFAULT_FILTERS = [
  ...
  recipeBlockExtendedInputSchemaFormatFilter,
