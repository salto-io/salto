...
import filterCreator from '../../../src/filters/recipe_block_format/block_extended_output_format'
    ...
    recipeCodeServerSide = new InstanceElement('recipeCode', codeType, {
      ...
      block: [
        ...
        },
        {
          ...
          keyword: 'action',
          input: {
            test1: "#{_('data.zendesk.1797b86b.custom_fields.field_4847599896339')} - #{_('data.zendesk.1797b86b.custom_fields.field_484759989111')} - #{_('data.zendesk.1797b86b.custom_fields.field_4847599896333')}",
            test2: undefined,
          },
          uuid: 'uuid4',
        },
