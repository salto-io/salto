...
describe('blockInputFilter filter', () => {
          ...
          block: [
            {
              ...
              input: {
                ...
                test2: {
                  ...
                  test2_3: {
                    test2_3_1: 'test2_3_1_value',
                    test2_3_2: 'test2_3_2_value',
                  },
                },
                test3: ['test3_value1', 'test3_value2'],
                test4: 4,
  ...
  describe('onFetch', () => {
    ...
    it('should build content from valid input', async () => {
      const validContent = [
        {
          key: 'test1',
          value: 'test1_value',
      ...
      // valid block
      expect(recipeCodeServerSide.value.block[0].block[0].content).toEqual(validContent)
      expect(recipeCodeServerSide.value.block[0].block[0].input).toBeUndefined()

      // with invalid input keys block
      expect(recipeCodeServerSide.value.block[1].content).toEqual(withInvalidContent)
      expect(recipeCodeServerSide.value.block[1].input).toBeUndefined()
    })
  })
})
