...
export type AwaitedParsedNaclFileData = {
  errors: () => parser.ParseError[] | undefined
...
export type AwaitedParsedNaclFile = {
  filename: string
  elements: () => Element[] | undefined
  data: AwaitedParsedNaclFileData
  buffer?: string
  sourceMap?: () => parser.SourceMap | undefined
}
