...
export const loadWorkspace = async (
  ...
  try {
    ...
    const workspace: Workspace = {
      ...
      envOfFile: filename =>
        getSourceNameForFilename(filename, envs() as string[], environmentsSources.commonSourceName),
    ...
    try {
      ...
      log.error('workspace close threw an error: %o. Ignoring it, and rethrowing the original error', closeError)
    }
    throw e
  }
}
