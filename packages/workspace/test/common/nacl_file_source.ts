...
export const createMockNaclFileSource = (
  ...
  return ({
    list: mockFunction<NaclFilesSource['list']>().mockImplementation(awu(currentElements.map(e => e.elemID)),
    ...
    setAll: mockFunction<NaclFilesSource['setAll']>().mockImplementation(async (_elements: ThenableIterable<Element>) => undefined)),
    ...
    deleteAll: mockFunction<NaclFilesSource['deleteAll']>().mockImplementation(async (_ids: ThenableIterable<ElemID>) => undefined),
    getAll: mockFunction<NaclFilesSource['getAll']>().mockImplementation(awu(currentElements)),
    getElementsSource: mockFunction<NaclFilesSource['getElementsSource']>().mockImplementation(createInMemoryElementSource(currentElements)),
