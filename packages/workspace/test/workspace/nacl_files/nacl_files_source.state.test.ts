...
describe('Nacl Files Source', () => {
  ...
  describe('change inner state', () => {
    ...
    beforeEach(async () => {
      ...
      naclFileSourceTest.getAll()
    })
    it('should includes expected elements', async () => {
      const elements = await awu(naclFileSourceTest.getAll()).toArray()
    ...
    describe('setNaclFiles', () => {
      it('should change existing element in one file', async () => {
        ...
        expect(await awu(naclFileSourceTest.getAll()).toArray()).toHaveLength(2)
      ...
      it('should remove an element from a file', async () => {
        ...
        const allElements = await awu(naclFileSourceTest.getAll()).toArray()
      ...
      it('should remove elements from list result upon element removal', async () => {
        ...
        expect(await awu(naclFileSourceTest.list()).map(e => e.getFullName()).toArray())
      ...
      describe('splitted elements', () => {
        describe('fragmented in all files', () => {
          ...
          it('should change splitted element correctly', async () => {
            ...
            const currentElements = await awu(naclFileSourceWithFragments.getAll()).toArray()
            ...
            expect(await awu(naclFileSourceWithFragments.getAll()).toArray())
    ...
    describe('removeNaclFiles', () => {
      it('should not change anything if the file does not exist', async () => {
        ...
        expect(await awu(naclFileSourceTest.getAll()).toArray()).toMatchObject([
      ...
      it('should remove one file correctly', async () => {
        ...
        const currentElements = await awu(naclFileSourceTest.getAll()).toArray()
      ...
      it('should remove multiple files correctly', async () => {
        ...
        expect(await awu(naclFileSourceTest.getAll()).toArray()).toEqual([])
      })
    })
    describe('updateNaclFiles', () => {
      ...
      it('should update one element correctly', async () => {
        ...
        expect(_.sortBy(
          await awu(naclFileSourceTest.getAll()).toArray(),
      ...
      it('should remove an element correctly', async () => {
        ...
        expect(changes).toHaveLength(1)
        expect(changes[0]).toMatchObject(_.omit(detailedChange, ['id', 'path']))
        expect(await awu(naclFileSourceTest.getAll()).toArray())
          .toMatchObject([objectTypeObjectMatcher])
      })
    })
  })
