    ...
    main: {
      ...
      endpoints: {
        ...
        customizations: {
          ...
          'api/v2/user_fields': { get: { pagination: 'new_cursor' } },
          'api/v2/organization_fields': { get: { pagination: 'new_cursor' } },
          'api/v2/apps/installations': { get: { pagination: 'new_cursor' } },
          'api/v2/apps/owned': { get: { pagination: 'new_cursor' } },
          'api/v2/oauth/clients': { get: { pagination: 'new_cursor' } },
          '/api/v2/oauth/global_clients': { get: { pagination: 'new_cursor' } },
        },
      },
    },
  },
