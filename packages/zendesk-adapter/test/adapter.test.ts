    ...
    describe('full fetch', () => {
      it('should generate the right elements on fetch', async () => {
        ...
        expect(elements.map(e => e.elemID.getFullName()).sort()).toEqual([
          ...
          'zendesk.order_in_brand',
          'zendesk.order_in_brand.instance.brandWithGuide_categories',
          'zendesk.order_in_brand.instance.myBrand_categories',
          'zendesk.order_in_category',
          'zendesk.order_in_category.instance.1500000550682_Development_sections',
          'zendesk.order_in_category.instance.1500000550682_General_sections',
          'zendesk.order_in_category.instance.1500000550684_greatCategory_sections',
          'zendesk.order_in_section',
          'zendesk.order_in_section.instance.2222705734931_greatSection_articles',
          'zendesk.order_in_section.instance.2222705734931_greatSection_sections',
          'zendesk.order_in_section.instance.5626221096595_Announcements_articles',
          'zendesk.order_in_section.instance.5626221096595_Announcements_sections',
          'zendesk.order_in_section.instance.5626221096595_Billing_and_Subscriptions@uss_articles',
          'zendesk.order_in_section.instance.5626221096595_Billing_and_Subscriptions@uss_sections',
          'zendesk.order_in_section.instance.5626221096595_FAQ_articles',
          'zendesk.order_in_section.instance.5626221096595_FAQ_sections',
          'zendesk.order_in_section.instance.5626221096595_Internal_KB@us_articles',
          'zendesk.order_in_section.instance.5626221096595_Internal_KB@us_sections',
          'zendesk.order_in_section.instance.7243705734931_Apex_articles',
          'zendesk.order_in_section.instance.7243705734931_Apex_sections',
          ...
          'zendesk.section_translation.instance.myBrand_General_Billing_and_Subscriptions_uuss__en_us_b@uuuumuuum',
          'zendesk.section_translation.instance.myBrand_General_FAQ__en_us_b@uuuuum',
          'zendesk.section_translation.instance.myBrand_General_Internal_KB_uus__en_us_b@uuumuuum',
