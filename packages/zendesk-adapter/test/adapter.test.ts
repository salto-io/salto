    ...
    describe('full fetch', () => {
      it('should generate the right elements on fetch', async () => {
        ...
        expect(elements.map(e => e.elemID.getFullName()).sort()).toEqual([
          ...
          'zendesk.guide_language_settings.instance.brandWithGuide_Eden_test@ub',
          'zendesk.guide_language_settings.instance.brandWithGuide_c',
          'zendesk.guide_language_settings.instance.brandWithGuide_test',
          'zendesk.guide_language_settings.instance.myBrand_Eden_test@ub',
          'zendesk.guide_language_settings.instance.myBrand_c',
          'zendesk.guide_language_settings.instance.myBrand_test',
