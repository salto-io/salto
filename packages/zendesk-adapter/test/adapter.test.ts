    ...
    describe('full fetch', () => {
      it('should generate the right elements on fetch', async () => {
        ...
        expect(elements.map(e => e.elemID.getFullName()).sort()).toEqual([
          ...
          'zendesk.business_hours_schedule_holiday.instance.New_schedule_s__Holiday1_2021@umuuu',
          'zendesk.business_hours_schedule_holiday.instance.Schedule_3_s__Holi2_2021@umuuu',
