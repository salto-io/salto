    ...
    describe('full fetch', () => {
      it('should generate the right elements on fetch', async () => {
        ...
        expect(elements.map(e => e.elemID.getFullName()).sort()).toEqual([
          ...
          'zendesk.order_in_brand.instance.brandWithGuide',
          'zendesk.order_in_brand.instance.myBrand',
          'zendesk.order_in_category',
          'zendesk.order_in_category.instance.1500000550682_Development',
          'zendesk.order_in_category.instance.1500000550682_General',
          'zendesk.order_in_category.instance.1500000550684_greatCategory',
          'zendesk.order_in_section',
          'zendesk.order_in_section.instance.2222705734931_greatSection',
          'zendesk.order_in_section.instance.5626221096595_Announcements',
          'zendesk.order_in_section.instance.5626221096595_Billing_and_Subscriptions@uss',
          'zendesk.order_in_section.instance.5626221096595_FAQ',
          'zendesk.order_in_section.instance.5626221096595_Internal_KB@us',
          'zendesk.order_in_section.instance.7243705734931_Apex',
