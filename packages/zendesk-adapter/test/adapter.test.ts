    ...
    describe('full fetch', () => {
      it('should generate the right elements on fetch', async () => {
        ...
        expect(elements.map(e => e.elemID.getFullName()).sort()).toEqual([
          ...
          'zendesk.articles',
          'zendesk.articles_order',
          'zendesk.articles_order',
          'zendesk.articles_order.instance.brandWithGuide_greatCategory_greatSection__',
          'zendesk.articles_order.instance.myBrand_Development_Apex__',
          'zendesk.articles_order.instance.myBrand_General_Announcements__',
          'zendesk.articles_order.instance.myBrand_General_Billing_and_Subscriptions_uuss__@uuuumuu',
          'zendesk.articles_order.instance.myBrand_General_FAQ__',
          'zendesk.articles_order.instance.myBrand_General_Internal_KB_uus__@uuumuu',
          'zendesk.automation',
          ...
          'zendesk.categories',
          'zendesk.categories_order',
          'zendesk.categories_order',
          'zendesk.categories_order.instance.brandWithGuide__',
          'zendesk.categories_order.instance.myBrand__',
          'zendesk.category',
          ...
          'zendesk.guide_locale.instance.he',
          ...
          'zendesk.sections',
          'zendesk.sections_order',
          'zendesk.sections_order',
          'zendesk.sections_order.instance.brandWithGuide_greatCategory__',
          'zendesk.sections_order.instance.brandWithGuide_greatCategory_greatSection__',
          'zendesk.sections_order.instance.myBrand_Development_Apex__',
          'zendesk.sections_order.instance.myBrand_Development__',
          'zendesk.sections_order.instance.myBrand_General_Announcements__',
          'zendesk.sections_order.instance.myBrand_General_Billing_and_Subscriptions_uuss__@uuuumuu',
          'zendesk.sections_order.instance.myBrand_General_FAQ__',
          'zendesk.sections_order.instance.myBrand_General_Internal_KB_uus__@uuumuu',
          'zendesk.sections_order.instance.myBrand_General__',
