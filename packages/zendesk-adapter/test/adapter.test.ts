    ...
    describe('full fetch', () => {
      it('should generate the right elements on fetch', async () => {
        ...
        expect(elements.map(e => e.elemID.getFullName()).sort()).toEqual([
          ...
          'zendesk.brand_language_settings',
          'zendesk.brand_language_settings.instance.brandWithGuide_ar',
          'zendesk.brand_language_settings.instance.brandWithGuide_en_us@ub',
          'zendesk.brand_language_settings.instance.brandWithGuide_he',
          'zendesk.brand_language_settings.instance.myBrand_ar',
          'zendesk.brand_language_settings.instance.myBrand_en_us@ub',
          'zendesk.brand_language_settings.instance.myBrand_he',
          'zendesk.brand_logo',
          'zendesk.brands',
