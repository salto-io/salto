    ...
    describe('full fetch', () => {
      it('should generate the right elements on fetch', async () => {
        ...
        expect(elements.map(e => e.elemID.getFullName()).sort()).toEqual([
          ...
          'zendesk.automations',
          'zendesk.badge',
          'zendesk.badge.instance.Conversation_starter@s',
          'zendesk.badge_categories',
          'zendesk.badge_category',
          'zendesk.badge_category.instance.Achievements',
          'zendesk.badge_category.instance.Titles',
          'zendesk.badges',
          'zendesk.brand',
          ...
          'zendesk.targets',
          'zendesk.theme',
          'zendesk.theme.instance.Copenhagen',
          'zendesk.themes',
          ...
          'zendesk.topic',
          'zendesk.topic.instance.Feature_Requests@s',
          'zendesk.topic.instance.General_Discussion@s',
          'zendesk.topics',
          'zendesk.trigger',
