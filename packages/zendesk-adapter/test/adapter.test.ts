    ...
    describe('full fetch', () => {
      it('should generate the right elements on fetch', async () => {
        ...
        expect(elements.map(e => e.elemID.getFullName()).sort()).toEqual([
          ...
          'zendesk.articles_order.instance.2222705734931_greatSection',
          'zendesk.articles_order.instance.5626221096595_Announcements',
          'zendesk.articles_order.instance.5626221096595_Billing_and_Subscriptions@uss',
          'zendesk.articles_order.instance.5626221096595_FAQ',
          'zendesk.articles_order.instance.5626221096595_Internal_KB@us',
          'zendesk.articles_order.instance.7243705734931_Apex',
          'zendesk.automation',
          ...
          'zendesk.categories_order.instance.brandWithGuide',
          'zendesk.categories_order.instance.myBrand',
          'zendesk.category',
          ...
          'zendesk.sections_order.instance.1500000550682_Development',
          'zendesk.sections_order.instance.1500000550682_General',
          'zendesk.sections_order.instance.1500000550684_greatCategory',
          'zendesk.sections_order.instance.2222705734931_greatSection',
          'zendesk.sections_order.instance.5626221096595_Announcements',
          'zendesk.sections_order.instance.5626221096595_Billing_and_Subscriptions@uss',
          'zendesk.sections_order.instance.5626221096595_FAQ',
          'zendesk.sections_order.instance.5626221096595_Internal_KB@us',
          'zendesk.sections_order.instance.7243705734931_Apex',
