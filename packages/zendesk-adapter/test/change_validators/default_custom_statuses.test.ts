...
describe('defaultCustomStatusesValidator', () => {
  ...
  const createStatus = (category: string, isActive: boolean, id: number): InstanceElement =>
    new InstanceElement(`${category} ${isActive ? 'active' : ''}`, customStatusType, {
      id,
  ...
  it('should not return an error when default is valid', async () => {
    const validDefaultCustomStatusesInstance = new InstanceElement(ElemID.CONFIG_NAME, defaultCustomStatusesType, {
  ...
  it('should return an error when default is not valid because of an inactive status', async () => {
    const invalidDefaultCustomStatusesInstance = new InstanceElement(ElemID.CONFIG_NAME, defaultCustomStatusesType, {
  ...
  it('should return an error when default is not valid because of mixed categories and there is an inactive status', async () => {
    const invalidDefaultCustomStatusesInstance = new InstanceElement(ElemID.CONFIG_NAME, defaultCustomStatusesType, {
      [PENDING_CATEGORY]: new ReferenceExpression(openActive.elemID, openActive),
      [SOLVED_CATEGORY]: new ReferenceExpression(solvedActive.elemID, solvedActive),
