...
describe('macro action ticket field test', () => {
  ...
  const deactivatedTicketFieldInstance1 = new InstanceElement(
    'ticket1',
    ticketFieldType,
    {
      active: false,
  ...
  const deactivatedTicketFieldInstance2 = new InstanceElement(
    'ticket2',
    ticketFieldType,
    {
      active: false,
  ...
  const activatedTicketFieldInstance3 = new InstanceElement(
    'ticket3',
    ticketFieldType,
    {
      active: true,
  ...
  const activatedTicketFieldInstance4 = new InstanceElement(
    'ticket4',
    ticketFieldType,
    {
      active: true,
