...
describe('targetAuthDataValidator', () => {
  ...
  const targetInstanceWithAuth = new InstanceElement(
    'test1',
    targetType,
    { title: 'test', username: 'test_username', password: 'test_password' },
  )
  const targetInstanceWithoutAuth = new InstanceElement(
    'test2',
    targetType,
    { title: 'test' },
  )
