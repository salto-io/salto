...
describe('guideOrderDependencyChanger', () => {
  ...
  const customObject = new InstanceElement('customObject', new ObjectType({ elemID: new ElemID(ZENDESK, CUSTOM_OBJECT_TYPE_NAME) }))
