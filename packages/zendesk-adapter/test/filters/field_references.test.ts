...
describe('References by id filter', () => {
  ...
  const generateElements = (): Element[] => [
    ...
    new InstanceElement('option1', ticketFieldOptionType, { id: 9001, name: 'option1', value: 'v11' }),
    new InstanceElement('option2', userFieldOptionType, { id: 9002, name: 'option2', value: 'v12' }),
    new InstanceElement('option3', orgFieldOptionType, { id: 9003, name: 'option3', value: 'v13' }),
    new InstanceElement('option4', orgFieldOptionType, { id: 9004, name: 'option4', value: 'v14' }),
    new InstanceElement('customField1', ticketFieldType, {
      id: 6001,
      type: 'tagger',
    ...
    new InstanceElement('routingAttributeValue', routingAttributeValueType, {
      id: 777,
      conditions: {
        all: [
          {
    ...
    new InstanceElement('trigger2', triggerType, {
      id: 7002,
      conditions: {
        all: [
    ...
    new InstanceElement('userLookup1', userLookupTicketFieldType, {
      id: 2501,
      type: 'lookup',
      relationship_filter: {
        all: [{ field: 'user.custom_fields.key_uf1', operator: 'is', value: 9002 }],
      },
    }),
    new InstanceElement('workspace1', workspaceType, {
      id: 7001,
      conditions: {
        all: [{ field: 'group_id', operator: 'is', value: '2003' }],
      },
    }),
  ]
  ...
  describe('on fetch', () => {
    ...
    it('should resolve field values when referenced element exists', () => {
      ...
      expect(trigger10.value.category_id.elemID.getFullName()).toEqual(
        'zendesk.trigger_category.instance.triggerCategory5',
      )
      ...
      expect(workspace1.value.conditions.all[0].value.elemID.getFullName()).toEqual('zendesk.group.instance.group3')
      ...
      expect(inst.value.nestedValues[1].values[0].list[0].value.elemID.getFullName()).toEqual(
        'zendesk.group.instance.group3',
      )
      expect(inst.value.subjectAndValues[0].valueList[0].value).toBeInstanceOf(ReferenceExpression)
      expect(inst.value.subjectAndValues[0].valueList[0].value.elemID.getFullName()).toEqual(
        'zendesk.ticket_form.instance.ticketForm7',
      )
    })
    it('should not resolve if referenced element does not exist', () => {
      const trigger9 = elements.filter(e => isInstanceElement(e) && e.elemID.name === 'trigger9')[0] as InstanceElement
      expect(trigger9.value.category_id).not.toBeInstanceOf(ReferenceExpression)
      expect(trigger9.value.category_id).toEqual(2323)

      const inst = elements.filter(e => isInstanceElement(e) && e.elemID.name === 'inst1')[0] as InstanceElement
      expect(inst.value.nestedValues[0].values[0].list[1].value).not.toBeInstanceOf(ReferenceExpression)
      expect(inst.value.nestedValues[0].values[0].list[1].value).toEqual(123)
      expect(inst.value.subjectAndValues[1].valueList[0].value).not.toBeInstanceOf(ReferenceExpression)
      expect(inst.value.subjectAndValues[1].valueList[0].value).toEqual(4007)
    })
    it('should resolve custom field references', () => {
      const trigger = elements.filter(e => isInstanceElement(e) && e.elemID.name === 'trigger1')[0] as InstanceElement
      expect(trigger.value.conditions.all[0].field).toBeInstanceOf(ReferenceExpression)
      expect(trigger.value.conditions.all[0].field.elemID.getFullName()).toEqual(
        'zendesk.ticket_field.instance.customField1',
      )
      expect(trigger.value.conditions.all[0].value).toBeInstanceOf(ReferenceExpression)
      expect(trigger.value.conditions.all[0].value.elemID.getFullName()).toEqual(
        'zendesk.ticket_field__custom_field_options.instance.option1',
      )
      expect(trigger.value.conditions.all[1].field).toBeInstanceOf(ReferenceExpression)
      expect(trigger.value.conditions.all[1].field.elemID.getFullName()).toEqual(
        'zendesk.user_field.instance.userField1',
      )
      expect(trigger.value.conditions.all[1].value).toBeInstanceOf(ReferenceExpression)
      expect(trigger.value.conditions.all[1].value.elemID.getFullName()).toEqual(
        'zendesk.user_field__custom_field_options.instance.option2',
      )
      expect(trigger.value.conditions.all[2].field).toBeInstanceOf(ReferenceExpression)
      expect(trigger.value.conditions.all[2].field.elemID.getFullName()).toEqual(
        'zendesk.organization_field.instance.orgField1',
      )
      expect(trigger.value.conditions.all[2].value).toBeInstanceOf(ReferenceExpression)
      expect(trigger.value.conditions.all[2].value.elemID.getFullName()).toEqual(
        'zendesk.organization_field__custom_field_options.instance.option3',
      )
      expect(trigger.value.conditions.all[3].field).toBeInstanceOf(ReferenceExpression)
      expect(trigger.value.conditions.all[3].field.elemID.getFullName()).toEqual(
        'zendesk.organization_field.instance.orgField2',
      )
      ...
      expect(trigger.value.conditions.all[4].field.elemID.getFullName()).toEqual(
        'zendesk.ticket_field.instance.customField2',
      )
      ...
      expect(trigger.value.conditions.all[5].field.elemID.getFullName()).toEqual(
        'zendesk.custom_status.instance.customStatus',
      )
      ...
      expect(userLookup.value.relationship_filter.all[0].field.elemID.getFullName()).toEqual(
        'zendesk.user_field.instance.userField1',
      )
      expect(userLookup.value.relationship_filter.all[0].value).toBeInstanceOf(ReferenceExpression)
      expect(userLookup.value.relationship_filter.all[0].value.elemID.getFullName()).toEqual(
        'zendesk.user_field__custom_field_options.instance.option2',
      )
    })
    describe('missing references', () => {
      it('should create missing references', () => {
        ...
        expect(brokenTrigger.value.conditions.all[0].value.elemID.name).toEqual('missing_v15')
        ...
        expect(brokenTrigger.value.conditions.all[2].value.elemID.name).toEqual('missing_you_like_crazy')
        expect(brokenTrigger.value.conditions.all[3].value).toBeInstanceOf(ReferenceExpression)
        expect(brokenTrigger.value.conditions.all[3].value.elemID.name).toEqual('missing_a_thing')
        expect(brokenTrigger.value.conditions.all[4].value).toBeInstanceOf(ReferenceExpression)
        expect(brokenTrigger.value.conditions.all[4].value.elemID.name).toEqual('missing_someone_you_love')
        ...
        expect(brokenTrigger.value.conditions.all[6].field.elemID.name).toEqual('missing_custom_status_2002')
      })
      it('should create valid missing reference for routing_attribute_value', async () => {
        ...
        expect(brokenAttribute.value.conditions.all[1].subject.elemID.name).toEqual(
          'missing_requester_custom_fields_key_uf11@uvuvu',
        )
        ...
        expect(brokenAttribute.value.conditions.all[3].subject.elemID.name).toEqual(
          'missing_organization_custom_fields_key_of11@uvuvu',
        )
