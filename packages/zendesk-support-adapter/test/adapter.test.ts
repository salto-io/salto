    ...
    describe('full fetch', () => {
      it('should generate the right elements on fetch', async () => {
        ...
        expect(elements.map(e => e.elemID.getFullName()).sort()).toEqual([
          ...
          'zendesk_support.oauth_client.instance.salto_test',
          'zendesk_support.oauth_client.instance.salto_test_oauth',
          'zendesk_support.oauth_client.instance.salto_zendesk_client',
          'zendesk_support.oauth_clients',
          'zendesk_support.oauth_global_client',
          'zendesk_support.oauth_global_client.instance.salto',
          'zendesk_support.oauth_global_client.instance.salto_staging@s',
          'zendesk_support.oauth_global_clients',
          'zendesk_support.organization',
          'zendesk_support.organization.instance.Salto',
          ...
          'zendesk_support.support_address.instance.Salto',
          ...
          'zendesk_support.trigger_definitions.instance',
          'zendesk_support.trigger_definitions__actions',
          'zendesk_support.trigger_definitions__actions__metadata',
          'zendesk_support.trigger_definitions__actions__metadata__phone_numbers',
          'zendesk_support.trigger_definitions__actions__values',
          'zendesk_support.trigger_definitions__conditions_all',
          'zendesk_support.trigger_definitions__conditions_all__operators',
          'zendesk_support.trigger_definitions__conditions_all__values',
          'zendesk_support.trigger_definitions__conditions_any',
          'zendesk_support.trigger_definitions__conditions_any__operators',
          'zendesk_support.trigger_definitions__conditions_any__values',
          'zendesk_support.triggers',
          'zendesk_support.triggers_definitions',
        ...
        const supportAddress = elements.filter(isInstanceElement).find(e => e.elemID.getFullName().startsWith('zendesk_support.support_address.instance.Salto'))
        expect(supportAddress).toBeDefined()
        expect(supportAddress?.value).toMatchObject({
          id: 1500000743022,
          default: true,
          name: 'Salto',
          email: 'support@d3v-salto.zendesk.com',
          // eslint-disable-next-line camelcase
          brand_id: expect.any(ReferenceExpression),
        })
        expect(supportAddress?.value.brand_id.elemID.getFullName()).toEqual('zendesk_support.brand.instance.Salto')
      })
    })
