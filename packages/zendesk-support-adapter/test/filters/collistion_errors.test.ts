...
describe('collision errors', () => {
  ...
  const objType = new ObjectType({ elemID: new ElemID(ZENDESK_SUPPORT, 'obj') })
...
\t2. Delete duplicate instances from your zendesk_support account.

Alternatively, you can exclude obj from the service configuration in zendesk_support.nacl`,
      })
    })
