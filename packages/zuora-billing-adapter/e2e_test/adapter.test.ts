    ...
    describe('swagger types only', () => {
      it('should generate the right type elements on fetch', async () => {
        ...
        expect(elements.map(e => e.elemID.getFullName()).sort()).toEqual([
          ...
          'zuora_billing.CustomObjectBulkJobErrorResponse',
          'zuora_billing.CustomObjectBulkJobErrorResponseCollection',
          'zuora_billing.CustomObjectBulkJobResponse',
          'zuora_billing.CustomObjectBulkJobResponseCollection',
          'zuora_billing.CustomObjectBulkJobResponse_error',
