...
export const SUPPORTED_TYPES = {
  [`${SETTINGS_TYPE_PREFIX}AccountingRules`]: ['AccountingRules'],
  [`${SETTINGS_TYPE_PREFIX}AgingBucket`]: ['AgingBucket'],
  [`${SETTINGS_TYPE_PREFIX}AllNotifications`]: ['AllNotifications'],
  [`${SETTINGS_TYPE_PREFIX}AllPaymentTerms`]: ['AllPaymentTerms'],
  [`${SETTINGS_TYPE_PREFIX}AllRevenueRecognition`]: ['AllRevenueRecognition'],
  [`${SETTINGS_TYPE_PREFIX}AllTaxCode`]: ['AllTaxCode'],
  [`${SETTINGS_TYPE_PREFIX}ApplicationRules`]: ['ApplicationRules'],
  [`${SETTINGS_TYPE_PREFIX}BatchAlias`]: ['BatchAlias'],
  [`${SETTINGS_TYPE_PREFIX}BillingCycleType`]: ['BillingCycleType'],
  [`${SETTINGS_TYPE_PREFIX}BillingListPriceBase`]: ['BillingListPriceBase'],
  [`${SETTINGS_TYPE_PREFIX}BillingPeriod`]: ['BillingPeriod'],
  [`${SETTINGS_TYPE_PREFIX}BillingPeriodStart`]: ['BillingPeriodStart'],
  [`${SETTINGS_TYPE_PREFIX}BillingRules`]: ['BillingRules'],
  [`${SETTINGS_TYPE_PREFIX}ChargeModel`]: ['ChargeModel'],
  [`${SETTINGS_TYPE_PREFIX}ChargeType`]: ['ChargeType'],
  [`${SETTINGS_TYPE_PREFIX}CommunicationProfiles`]: ['CommunicationProfiles'],
  [`${SETTINGS_TYPE_PREFIX}Currencies`]: ['Currencies'],
  [`${SETTINGS_TYPE_PREFIX}DiscountSettings`]: ['DiscountSettings'],
  [`${SETTINGS_TYPE_PREFIX}DocPrefix`]: ['DocPrefix'],
  [`${SETTINGS_TYPE_PREFIX}FxCurrency`]: ['FxCurrency'],
  [`${SETTINGS_TYPE_PREFIX}GetTaxCompanies`]: ['GetTaxCompanies'],
  [`${SETTINGS_TYPE_PREFIX}GlSegments`]: ['GlSegments'],
  [`${SETTINGS_TYPE_PREFIX}HostedPaymentPages`]: ['HostedPaymentPages'],
  [`${SETTINGS_TYPE_PREFIX}NumberAndSku`]: ['NumberAndSku'],
  [`${SETTINGS_TYPE_PREFIX}PaymentGateways`]: ['PaymentGateways'],
  [`${SETTINGS_TYPE_PREFIX}PaymentMethods`]: ['PaymentMethods'],
  [`${SETTINGS_TYPE_PREFIX}PaymentRetryRules`]: ['PaymentRetryRules'],
  [`${SETTINGS_TYPE_PREFIX}PaymentRules`]: ['PaymentRules'],
  [`${SETTINGS_TYPE_PREFIX}ReasonCodes`]: ['ReasonCodes'],
  [`${SETTINGS_TYPE_PREFIX}RevenueEventTypes`]: ['RevenueEventTypes'],
  [`${SETTINGS_TYPE_PREFIX}RevenueRecognitionModels`]: ['RevenueRecognitionModels'],
  [`${SETTINGS_TYPE_PREFIX}revenueRecognitionRuleDtos`]: ['revenueRecognitionRuleDtos'],
  [`${SETTINGS_TYPE_PREFIX}RevenueRecognitionStatus`]: ['RevenueRecognitionStatus'],
  [`${SETTINGS_TYPE_PREFIX}RevenueStartDate`]: ['RevenueStartDate'],
  [`${SETTINGS_TYPE_PREFIX}RolesPage`]: ['RolesPage'],
  [`${SETTINGS_TYPE_PREFIX}SegmentationRules`]: ['SegmentationRules'],
  [`${SETTINGS_TYPE_PREFIX}SubscriptionSetting`]: ['SubscriptionSetting'],
  [`${SETTINGS_TYPE_PREFIX}UnitsOfMeasureList`]: ['UnitsOfMeasureList'],
  [`${SETTINGS_TYPE_PREFIX}TaxEngines`]: ['TaxEngines'],
