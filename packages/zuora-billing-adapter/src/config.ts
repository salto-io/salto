...
export const SUPPORTED_TYPES = {
  Settings_AccountingRules: ['AccountingRules'],
  Settings_AgingBucket: ['AgingBucket'],
  Settings_AllNotifications: ['AllNotifications'],
  Settings_AllPaymentTerms: ['AllPaymentTerms'],
  Settings_AllRevenueRecognition: ['AllRevenueRecognition'],
  Settings_AllTaxCode: ['AllTaxCode'],
  Settings_ApplicationRules: ['ApplicationRules'],
  Settings_BatchAlias: ['BatchAlias'],
  Settings_BillingCycleType: ['BillingCycleType'],
  Settings_BillingListPriceBase: ['BillingListPriceBase'],
  Settings_BillingPeriod: ['BillingPeriod'],
  Settings_BillingPeriodStart: ['BillingPeriodStart'],
  Settings_BillingRules: ['BillingRules'],
  Settings_ChargeModel: ['ChargeModel'],
  Settings_ChargeType: ['ChargeType'],
  Settings_CommunicationProfiles: ['CommunicationProfiles'],
  Settings_Currencies: ['Currencies'],
  Settings_DiscountSettings: ['DiscountSettings'],
  Settings_DocPrefix: ['DocPrefix'],
  Settings_FxCurrency: ['FxCurrency'],
  Settings_GetTaxCompanies: ['GetTaxCompanies'],
  Settings_GlSegments: ['GlSegments'],
  Settings_HostedPaymentPages: ['HostedPaymentPages'],
  Settings_NumberAndSku: ['NumberAndSku'],
  Settings_PaymentGateways: ['PaymentGateways'],
  Settings_PaymentMethods: ['PaymentMethods'],
  Settings_PaymentRetryRules: ['PaymentRetryRules'],
  Settings_PaymentRules: ['PaymentRules'],
  Settings_ReasonCodes: ['ReasonCodes'],
  Settings_RevenueEventTypes: ['RevenueEventTypes'],
  Settings_RevenueRecognitionModels: ['RevenueRecognitionModels'],
  Settings_revenueRecognitionRuleDtos: ['revenueRecognitionRuleDtos'],
  Settings_RevenueRecognitionStatus: ['RevenueRecognitionStatus'],
  Settings_RevenueStartDate: ['RevenueStartDate'],
  Settings_RolesPage: ['RolesPage'],
  Settings_SegmentationRules: ['SegmentationRules'],
  Settings_SubscriptionSetting: ['SubscriptionSetting'],
  Settings_UnitsOfMeasureList: ['UnitsOfMeasureList'],
  Settings_TaxEngines: ['TaxEngines'],
